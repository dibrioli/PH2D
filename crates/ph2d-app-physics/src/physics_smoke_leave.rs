...
pub const LIFT_DRAG: f32 = 9.81 / LIFT_SPEED;
...
pub const LANES: [(&str, PlatformLift); 3] = [
...
pub fn build_leave_scene(world: &mut World) -> Vec<Entity> {
...
pub const LEAVE_SMOKE_MESSAGE: &str = concat!(
...
pub fn physics_smoke_leave(ctx: &mut crate::SceneCtx<'_>) {
