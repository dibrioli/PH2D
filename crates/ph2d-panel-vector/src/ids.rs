...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_ARRANGE_TO_FRONT, VECTOR_BLEND_REVERSE, VECTOR_BLEND_ROTATE, VECTOR_BLEND_RUN,
    VECTOR_BLEND_STACK_UP, VECTOR_BLEND_STEPS, VECTOR_BLEND_STEPS_NUM, VECTOR_BOOL_EXCLUDE,
    ...
    VECTOR_MODE_TEXT, VECTOR_PANEL, VECTOR_PATH_CLOSE, VECTOR_PATH_SHARPEN, VECTOR_PATH_SIMPLIFY,
