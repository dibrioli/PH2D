...
pub(crate) fn moldura(conjuntos: &[&[[f32; 2]]]) -> (f32, f32, f32, f32) {
...
pub(crate) mod cor {
    /// O fundo da figura.
    pub(crate) const FUNDO: &str = "#141317";
    /// O que ENTROU no nó — a régua, e às vezes também a mensagem.
    pub(crate) const FANTASMA: &str = "#4b4560";
    /// O traço que liga a entrada à saída.
    pub(crate) const TRACO: &str = "#6a5b8c";
    /// O que SAIU.
    pub(crate) const FORTE: &str = "#c9a6ff";
}
