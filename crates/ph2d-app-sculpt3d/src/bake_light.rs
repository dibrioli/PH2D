...
//! a luz caber.
//!
//! ⚠️ **E a medição derrubou uma afirmação MINHA**: o doc do [`ph2d_form_donation::baked_form::planes::neutral_planes`] dizia que a
...
use ph2d_form_donation::baked_form::planes::{
...
/// **A premissa da sonda** — ver [`shade`]. Irmão (`#[path]`) pelo motivo dos
/// outros deste módulo: o corte é de responsabilidade.
#[path = "bake_light_shade.rs"]
mod shade;
...
/// |---|---|---|
/// | [`ph2d_form_donation::baked_form::planes::resolved_lamps`] larga a `dir` | **0,3002** | sangra (30× a barra) |
/// | [`ph2d_form_donation::baked_form::planes::build_input`] manda `form: None` | **0,3514** | sangra |
/// | [`ph2d_form_donation::baked_form::planes::clay_material`] volta ao `Material::NEUTRAL` | 0,0020 | **VERDE, e está certo** |
///
...
#[path = "bake_form_bytes.rs"]
mod form_bytes;

/// **UMA CENA QUE NASCE NÃO É UM GESTO DO ARTISTA.**
///
/// O [`crate::bake::follow_live_rig`] re-autora o rig de TODO objeto assado, e o campo
