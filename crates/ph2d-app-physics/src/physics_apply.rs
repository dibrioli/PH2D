...
use crate::physics_seed::sprite_half_extents;
...
pub fn apply_physics_edit(
    ...
    if crate::physics_markers::apply_marker_edit(world, entity, entity_bits, edit, queue, registry)
    {
        return;
    }
