...
///     --exact profile::tests::the_table_that_chose_the_tolerance --ignored --nocapture
/// ```
///
...
///    contorno e compara com o que está no nó (ver [`crate::profile_live`]). Se isso custasse
...
/// ```text
/// cargo test -p ph2d-host-desktop --bin ph2d-host-desktop --release -- \
///     --exact profile::tests::the_table_that_chose_the_resolution_ceiling --ignored --nocapture
/// ```
#[test]
#[ignore]
...
///     profile::tests::the_table_of_where_the_banding_knee_moves_with_zoom \
///     --ignored --nocapture
/// ```
#[test]
#[ignore]
...
/// ```text
/// cargo test -p ph2d-host-desktop --release -- --exact \
///     profile::tests::the_table_of_the_sharpest_corner --ignored --nocapture
/// ```
#[test]
#[ignore]
