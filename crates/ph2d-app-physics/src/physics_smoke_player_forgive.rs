...
pub fn physics_smoke_forgive(ctx: &mut crate::SceneCtx<'_>) {
...
pub const FORGIVE_SMOKE_MESSAGE: &str = concat!(
    ...
    "2. COYOTE -- corra para a direita e caia da beirada. Aperte a SETA PARA\n",
    "   CIMA *depois* de ja' ter saido do chao, um instante tarde demais.\n",
    "   >>> O pulo tem de SAIR, e voce alcanca a plataforma verde.\n",
    "3. BUFFER -- va' ate' o poco e caia nele. Aperte a SETA PARA CIMA *antes*\n",
    "   de o pe' tocar o fundo.\n",
