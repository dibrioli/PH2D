...
| 14 | SOURCE | `14_source.md` | 4 → **0** | 5 | 5 | — | **47 formas** existem atrás de uma porta única e o nó usa um enum próprio de **8** |
