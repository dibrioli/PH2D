...
//! ([`ph2d_viewport3d::layout`]), com a lição das arestas inteiras escrita no
...
pub(crate) struct Janela {
    ...
    pub(super) split: ph2d_viewport3d::layout::Split,
    ...
    pub(super) gizmo_hot: Option<ph2d_viewport3d::gizmo::Handle>,
    ...
    pub(super) gizmo_grip: Option<ph2d_viewport3d::gizmo::Handle>,
...
impl Sculpt3dScene {
    ...
    pub fn vp_rects(&self) -> Vec<EditorRect> {
        ...
        ph2d_viewport3d::layout::rects(area, self.janela.split)
            .as_slice()
            .to_vec()
    }
    ...
    pub(crate) fn vp_at(&self, x: f32, y: f32) -> Option<usize> {
        ph2d_viewport3d::layout::hit(self.vp_rects(), [x, y])
    }
    ...
    pub(crate) fn view_menu_click(&mut self, x: f32, y: f32) -> bool {
        ...
        let escolha = self
            .janela
            .view_menu_rect
            .and_then(|m| ph2d_viewport3d::view_menu::row_at(m, [x, y]));
    ...
    pub(crate) fn seam_cursor(&self, x: f32, y: f32) -> Option<winit::window::CursorIcon> {
        ...
        ph2d_viewport3d::layout::seam_cursor(self.janela.canvas?, self.janela.split, [x, y])
    }
    ...
    pub(crate) fn seam_grab(&mut self, x: f32, y: f32) -> bool {
        ...
        self.janela.seam_drag = ph2d_viewport3d::layout::seam_grab(area, self.janela.split, [x, y]);
    ...
    pub(crate) fn seam_at(&mut self, x: f32, y: f32) -> bool {
        ...
        let (tx, ty) = ph2d_viewport3d::layout::t_at(area, [x, y]);
