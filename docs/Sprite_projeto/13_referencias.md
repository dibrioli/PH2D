...
- [feedback-perfection-no-deferrals](../../project-memory/feedback_perfection_no_deferrals.md) — padrão-ouro absoluto.
- [feedback-audit-lens-diversity](../../project-memory/feedback_audit_lens_diversity.md) — auditoria adversarial rotacionada.
