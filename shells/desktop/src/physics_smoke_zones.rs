...
pub fn physics_smoke_spin_zone(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
...
pub fn physics_smoke_author_spin(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
...
pub fn physics_smoke_force_frame(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
...
pub fn physics_smoke_falloff(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
...
/// girada), mas há gate.
pub fn physics_smoke_mirror(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
