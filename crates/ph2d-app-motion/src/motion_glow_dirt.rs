...
pub fn resolve(sim: &mut SimWorld, look: Appearance<'_>, name: &str) -> Option<Resolved> {
...
pub fn mask<'a>(r: Resolved, renderer: &'a SpriteRenderer) -> Option<DirtMask<'a>> {
...
pub fn diag_unresolved(name: &str) {
