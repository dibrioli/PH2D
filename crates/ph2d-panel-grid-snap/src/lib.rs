//! ph2d-panel-grid-snap — Wave 7 Stage 2 panel-as-crate (alias form).
//!
//! Re-exports the in-tree [`ph2d_editor::grid_snap::PANEL_MANIFEST`]
...
pub use ph2d_editor::grid_snap::PANEL_MANIFEST;
