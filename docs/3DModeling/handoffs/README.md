...
| 2026-09-13 | [HANDOFF_INTEGRACAO_line_3DModeling_2026-09-13.md](HANDOFF_INTEGRACAO_line_3DModeling_2026-09-13.md) | wave | **W148 — a cache contra o CASCO**: a cache de fitas passa a guardar uma fita por **casco de folha**, porque servir por CAIXA só acertava `1,9`–`2,4×` as arestas do caminho · uma folha de perfil sob uma OPERAÇÃO que remapeia deixa de ser especializada |
