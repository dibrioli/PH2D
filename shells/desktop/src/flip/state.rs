...
pub(crate) struct FlipState {
    ...
    pub colorize: crate::flip::colorize::FlipColorize,
    ...
    pub strip: crate::flip::strip::FlipStrip,
    ...
    pub reshape: Option<crate::flip::reshape::FlipReshape>,
    ...
    pub edit_gesture: Option<crate::flip::edit_gesture::EditGesture>,
    ...
    pub pose_drag: Option<crate::flip::pose_gizmo::FlipPoseDrag>,
    ...
    pub selection_drag: Option<crate::flip::selection_gizmo::FlipSelectionDrag>,
    ...
    pub entities: crate::flip::entities::FlipEntityMap,
}
