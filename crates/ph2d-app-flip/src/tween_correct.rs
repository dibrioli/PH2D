...
//!
//! **A sessão é ESTADO DE AUTORIA, não documento** (vive na [`crate::strip::FlipStrip`],
//! como os toggles): corrigir um par não muda o desenho até o Add. Ela é PINADA a um
//! intervalo `(camada, A, B)` pela [`crate::strip::current_tween_interval`] — a MESMA
...
///
/// A porta única [`crate::strip::current_tween_interval`] resolve o intervalo (o MESMO
...
pub fn upkeep(state: &mut FlipState, flip: &ph2d_flip::FlipDoc, playhead: &ph2d_core::Playhead) {
