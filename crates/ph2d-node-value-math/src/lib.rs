...
pub fn register(reg: &mut NodeRegistry) -> Result<(), RegistryError> {
    ...
    reg.register_ui(
        ...
        ph2d_node_registry::NodeUiManifest {
            display_key: "node.value.math.name",
...
static PARAM_HINTS: &[ParamUiHint] = &[
    ParamUiHint {
        ...
        widget: ParamWidget::Enum {
            ...
            labels: &[
                "node.value.math.param.op.0",
                "node.value.math.param.op.1",
                "node.value.math.param.op.2",
                "node.value.math.param.op.3",
                "node.value.math.param.op.4",
                "node.value.math.param.op.5",
                "node.value.math.param.op.6",
                "node.value.math.param.op.7",
                "node.value.math.param.op.8",
                "node.value.math.param.op.9",
                "node.value.math.param.op.10",
                "node.value.math.param.op.11",
                "node.value.math.param.op.12",
                "node.value.math.param.op.13",
                "node.value.math.param.op.14",
                "node.value.math.param.op.15",
                "node.value.math.param.op.16",
            ],
        },
    },
    ParamUiHint {
