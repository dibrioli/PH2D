...
use crate::physics_smoke_pulley::{GROUND, POST, R, ball};
use ph2d_core::Vec2;
...
pub const MEASURED_GEARED_ROPE_LENGTH: f32 = 80.8986;
...
pub const MEASURED_GEARED_ROPE_LENGTH_ADDED: f32 = 80.9190;
...
pub const MEASURED_GEARED_WORST_JUMP: f32 = 0.0046;
...
pub const CAMERA_CENTRE: [f32; 2] = [0.0, 5.0];
/// A altura de mundo que cobre do chão ao topo dos tambores com folga.
pub const CAMERA_HEIGHT: f32 = 13.0;
...
/// Monta a cena 63.
pub fn build_composition(world: &mut World) {
    world.spawn((
        Name::new("Floor"),
        RigidBody {
            kind: BodyKind::Static,
...
pub fn physics_smoke_composition(ctx: &mut crate::SceneCtx<'_>) {
