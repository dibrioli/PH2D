...
impl FlipStrip {
    ...
    // ⚠️ Só o arrasto da tira os chama, e ele vive atrás de `panel-flip-frames` — ver a
    // nota gémea em `bridge::publish`.
    #[cfg_attr(not(feature = "panel-flip-frames"), allow(dead_code))]
