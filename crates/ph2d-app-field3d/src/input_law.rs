...
/// mede a peça **na tela**.
pub fn orbit(cam: &mut Orbit, dx: f32, dy: f32) {
...
pub fn frame(cam: &mut Orbit, ball: ph2d_field_eval::bounds::Ball) {
...
/// altura.
pub fn pan(cam: &mut Orbit, dx: f32, dy: f32, half_px: f32) {
...
pub fn other_lens(lens: Lens) -> Lens {
    match lens {
...
pub fn zoom(cam: &mut Orbit, steps: f32) {
    cam.half_extent =
