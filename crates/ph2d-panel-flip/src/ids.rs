...
//! — nunca por este módulo. Ele re-exportava a fundação «para não bifurcar a fonte da verdade»: com
//! uma definição só não há o que bifurcar, e o censo de colisões (`node_id_collisions`) lê os
