...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_PATH_SMOOTH, VECTOR_PATH_SUBDIVIDE, VECTOR_PIVOT_EDIT, VECTOR_SNAP_CROSS_OFF,
    VECTOR_SNAP_CROSS_ON, VECTOR_SNAP_OFF, VECTOR_SNAP_ON, VECTOR_SNAP_PATH_OFF,
