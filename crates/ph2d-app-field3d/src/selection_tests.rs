...
fn scene_of_three() -> (SimWorld, Vec<bevy_ecs::entity::Entity>) {
    ...
    crate::scene::sync_scene(&mut sim, Some(&three_in_a_row()), 0.0);
...
fn a_drag_moves_every_selected_node() {
    ...
    crate::scene::apply_motion_for_test(
        ...
        leaves[0].to_bits(),
        &[leaves[0], leaves[2]],
        crate::gizmo::Target::Node,
        crate::gizmo::Motion::Translate([0.0, 0.5, 0.0]),
    );
...
fn a_child_of_a_selected_node_does_not_move_twice() {
    ...
    crate::scene::apply_motion_for_test(
        ...
        &[group, leaves[0]],
        crate::gizmo::Target::Node,
        crate::gizmo::Motion::Translate([0.0, 0.0, 0.25]),
    );
...
fn the_pivot_survives_the_motion_it_applies() {
    ...
    let before = crate::scene::selection_pivot(sim.world(), &sel);
    ...
    for motion in [
        ...
        let now = crate::scene::selection_pivot(sim.world(), &sel);
        assert!(
...
fn a_hidden_node_has_no_gizmo_and_does_not_move_with_the_selection() {
    ...
    crate::scene::apply_motion_for_test(
        ...
        &[a, b],
        crate::gizmo::Target::Node,
        crate::gizmo::Motion::Translate([0.0, 0.4, 0.0]),
    );
    assert!(
...
fn the_hierarchy_drag_asks_this_module_where_the_node_was() {
    ...
    let src = include_str!("../../../shells/desktop/src/hero_intents/hierarchy.rs");
    let code: String = src
        .lines()
