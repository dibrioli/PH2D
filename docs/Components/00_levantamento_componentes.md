...
| ⭐ [05_plano_de_implementacao.md](05_plano_de_implementacao.md) | **o plano VIVO da linha `line/components`** — fases F0–F8 com critério de pronto observável, gates com número, a 1ª migração do `PROJECT_SCHEMA`, e o placar que a linha atualiza. Governado por [ADR-0164](../architecture/decisions/0164-instances-are-real-entities-linked-by-stableid-with-live-sync-and-incremental-undo.md) + [ADR-0165](../architecture/decisions/0165-assets-are-born-inside-the-app-three-level-identity-index-before-browser.md) |
