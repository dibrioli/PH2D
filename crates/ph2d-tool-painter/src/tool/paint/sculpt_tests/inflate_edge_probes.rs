...
//!
//! ## 2026-07-16, Enio's 3rd smoke: *"why does the inflate not apply at the LATERAL of the junction between
...
//!
//! ⚠️ The corollary for anyone reading the history: the coverage the shipped kernel wrote before the taper
//! reached the matter (`cov[gi] = pre_cover[si]`, full 255) did NOT grow the flank either — measured, the
//! cover edge is 137 both ways. It painted the deposit's existing soft rim SOLID, which reads as a form that
//! jumped outward with a hard edge. **The growth was never there; the cookie cutter was the look of its
//! absence.**
