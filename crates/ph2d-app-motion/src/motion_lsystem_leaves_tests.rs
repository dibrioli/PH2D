...
//! o do produto: o irmão [`crate::motion_lsystem_gen`] responde *como um ramo vira forma*.
//!
...
use crate::motion_lsystem_gen::publish;
use crate::motion_lsystem_testkit::*;
...
fn two_identical_plants_with_different_leaves_do_not_share_the_stream() {
    use crate::motion_lsystem_testkit::{key_of, plant_with_leaves};
