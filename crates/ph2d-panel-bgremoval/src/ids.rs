...
pub use ph2d_editor_core::ids::{
    BGR_ADD_AREA, BGR_ADD_AREA_CLEAR, BGR_APPLY, BGR_BRUSH_SIZE, BGR_BRUSH_SIZE_NUM, BGR_CANCEL,
    BGR_EYEDROPPER, BGR_FALLOFF_CONSTANT, BGR_FALLOFF_SHARP, BGR_FALLOFF_SMOOTH,
    BGR_FALLOFF_SPHERE, BGR_FEATHER, BGR_FEATHER_NUM, BGR_GROW, BGR_GROW_NUM, BGR_MODE_CHROMA,
    BGR_MODE_GRABCUT, BGR_PANEL, BGR_PROTECT, BGR_PROTECT_CLEAR, BGR_REFINE, BGR_REFINE_NUM,
    BGR_RESET, BGR_SHOW_MASK, BGR_SWATCHES, BGR_TOLERANCE, BGR_TOLERANCE_NUM, bgr_swatch_index,
};
