...
const CHROME_IDS: &[(&str, NodeId)] = &[
    ...
    ("VECTOR_FX_TRIM", ids::VECTOR_FX_TRIM),
    ("VECTOR_FX_TRIM_START", ids::VECTOR_FX_TRIM_START),
    ("VECTOR_FX_TRIM_START_NUM", ids::VECTOR_FX_TRIM_START_NUM),
    ("VECTOR_FX_TRIM_END", ids::VECTOR_FX_TRIM_END),
    ("VECTOR_FX_TRIM_END_NUM", ids::VECTOR_FX_TRIM_END_NUM),
    ("VECTOR_FX_TRIM_OFFSET", ids::VECTOR_FX_TRIM_OFFSET),
    ("VECTOR_FX_TRIM_OFFSET_NUM", ids::VECTOR_FX_TRIM_OFFSET_NUM),
