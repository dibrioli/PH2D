...
#[cfg(test)]
pub const INK_FOR_TEST: [f32; 3] = INK;
...
pub const ROSETTE_N: f32 = 5.0;
pub const ROSETTE_R: f32 = 0.22;
...
pub const FLASH_RGB: [f32; 3] = [1.0, 0.72, 0.25];
pub const FLASH_AMOUNT: f32 = 0.9;
...
pub fn build_operator_demo_document(
    doc: &mut MotionDoc,
