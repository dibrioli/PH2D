...
pub use state::{
    ...
    set_current_has_envelope, set_current_has_skeleton, set_current_path_closed,
    set_current_patternpath, set_current_patternpath_can_link, set_current_patternpath_can_pick,
    set_current_pivot_edit, set_current_selection_count, set_current_shape_focus,
    set_current_skinned, set_current_snap, set_current_snap_position, set_current_text,
    set_current_text_align, set_current_text_axes, set_current_text_font,
    set_current_text_font_previews, set_current_text_has_weight, set_current_text_seed,
    ...
    set_filter_kinds, set_length_suffix, set_reveal_bone_section, set_selected_vertex_type,
    set_stroke_paint_kind, take_want_font_previews,
};
