...
pub fn physics_smoke_multi_jump(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn build_multi_jump_scene(world: &mut bevy_ecs::world::World) -> (Entity, Entity) {
...
pub const MULTI_JUMP_SMOKE_MESSAGE: &str = concat!(
