...
const CHROME_IDS: &[(&str, NodeId)] = &[
    ...
    ("VECTOR_MODE_LINE", ids::VECTOR_MODE_LINE),
    ("VECTOR_MODE_ARC", ids::VECTOR_MODE_ARC),
    ("VECTOR_ARC_DEGREES", ids::VECTOR_ARC_DEGREES),
    ("VECTOR_ARC_DEGREES_NUM", ids::VECTOR_ARC_DEGREES_NUM),
