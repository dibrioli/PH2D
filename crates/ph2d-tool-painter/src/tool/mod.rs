...
pub use paint::{
    ...
    BrushSettings, CircleOverlay, CurveOverlay, MAX_SHAPE_LAYERS, PANEL_RAMP_STOPS, PolygonOverlay,
    StencilOverlay, StencilPreview, TangentHandles, brush_falloff_weight_at,
};
mod runtime;
mod trait_impls;
