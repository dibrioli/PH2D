...
// ⛔⛔⛔⛔ **AQUI VIVIAM OS CINCO SUJEITOS DO `Even Detail`** — três gates e
// duas sondas — **e saíram com ele, por ordem do dono (2026-09-23):** *«Even
// Detail derruba muito a resolução. retiro!»*
//
// ⚠️ A cadeia de premissas que eles atravessaram em três dias vale mais do que
// o código deles, e está por inteiro no handoff §25–§26:
//
// * `a_peca_da_cena_tem_de_que_igualar` **exigia** que a caixa fizesse algo
//   aqui — e o que ela fazia era DESCER a resolução de um quarto das faces, que
//   foi o report;
// * o piso inverteu-o em `a_peca_da_cena_nao_tem_de_que_igualar…`, com um
//   CILINDRO como controlo;
// * e a inversão durou um dia, porque uma caixa que não faz nada na peça que o
//   dono usa é uma caixa que ele retira.
//
// ⭐ **O que FICA nesta varredura é o que continua a ter sujeito:** o
// `o_oito_e_o_primeiro_degrau_que_alcanca_a_densidade_da_cena_irma`, que mede a
// lei por ÁREA (`niveis_por_area`) e não o escolhedor, e o censo do roteiro.
