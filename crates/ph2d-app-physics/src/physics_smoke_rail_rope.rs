...
pub const LANE_Y: [f32; 3] = [2.4, 0.0, -2.4];
pub const LANE_NAMES: [&str; 3] = ["Rail", "Cross", "Weld"];
...
pub fn build_rail_rope_scene(world: &mut World) {
...
pub fn physics_smoke_rail_rope(ctx: &mut crate::SceneCtx<'_>) {
