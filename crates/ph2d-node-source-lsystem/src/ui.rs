...
pub(crate) static PARAM_GROUPS: &[ph2d_node_registry::ParamGroup] = &[
    ...
    ph2d_node_registry::ParamGroup::new(param::GEOMETRY, "node.group.shape"),
    ph2d_node_registry::ParamGroup::new(param::TIP_TAPER, "node.group.shape"),
    ...
    ph2d_node_registry::ParamGroup::new(LEAF_PARAMS[0], "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(LEAF_PARAMS[1], "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(LEAF_PARAMS[2], "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(param::LEAF_FIRST_LEVEL, "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(param::LEAF_ANGLE, "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(param::LEAF_SPREAD, "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(param::LEAF_FRONT, "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(param::LEAF_EFFECTS, "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(param::LEAF_SIZE, "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(param::LEAF_SIZE_JITTER, "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(param::LEAF_POS_JITTER, "node.group.leaves").folded(),
    ph2d_node_registry::ParamGroup::new(param::BRANCHES, "node.group.shape"),
    ph2d_node_registry::ParamGroup::new(param::SEGMENTS, "node.group.shape"),
    ph2d_node_registry::ParamGroup::new(param::ANGLE, "node.group.shape"),
    ph2d_node_registry::ParamGroup::new(param::BEND, "node.group.shape"),
    ph2d_node_registry::ParamGroup::new(param::VARIATION, "node.group.shape"),
    ph2d_node_registry::ParamGroup::new(param::PRESET, "node.group.grammar"),
    ph2d_node_registry::ParamGroup::new(AXIOM_PARAM, "node.group.grammar"),
    ph2d_node_registry::ParamGroup::new(RULES_PARAM, "node.group.grammar"),
    ph2d_node_registry::ParamGroup::new(param::GENERATIONS, "node.group.growth"),
    ph2d_node_registry::ParamGroup::new(param::GROWTH, "node.group.growth"),
    ph2d_node_registry::ParamGroup::new(param::STEP, "node.group.growth"),
    ph2d_node_registry::ParamGroup::new(param::LENGTH_SCALE, "node.group.growth"),
    ph2d_node_registry::ParamGroup::new(param::WIDTH, "node.group.growth"),
    ph2d_node_registry::ParamGroup::new(param::WIDTH_SCALE, "node.group.growth"),
    ph2d_node_registry::ParamGroup::new(param::STEP_SCALE, "node.group.growth"),
    ph2d_node_registry::ParamGroup::new(param::CONTINUOUS_LENGTH, "node.group.growth"),
    ph2d_node_registry::ParamGroup::new(param::CONTINUOUS_ANGLE, "node.group.growth"),
    // ⚠️ Esta nasce FECHADA: é a única cujos cinco defaults já dão uma planta de pé, e o
    // artista que nunca a abrir não perde nada.
    ph2d_node_registry::ParamGroup::new(param::ROOT_ANGLE, "node.group.lean_and_look").folded(),
    ph2d_node_registry::ParamGroup::new(param::TROPISM, "node.group.lean_and_look").folded(),
    ph2d_node_registry::ParamGroup::new(param::TROPISM_ANGLE, "node.group.lean_and_look").folded(),
    ph2d_node_registry::ParamGroup::new(param::ORIENT, "node.group.lean_and_look").folded(),
    ph2d_node_registry::ParamGroup::new(param::SEED, "node.group.lean_and_look").folded(),
];
