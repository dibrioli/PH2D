...
pub(crate) fn tr(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "panel.inspector.vida.death_hitstop" => "Death Pause",
        "panel.inspector.vida.blink" => "Blink",
        "panel.inspector.vida.knockback_taken" => "Push Taken",
        "panel.inspector.vida.numbers" => "Hit Numbers",
        "panel.inspector.vida.numbers_color" => "Number Color",
        "panel.inspector.vida.numbers_size" => "Number Size",
