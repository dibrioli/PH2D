...
> → **este arquivo** → **[`Flip/09_colorize.md`](../09_colorize.md)** (o plano da wave —
> é ele que impede a fatia 3 redescobrir a decisão da fatia 1) → [`Flip/BUGS_flip.md`](../BUGS_flip.md).
...
**O plano da wave inteira está escrito** em [`Flip/09_colorize.md`](../09_colorize.md) —
...
com os números do PRODUTO; tabela completa em [`09_colorize.md` §7.1](../09_colorize.md).
