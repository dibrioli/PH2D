//! ⭐⭐⭐ **NENHUMA PALAVRA DO PAINEL AUDIO EDITOR É ESCRITA NO FONTE** — o HR-15, por crate.
//!
//! Migrado em 2026-09-16 (`scripts/migrar-texto-pintado.py`, mapa
//! `docs/UI_New_and_Simple/ferramentas/seccoes_audio_editor.tsv`): o painel escrevia **95** textos no fonte, medidos
...
const PREFIX: &str = "panel.audio_editor.";
