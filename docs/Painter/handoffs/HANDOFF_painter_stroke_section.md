...
> Plano/algoritmos: [`docs/Painter/02_plano_de_implementacao.md`](../02_plano_de_implementacao.md) +
> [`03_algoritmos_referencia_blender.md`](../03_algoritmos_referencia_blender.md).
...
- **Causa provável (NÃO confirmada — instrumente):** **densidade de amostra de input baixa.** O
  ...
  `docs/Painter/handoffs/HANDOFF_painter_falloff_curve.md` §4 — e/ou **coalescing de eventos do macOS** no winit),
