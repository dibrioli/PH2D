...
//!
//! O chip da vista acende por [`crate::views::named_view`], que reconhece a orientação com
...
/// da nota do [`crate::views::named_view`], que já paga o mesmo sinal.
