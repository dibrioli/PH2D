...
// ⚠️ O `anchor_side` mudou-se para `crate::anchor_side` (W2/L2 Fase B): ele é uma
...
/// Os gates do **pino de MUNDO** vistos pelo gizmo de pontos — a metade que
/// exercita [`joint_anchor_handles`] sobre uma cena da casa. Veio de
/// `shells/desktop/src/physics/overlay_joint_world_gizmo_tests.rs` (W2/L2 Fase C).
#[cfg(test)]
#[path = "joint_world_gizmo_tests.rs"]
mod joint_world_gizmo_tests;
