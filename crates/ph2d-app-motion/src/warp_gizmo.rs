...
pub const GRAB_PX: f32 = 11.0;

/// Que alça é esta.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WarpHandleKind {
...
pub fn spec_for(ty: NodeTypeId) -> Option<WarpGizmoSpec> {
...
pub const OUTLINE_SEGMENTS: usize = 16;
...
pub fn outline(b: &Boundary) -> Vec<[f32; 2]> {
...
pub fn tangent_arm(kind: WarpHandleKind) -> Option<usize> {
    match kind {
...
/// *"esta alça não pega"*.
pub fn hit(handles: &[WarpHandle], world: [f32; 2], world_per_px: f32) -> Option<usize> {
...
#[cfg(test)]
pub use doc::{box_from_tap, selected_warp, upstream_of, warp_amount};
