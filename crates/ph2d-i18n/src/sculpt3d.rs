...
pub(crate) fn tr(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "panel.sculpt3d.tinta_detalhe.trinta_e_dois" => "32x",
        "panel.sculpt3d.tinta_detalhe.sessenta_e_quatro" => "64x",
        "panel.sculpt3d.tinta_detalhe.cento_e_vinte_e_oito" => "128x",
        "panel.sculpt3d.tinta_detalhe.duzentos_e_cinquenta_e_seis" => "256x",
