...
## ⛔ Recusas MEDIDAS — 15, e nenhuma volta à fila

> ⚠️ **Este doc foi cortado em 2026-08-18** e a narrativa foi **verbatim** para
> [`00_plano_waves.md`](../archive/docs-2026-08-18/Physics/00_plano_waves.md) — a remontagem das duas metades confere sha256 com o original.
>
...
| onde | a recusa |
|---|---|
| [(topo)](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L10) | ⛔ O que estiver aqui marcado **«medido e REJEITADO»** continua rejeitado: uma |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L87) | \| **W-Rod** ([plano 02 §8.1](02_plano_joints_ui_authoring.md)) \| **A BARRA RÍGIDA — o 6º tipo, e o único vínculo que este conjunto não sabia dizer.** O vão é estreito o bastante para passar  |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L90) | \| **W-Pulley W0..W6 + W-Weston** ([plano 03](03_plano_polia.md)) \| **O REDESENHO da polia**, sobre oito pontos de um smoke do Enio. **W0** as quatro correções da foto (a criação pelo canvas  |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L104) | \| **W-LeadDrag** \| **ARRASTAR O CORPO DA ÂNCORA A LEVA O SISTEMA — rígido em FK, como uma CORDA em IK.** Dois gestos **MORTOS** ressuscitam: uma peça toda soldada não abria sessão de FK (a s |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L105) | \| **W-RopeStop** \| **O LIMITADOR — a ponta da corda PARA antes da roldana** (pedido do Enio, com desenho: *"limitadores de modo que os objetos nunca colidam com as polias … dois por corda, d |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L119) | \| **W11 (player)** \| **O REPOUSO** — o personagem parado numa rampa subia sozinho a **3,3 cm/s, para sempre** (relato do Enio no smoke da W10). ⚠️ **A ablação pela GRAVIDADE fecha a causa:** |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L120) | \| **W11b (player)** \| **E a subida que sobrou era o impulso da perna a cair todo no TOPO do tique.** ⚠️ **O mecanismo da W11 estava certo e o remédio prescrito não:** ela escreveu *"a perna  |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L125) | \| **W15 (player)** \| **O AGACHAR** (cena `=94`) — e ele e' uma **perna mais CURTA, nao um corpo menor**. ⚠️ **A previsao do plano 06 §4 estava ERRADA e a construcao corrigiu-a:** ela mantinh |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L129) | \| **W19 (player)** \| **A ESCADA DE PRANCHAS TEM UMA JANELA UTIL, E AS DUAS BORDAS DELA SAO DEFEITOS** (sem cena propria) — ⚠️ **medicao, nao correcao: a cura foi construida tres vezes e REVE |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L130) | \| **W20 (player)** \| **A DESCIDA MORRE QUANDO PARA DE FAZER TRABALHO — a borda de CIMA fechou** (cena `=97`). A W19 mediu duas bordas e reprovou tres leis; esta mede o MECANISMO e cura a que |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L131) | \| **W22 (player)** \| **O SENSOR LATERAL VE O FLANCO, NAO A CINTURA** (cena `=98`) — o item que a W13 deixou aberto no proprio aviso do `probe_wall`. ⚠️ **A nota SUBESTIMAVA, e a medicao veio |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L132) | \| **W23 (player)** \| **O AGARRAR-SE** (cena `=99`) — a outra metade do item aberto da W13, ao pe' da letra: *"ficar parado numa parede e' outra mecanica, com botao proprio"*. ⚠️ **A pesquisa |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L137) | \| **W-KinMove (player)** \| **O SEGUNDO MODO — o controlador cinematico** (cena `=101`, plano 07). O componente `PlayerMode` (valuado, ausente = Dynamic ⇒ **zero bump**), a porta unica `pose_ |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L138) | \| **W-KinFluid (player)** \| **A AGUA PASSA A EXISTIR PARA O MODO CINEMATICO** (cena `=104`, plano 07 §8.4). Medido antes de uma linha: numa poca funda de 4 s o cinematico **afundava 139,67 m |
| [⚠️ O mapa acima FECHOU — as waves seguintes vivem no tracker](../archive/docs-2026-08-18/Physics/00_plano_waves.md#L142) | \| **W-Probes** \| **OS SENSORES DO PLAYER FICAM VISÍVEIS** (cena `=108`, plano 08 §4.55) — o report do Enio (*"os Rays dos Setups dos Players não estão visíveis e nem são plenamente editáveis |
