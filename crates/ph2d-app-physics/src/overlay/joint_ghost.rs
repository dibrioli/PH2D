...
//!
//! Irmão do [`crate::overlay::joints`], separado dele em W-RopeSays pelo
...
pub const JOINT_GHOST_RGBA: [f32; 4] = [0.98, 0.75, 0.25, 0.28]; // LITERAL-COLOR-OK: overlay de joint (fantasma)
...
pub fn limit_ghost(
    ...
    Some(crate::overlay::outline::collider_outline(
