...
pub const TAKEOFF_TOP: f32 = 3.0;
/// Onde ele acaba (a beira de onde se corre).
pub const TAKEOFF_END: f32 = 4.0;
...
/// **O vão** — o planeio.
pub fn physics_smoke_glide(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn build_glide_scene(world: &mut bevy_ecs::world::World) -> (Entity, Entity) {
...
pub const GLIDE_SMOKE_MESSAGE: &str = concat!(
