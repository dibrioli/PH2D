...
//! [`crate::flip_entities::sync`] corria no passe do desenho e **não** na rede do fim do quadro, e
...
use super::*;
use crate::flip_transform::settle_origins;
...
/// *a fixtura não produzia o fenómeno*. O [`crate::flip_transform::settle_origins`] só age sobre um
