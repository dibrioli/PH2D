...
mod a_accao_pedida_pela_fileira_nasce_no_mapa;
...
mod a_paralaxe_corre_depois_da_camera_e_recebe_o_rectangulo_inteiro;
...
mod every_snapshot_the_panel_offers_is_published;
mod every_text_on_path_id_is_consumed_by_the_render_loop;
mod every_verb_is_born_in_a_mode_that_declares_it;
mod every_word_the_shell_shows_comes_from_the_string_table;
mod file_loc_caps;
mod fn_loc_caps;
mod frame_text;
...
mod um_modal_aberto_tem_o_teclado_antes_da_cena_3d;
