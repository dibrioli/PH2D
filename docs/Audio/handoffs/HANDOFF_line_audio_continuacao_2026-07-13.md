...
[`docs/Audio/handoffs/HANDOFF_INTEGRACAO_line_audio.md`](HANDOFF_INTEGRACAO_line_audio.md).
...
| **Plano do módulo** | [`docs/Audio/02_plano_implementacao_completo.md`](../02_plano_implementacao_completo.md) §7 |
...
| **Bugs conhecidos** | [`docs/Audio/BUGS_audio.md`](../BUGS_audio.md) |
