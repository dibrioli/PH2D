...
//! [`crate::field3d_navball`], com a pesquisa do ViewCube patenteado e a
//! calibração das duas folgas registadas no cabeçalho dela. A lista de vistas
//! também: [`crate::field3d_views::Standard`].
//!
...
//! ([`crate::field3d_navball::balls_from_basis`]).
//!
...
impl Sculpt3dScene {
    ...
    /// cabeçalho do [`crate::field3d_navball`].
    ///
