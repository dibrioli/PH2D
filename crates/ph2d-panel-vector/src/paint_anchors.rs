        ...
        self.segmented(
            ...
            &[
                (
                    ...
                    a.v == Some(crate::ids::VECTOR_ANCHOR_V_START),
                ),
                (
                    crate::ids::VECTOR_ANCHOR_V_CENTER,
                    tr("panel.vector.anchors.center"),
                    a.v == Some(crate::ids::VECTOR_ANCHOR_V_CENTER),
                ),
                (
                    crate::ids::VECTOR_ANCHOR_V_END,
                    tr("panel.vector.anchors.bottom"),
                    a.v == Some(crate::ids::VECTOR_ANCHOR_V_END),
                ),
                (
                    crate::ids::VECTOR_ANCHOR_V_STRETCH,
                    tr("panel.vector.anchors.stretch"),
                    a.v == Some(crate::ids::VECTOR_ANCHOR_V_STRETCH),
                ),
            ],
            y,
        )
