...
/// boia oscila.
pub const DIVE_IDLE_RISE: [f32; 3] = [-3.0873, 1.2284, 1.7589];
...
pub const FLOATER_RISE: f32 = 1.5009;
...
pub fn build_swim_scene(world: &mut World) {
...
pub fn physics_smoke_swim(ctx: &mut crate::SceneCtx<'_>) {
