...
pub const LANES: [f32; 3] = [-3.5, 0.0, 3.5];
pub const LANE_NAMES: [&str; 3] = ["Door", "Bell", "Quiet"];
...
pub fn build_signal_scene(world: &mut World) {
    world.spawn((
        Name::new("Ground"),
        RigidBody {
...
pub fn physics_smoke_signal(ctx: &mut crate::SceneCtx<'_>) {
