...
pub(crate) fn populate(store: &mut WidgetStore) {
    ...
    // click reach it.
    button(store, crate::ids::TIMELINE_CLOSE);
    button(store, crate::ids::TIMELINE_GO_START);
    button(store, crate::ids::TIMELINE_PREV_FRAME);
    button(store, crate::ids::TIMELINE_PLAY);
    button(store, crate::ids::TIMELINE_NEXT_FRAME);
    button(store, crate::ids::TIMELINE_GO_END);
    ...
    button(store, crate::ids::TIMELINE_ADD_MARKER);
    for (id, _) in ids::ADDPROP_BUTTONS {
        button(store, id);
    }
    number(store, crate::ids::TIMELINE_TIME_NUM);
    number(store, crate::ids::TIMELINE_FRAME_NUM);
    ...
    toggle(store, crate::ids::TIMELINE_LOOP, false);
    toggle(store, crate::ids::TIMELINE_PINGPONG, false);
    toggle(store, crate::ids::TIMELINE_PHYSICS, false);
    toggle(store, crate::ids::TIMELINE_AUTOKEY, false);
    toggle(store, crate::ids::TIMELINE_RECORD, false);
    ...
    toggle(store, crate::ids::TIMELINE_MOTION_PATH, false);
    toggle(store, crate::ids::TIMELINE_SNAP, true);
    ...
    button(store, crate::ids::TIMELINE_ONION_SETTINGS);
