...
pub(crate) fn register_sculpt_widgets(store: &mut WidgetStore) {
    let radius = ph2d_tool_painter::ids::PAINTER_SCULPT_RADIUS_SLIDER;
    let radius_chip = ph2d_tool_painter::ids::PAINTER_SCULPT_RADIUS_CHIP;
    ...
    let offset = ph2d_tool_painter::ids::PAINTER_SCULPT_OFFSET_SLIDER;
    let offset_chip = ph2d_tool_painter::ids::PAINTER_SCULPT_OFFSET_CHIP;
    ...
    let depth = ph2d_tool_painter::ids::PAINTER_SCULPT_DEPTH_SLIDER;
    let depth_chip = ph2d_tool_painter::ids::PAINTER_SCULPT_DEPTH_CHIP;
    ...
    let angle = ph2d_tool_painter::ids::PAINTER_SCULPT_ANGLE_SLIDER;
    let angle_chip = ph2d_tool_painter::ids::PAINTER_SCULPT_ANGLE_CHIP;
    ...
    let smooth = ph2d_tool_painter::ids::PAINTER_SCULPT_SMOOTH_SLIDER;
    let smooth_chip = ph2d_tool_painter::ids::PAINTER_SCULPT_SMOOTH_CHIP;
