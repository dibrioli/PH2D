...
// ⛔⛔ **NÃO EXISTE UM `PAINTER_WATERCOLOR_SELF_PICKUP`, e a ausência é uma DECISÃO.** Ele shipou
//    em 2026-09-20 (o pincel gasto a recolher a tinta do próprio traço) e o dono RETIROU-O no
//    mesmo dia: *«feature com resultado ruim, não consegue distribuir corretamente a carga da
//    tinta»*. O mecanismo, os números e o que a medição custou ficam no
//    `docs/Painter/40_a_costura_dura_do_retorno_sobre_o_proprio_traco.md` §S2-C — ⚠️ leia-o antes
//    de reabrir o assunto: a lei funcionava e o que ele julgou foi a DISTRIBUIÇÃO da carga.
...
/// que o `Self Pickup` shipou (report do dono, 2026-09-20: *«valor não sai de 0»*; o controlo foi
/// retirado depois, mas a armadilha fica). ⚠️ E o gate
