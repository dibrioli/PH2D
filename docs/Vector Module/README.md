...
| ⭐ **A FILA de 25/08** (⛔ **não é plano**) | [`29_fila_morph_state_machine_e_texture_pattern.md`](29_fila_morph_state_machine_e_texture_pattern.md) — a *state machine* do **Morph** (entre **N** formas, viva no **runtime do jogo**) e o **Texture pattern** no preenchimento; com o que já existe, medido e endereçado, para o plano não gastar a 1.ª hora a redescobri-lo |
