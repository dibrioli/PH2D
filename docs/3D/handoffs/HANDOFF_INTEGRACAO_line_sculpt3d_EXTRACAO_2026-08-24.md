...
| 9 | ⭐ **o handoff do R-pré preenchido e varrido**, + o `INBOX` do Implementador + o ledger fechado do lado do E | [`NEXT_R-PRE.md`](../cleanroom/NEXT_R-PRE.md) · `INBOX_quadwild.md` |
...
1. ⏳ **A auditoria R-pré da espec** (SKILL_Cleanroom §3.R, modo PRÉ) — **condição** de abertura
   ...
   👉 ⭐ **O bloco está pronto a colar** em [`NEXT_R-PRE.md`](../cleanroom/NEXT_R-PRE.md)
   (a corrente do §10 da skill: cada papel entrega o bloco do seguinte).
