...
pub const LANES: [f32; 3] = [-4.0, 0.0, 4.0];
pub const LANE_NAMES: [&str; 3] = ["Single", "Compound", "Sensor Cargo"];
...
pub const MEASURED_Y: [f32; 3] = [0.125, 0.125, 0.063];
...
pub fn build_rafts(world: &mut World) {
    world.spawn((
        Name::new("Pool"),
        RigidBody {
...
pub fn physics_smoke_raft(ctx: &mut crate::SceneCtx<'_>) {
