...
///     preview::cost_tests::measure_where_the_frame_stands_after_all_of_it \
///     --ignored --nocapture
/// ```
#[test]
#[ignore = "sonda; roda com --ignored --nocapture"]
...
/// avaliado a cada quadro de ecrã como o `smoke_draw::draw` faz. ⇒ o A/B entre as duas leis
/// é **determinístico**, que é a única forma honesta de o ler nesta workstation (`load` 3–26).
///
/// ```text
/// cargo test -p ph2d-host-desktop --profile ci-test -- --exact \
///     preview::cost_tests::measure_the_stall_a_hesitating_hand_pays \
///     --ignored --nocapture
/// ```
#[test]
#[ignore = "sonda; roda com --ignored --nocapture"]
