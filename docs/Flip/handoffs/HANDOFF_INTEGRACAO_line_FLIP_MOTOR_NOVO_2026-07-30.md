...
| **5** | a **terceira lei** (`Soft` do Krita) | ⚠️ **funciona exato** e a ressalva do §2.4 não a alcança — mas muda a borda de UMA passada em **+69 %**: decisão de LOOK, do Enio **⚠️ E há uma SEGUNDA metade do preço, medida em 2026-07-31 (§22.11):** ela capa toda acumulação dentro do traço, então o **SELF OVERLAP** (shipado em 2026-07-27) fica INERTE — o cruzamento vai de **1,50× para 1,00×** o braço, em toda dureza. Os dois são mutuamente exclusivos, como o One-Way e a zona de força da física. |
...
- `docs/Flip/handoffs/HANDOFF_line_FLIP_NOVO_MOTOR_DE_TRACO_2026-07-28.md` — o briefing original do Enio.
- `docs/Flip/handoffs/HANDOFF_INTEGRACAO_line_FLIP_crossing_curves_2026-07-28.md` e
