...
| 12 | **Preview de umidade + secagem paulatina** (Enio 2026-07-09) | (a) ✅ LANDOU (`d9dda7ec` overlay + **#1/#2 smoke** escurecimento NEUTRO + slider Preview 0..1, `7b198f51`); (b) secagem gradual influenciando a mescla = ABERTO | (a) overlay on-canvas do `canvas_wet` (véu de papel molhado, sem azul; intensidade por slider, 0=off); (b) a fusão da sessão ainda é binária — usar o valor local do mapa pra atenuar o rim progressivamente (meio-seco = meio-rim) segue aberto |
