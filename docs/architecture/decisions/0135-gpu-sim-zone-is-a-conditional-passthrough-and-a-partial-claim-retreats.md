...
- **Método:** o **censo medido** (`shells/desktop/src/motion/motion_gpu_coverage.rs`) apontou o gargalo ANTES de qualquer desenho ([[feedback_a_frontier_is_not_a_census]]).
