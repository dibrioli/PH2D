...
pub use tool::{
    ...
    BrushSettings, CurveOverlay, EllipseOverlay, LineOverlay, MAX_SHAPE_LAYERS, PANEL_RAMP_STOPS,
    PainterTool, PolygonOverlay, StencilOverlay, StencilPreview, TangentHandles, TransformGizmo,
