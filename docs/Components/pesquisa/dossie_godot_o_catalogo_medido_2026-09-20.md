...
> ✅ temos · ◑ metade (a que falta está dita) · ⭐ não temos · ⛔ fora (decisão ou contexto)
...
| `Parallax2D` · `ParallaxLayer` · `ParallaxBackground` | multiplano do Flip; não como componente de cena | ◑ |
