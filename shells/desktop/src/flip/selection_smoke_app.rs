//! **O invólucro de shell** do `selection_smoke` (W2/L5 Fase B, 2026-09-11).
//!
//! A cena inteira vive em [`ph2d_app_flip::selection_smoke::arm`]. Aqui fica o que só a `App` tem:
...
impl crate::App {
    pub(crate) fn flip_selection_smoke(&mut self) {
        ...
        let armou = ph2d_app_flip::selection_smoke::arm(
            &mut gfx.flip,
            &mut gfx.tools,
