...
a porta `pulse` sem ninguém reconferir a nota. Restam **2 P1**: substeps · teto de
população — a **probabilidade de nascimento** fechou na mesma varredura (a linha acima), e o que
