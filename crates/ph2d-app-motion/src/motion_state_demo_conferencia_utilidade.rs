...
pub fn join(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
...
pub fn sortkey(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
    let sinks =
...
pub fn taper(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
    let sinks =
...
pub fn cursor(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
    let sinks =
...
pub fn field_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
    let sinks =
...
pub fn drizzle(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
    let sinks =
...
pub fn deform(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
    let sinks =
...
///
/// Cinco pares; o mesmo grafo dos dois lados de cada um.
pub fn transform_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
...
pub fn fx_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
...
pub fn force_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
    let sinks =
...
pub fn color_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
    let sinks =
...
pub fn rank_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
...
pub fn goal_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
...
pub fn sim_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
...
pub fn style_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
    let sinks =
...
pub fn operator_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
    let sinks =
...
pub fn util_family(doc: &mut MotionDoc, registry: &NodeRegistry) -> Vec<NodeId> {
