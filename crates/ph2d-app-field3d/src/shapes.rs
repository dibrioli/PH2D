...
//! `+` do Inspector). Ver [`crate::shape_palette`].
...
impl Family {
    ...
    pub fn color(self) -> ph2d_tokens::ColorToken {
...
impl Make {
    ...
    #[cfg(test)]
    pub fn builds(self) -> Option<ph2d_field::PrimitiveKind> {
        match self {
...
#[path = "shapes_table.rs"]
mod table;
pub use table::SHAPES;
...
pub fn shape_at(slot: usize, r: f32) -> Option<Primitive> {
...
pub fn available(shape: &Shape, live_sculpt: bool, profile: bool) -> bool {
    match shape.make {
