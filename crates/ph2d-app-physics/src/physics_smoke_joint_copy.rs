...
pub const TUNED_LIMIT_DEG: f32 = 25.0;
...
pub fn build_joint_copy(world: &mut World) {
    for i in 0..4 {
        gate(world, i, i == 0);
    }
}
...
pub fn physics_smoke_joint_copy(ctx: &mut crate::SceneCtx<'_>) {
