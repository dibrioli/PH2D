...
pub(super) fn build(n: &str, doc: &mut MotionDoc, reg: &NodeRegistry) -> Vec<NodeId> {
    match n {
        ...
        "111" => {
            ...
            crate::motion::motion_demo_legend::publish(super::pivot_demo::captions());
            announce::pivot();
            sinks
        }
        ...
        "112" => {
            ...
            crate::motion::motion_demo_legend::publish(super::foco_demo::captions());
            announce::foco();
            sinks
        }
        ...
        "113" => {
            ...
            crate::motion::motion_demo_legend::publish(super::sim_demo::captions());
            announce::sim();
            sinks
        }
        ...
        "114" => {
            ...
            crate::motion::motion_demo_legend::publish(super::pilha_demo::captions());
            announce::pilha();
            sinks
        }
