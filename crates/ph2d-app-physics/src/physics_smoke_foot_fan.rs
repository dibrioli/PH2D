...
pub fn physics_smoke_foot_fan(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn build_foot_fan_scene(world: &mut bevy_ecs::world::World) -> (Entity, Entity) {
...
pub const FOOT_FAN_SMOKE_MESSAGE: &str = concat!(
