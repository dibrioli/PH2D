# ARQUIVO — 06_resultados_cena_e_gizmo.md (história, 13966 linhas)

> ⚠️ **Isto NÃO é o estado atual de nada.** É a história recortada de
> [`06_resultados_cena_e_gizmo.md`](../../3DModeling/06_resultados_cena_e_gizmo.md) em 2026-08-18, **verbatim** — nenhuma
...
>
> Recorte: linhas fora de `1-28,5736-6266` do original.
>
> ⚠️ **A única alteração ao corpo:** 69 alvo(s) de link relativo foram
...
([doc 08](../../3DModeling/08_formas_por_formula.md)): *«escolha e vamos começar. Ao final quero todas. Encontre um
...
lugar, a auditoria ([doc 08 §4](../../3DModeling/08_formas_por_formula.md)) leu:
...
**A wave** era o resto da fila do [doc 08 §4.2](../../3DModeling/08_formas_por_formula.md): estrela de N pontas,
...
O [doc 08 §4](../../3DModeling/08_formas_por_formula.md) auditou *«quantas das **47** formas do catálogo vetorial o
...
O levantamento contra o [doc 08](../../3DModeling/08_formas_por_formula.md) deu **24** por construir (36 das 62 do
...
> **Enio, 05/09:** *«smoke ok. Siga.»* — o lote 2 da fila do [doc 08 §6.2](../../3DModeling/08_formas_por_formula.md).
...
> ([doc 08 §6.2](../../3DModeling/08_formas_por_formula.md)).
...
O [doc 08](../../3DModeling/08_formas_por_formula.md) dá as duas como classe **C/D** porque *«a distância a uma
...
> ([doc 08 §7.5](../../3DModeling/08_formas_por_formula.md)): as duas de maior alcance, e as duas cujo mecanismo esta
> linha acabou de pagar.

### §125.1 — ⛔⛔⛔ E a primeira coisa que a medição fez foi DESMENTIR uma frase minha

O [doc 08 §3.1](../../3DModeling/08_formas_por_formula.md) diz, desde Agosto, que *«uma primitiva de fórmula custa
...
Antes de construir, corri a lista do [§7.3](../../3DModeling/08_formas_por_formula.md) contra o **código**, e não
contra os nomes:
...
Escolhida a de maior razão **família/linha** do levantamento ([doc 08 §7.4](../../3DModeling/08_formas_por_formula.md)):
...
O primeiro item do [plano das dez](../../3DModeling/09_plano_das_dez_que_faltam.md): o **escaleno**, que hoje obriga a
desenhar.
...
O segundo item do [plano das dez](../../3DModeling/09_plano_das_dez_que_faltam.md), e o que fecha o lote 9: o
...
> [plano 09](../../3DModeling/09_plano_das_dez_que_faltam.md) é a família da hélice, e o nó é a primeira metade dela.
...
> **Fecha a outra metade do Lote 10** ([plano 09](../../3DModeling/09_plano_das_dez_que_faltam.md)). A fila de formas
> passa de **7** para **6**.
...
> **Fecha o Lote 11** ([plano 09](../../3DModeling/09_plano_das_dez_que_faltam.md)) menos o que ele não precisava de
...
O [plano 09](../../3DModeling/09_plano_das_dez_que_faltam.md) diz que o Plane *«não é uma forma a construir: é a bola
