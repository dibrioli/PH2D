...
- 📚 [Comunicação & decisão: mais (53) lições, uma linha cada, verbatim](reference_topic_communication_and_decision_lessons.md)
...
- [Estado autorado & relógios (20)](reference_topic_authored_state_and_clocks.md) · [modo que não exclui ninguém é outro produtor](feedback_a_mode_whose_entry_excludes_nobody_is_just_another_producer.md)
...
- ⭐ [**Como uma RÉGUA mente** — a família (136)](reference_topic_measurement_discipline.md)
...
- [**Ofício de gate** — a família (101)](reference_topic_gate_discipline.md)
...
- [fixture (16)](reference_topic_fixture_discipline.md)
- [Provas de mutação (23) — 3 controles no arnês · ⛔ corpus onde a desigualdade nunca aperta não a testa (2 de 8 sobreviveram)](reference_topic_mutation_proofs.md)
