...
//! operandos preservados. O que esta crate é, e sempre foi, é **pura**: ela
//! devolve geometria, não guarda nada e não decide quando correr — quem escolhe
//! entre assar e re-cozinhar é a shell.
//!
