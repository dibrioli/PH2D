//! Os gates do **motor** do pincel de contorno (plano 36, W2 + W3-bis).
//!
//! ⚠️ As fixturas partilhadas vivem no irmão [`super::fixtures`] — o corte foi por
//! **responsabilidade** quando este ficheiro passou o teto de LOC: aqui só o que se AFIRMA.

use super::fixtures::*;
use super::*;
use crate::{Rgba8, VecVertex};
