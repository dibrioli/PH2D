...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_SNAP_ON, VECTOR_SNAP_PATH_OFF, VECTOR_SNAP_PATH_ON, VECTOR_STROKE_KIND_PATTERN,
    VECTOR_STROKE_KIND_SOLID, VECTOR_STROKE_OPACITY, VECTOR_STROKE_OPACITY_NUM,
    VECTOR_STROKE_PRESENT, VECTOR_STROKE_SWATCH, VECTOR_TEXT_ALIGN_CENTER, VECTOR_TEXT_ALIGN_LEFT,
...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_MODE_CHAMFER, VECTOR_MODE_CUT, VECTOR_MODE_FILLET, VECTOR_MODE_TRIM, VECTOR_MODE_WIDTH,
};
