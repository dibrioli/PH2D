...
6. ~~Ordem~~ — **DECIDIDO (Enio, 2026-08-02): B (preview) primeiro, depois A1**, depois A2→A4. **Wave B FECHADA (smoke OK).** **Wave A1 FECHADA (smoke OK).** **Wave A2 FECHADA (smoke OK).** **Wave A3 CONSTRUÍDA (Enio: "A3 agora"; aguarda smoke)** — ver §8. Próximo após smoke de A3: **A4** (grupo/composto + fonte multi-objeto) — herda o motor de readback/compositor-drive de A3.
