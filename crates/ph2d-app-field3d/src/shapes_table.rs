...
pub const SHAPES: &[Shape] = &[
    ...
    // ⭐⭐ **W139: AS DUAS ÚLTIMAS** — as duas são redondas antes de serem outra coisa, e é aí que
    // um artista as procura.
    Shape {
        key: "panel.model3d.add.cratered_sphere",
        family: Family::Round,
        make: Make::Formula(a_cratered_sphere),
    },
    Shape {
        key: "panel.model3d.add.lens",
        family: Family::Round,
        make: Make::Formula(a_lens),
    },
    // ─────────────────────────── W136 ───────────────────────────
