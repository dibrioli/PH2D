...
/// ⭐ **A versão do wire-format e a escada dela** — módulo irmão pelo tecto de LOC (o corte é por
/// responsabilidade: aqui o MODELO, ali o número que diz que bytes ele escreve).
mod schema;
pub use schema::VEC_SCENE_SCHEMA_VERSION;
