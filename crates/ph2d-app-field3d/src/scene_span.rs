...
pub fn latched_span(selected: Option<bevy_ecs::entity::Entity>) -> f32 {
...
pub fn latched_span_for(chave: u64, raio: f32) -> f32 {
...
pub fn gesture_span(piece_radius: f32) -> f32 {
    const PISO: f32 = 1.0;
