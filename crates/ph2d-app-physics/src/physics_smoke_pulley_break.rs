...
use crate::physics_smoke_pulley::{BOOM_Y, GROUND, HOOK_Y, POST, R, ball};
use ph2d_core::Vec2;
...
pub const MEASURED_HOLDS_DRIFT: f32 = 0.01;
...
pub const MEASURED_JERK: f32 = 5202.0;
...
pub const MEASURED_AXLE_LOAD: f32 = 52.4;

/// Monta a cena 60.
pub fn build_break(world: &mut World) {
    world.spawn((
        Name::new("Floor"),
        RigidBody {
            kind: BodyKind::Static,
...
pub fn physics_smoke_break(ctx: &mut crate::SceneCtx<'_>) {
