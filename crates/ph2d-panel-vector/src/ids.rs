...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_SECTION_SHAPE, VECTOR_SECTION_SHAPE_PARAMS, VECTOR_SECTION_SNAP, VECTOR_SECTION_STROKE,
    VECTOR_SECTION_TEXT, VECTOR_SECTION_TOOL, VECTOR_SECTION_TRANSFORM, VECTOR_SECTION_VERTEX,
    VECTOR_SECTIONS, VECTOR_SHAPE_GROUP_DD,
};
