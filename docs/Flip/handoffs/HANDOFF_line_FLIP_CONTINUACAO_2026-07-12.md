...
> cada passo) → este arquivo → [`Flip/BUGS_flip.md`](../BUGS_flip.md) (§3 abaixo diz por quê).
...
[`Flip/07_reshape_escultura.md`](../07_reshape_escultura.md); tracker: `HANDOFF_flip_impl §W5`.
...
[`Flip/02 §7`](../02_referencia_algoritmos_blender_5.2.md) (Smooth · Push · Grab · Pinch · Twist ·
...
declarado. O modelo de seleção está especificado em [`Flip/02 §11`](../02_referencia_algoritmos_blender_5.2.md)
...
[`Flip/04 §3`](../04_alem_do_blender.md). *Só o TVPaint tem.* É grande: não a misture com outra etapa.
...
[`Flip/00_README.md`](../00_README.md)). Para a W5: `sculpt_paint/grease_pencil/sculpt_*.cc`.

**Docs do módulo:** [`docs/Flip/`](../00_README.md) — `01_plano_waves` (a fila oficial + os
