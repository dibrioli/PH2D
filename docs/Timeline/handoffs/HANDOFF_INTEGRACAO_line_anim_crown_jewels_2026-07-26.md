...
O plano das **joias da coroa** ([`docs/Timeline/07_plano_joias_da_coroa.md`](../07_plano_joias_da_coroa.md))
...
Registrado também no plano [`07_plano_joias_da_coroa.md`](../07_plano_joias_da_coroa.md) §Aberto.
