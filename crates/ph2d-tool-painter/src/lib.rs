...
pub use tool::{
    ...
    BrushSettings, CircleOverlay, CurveOverlay, MAX_SHAPE_LAYERS, PANEL_RAMP_STOPS, PainterTool,
    PolygonOverlay, StencilOverlay, StencilPreview, TangentHandles, brush_falloff_weight_at,
