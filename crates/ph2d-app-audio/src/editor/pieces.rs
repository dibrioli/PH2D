...
impl AudioSystem {
    ...
    pub fn editor_cuts(&self) -> Vec<usize> {
        self.editor
            .clip
            .as_ref()
            .map(|c| c.cuts().to_vec())
    ...
    pub fn editor_piece_grab(&mut self, frame: usize) -> bool {
    ...
    pub fn editor_piece_scale_grab(&mut self, frame: usize) -> bool {
        let Some(clip) = self.editor.clip.as_mut() else {
            return false;
        };
        let pieces = clip.pieces();
    ...
    pub fn editor_piece_drag_to(&mut self, frame: usize) -> bool {
    ...
    pub fn editor_piece_release(&mut self) -> bool {
