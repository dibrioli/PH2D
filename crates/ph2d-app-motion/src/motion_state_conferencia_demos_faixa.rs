...
pub const BAND_MIN: f32 = -0.18;
pub const BAND_MAX: f32 = 0.42;
...
pub fn authored() -> (usize, f32, f32, f32) {
    (ROWS_TABLE.len(), BAND_MIN, BAND_MAX, DRIVE_VALUE)
}

/// O documento da cena `=79`.
pub fn build_band_demo_document(doc: &mut MotionDoc, reg: &NodeRegistry) -> Option<Vec<NodeId>> {
