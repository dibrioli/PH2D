...
pub const LANE_TOP: [f32; 2] = [0.0, -6.0];
/// Onde cada obstáculo nasce, medido do começo da pista.
pub const LIGHT_X: f32 = 3.0;
pub const HEAVY_X: f32 = 7.0;
pub const WALL_X: f32 = 12.0;
...
pub const HEAVY_DENSITY: f32 = 16.0;
...
pub fn physics_smoke_kin_push(ctx: &mut crate::SceneCtx<'_>) {
    build(ctx.world);
