...
/// **Pattern on Path** (plano 23): a seção + os quatro botões + os pares Spacing/Start.
pub use ph2d_editor_core::ids::{
    VECTOR_PATTERNPATH_DETACH, VECTOR_PATTERNPATH_FLIP, VECTOR_PATTERNPATH_FLIP_OFF,
    VECTOR_PATTERNPATH_LINK, VECTOR_PATTERNPATH_SPACING, VECTOR_PATTERNPATH_SPACING_NUM,
