...
/// as três cópias do WGSL deste nó **já divergiram uma vez**, com um grafo a correr
/// uma taxa no device e outra na CPU. *Uma cópia que só duas das cinco recebem
/// deixa de ser uma cópia.* O `channel_column` fica intocado; quem sabe do canal
/// novo é o `eval`, que despacha para aqui.
