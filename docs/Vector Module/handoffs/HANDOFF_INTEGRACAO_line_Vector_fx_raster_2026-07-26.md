...
Detalhe e números no [plano §8](../24_plano_fx_raster.md). O resumo que a integração
precisa:
...
Detalhe e números no [plano §9](../24_plano_fx_raster.md).
...
Detalhe no [plano §10](../24_plano_fx_raster.md). **Nenhum dos dois precisou de
...
Detalhe no [plano §11](../24_plano_fx_raster.md).
