...
> ([16 §10](../16_impasto_plano_implementacao.md)) e a Fase 4 (o CORPO) **landou**
...
2. **Atualizar o plano** ([`docs/Painter/16_impasto_plano_implementacao.md`](../16_impasto_plano_implementacao.md))
...
[`docs/Painter/15_impasto_pesquisa_e_design.md`](../15_impasto_pesquisa_e_design.md) estabeleceu
...
3. [`docs/Painter/16_impasto_plano_implementacao.md`](../16_impasto_plano_implementacao.md) — o plano
   **e a §9**, que lista onde a implementação divergiu dele e por quê.
4. [`docs/Painter/15_impasto_pesquisa_e_design.md`](../15_impasto_pesquisa_e_design.md) — a pesquisa
   existente, e §3 acima explica o que ela **não** responde.
5. [`docs/Painter/BUGS_painter.md`](../BUGS_painter.md) — **#12** (o SIGSEGV que abriu a linha) e
