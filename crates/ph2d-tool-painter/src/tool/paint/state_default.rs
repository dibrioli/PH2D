...
impl Default for PaintState {
    fn default() -> Self {
        ...
        Self {
            ...
            paper_color_ramp: ph2d_color::ColorRamp::default(),
            paper_color_ramp_enabled: false,
            paper_color_ramp_bw: false,
            paper_color_ramp_alpha_mode: ph2d_painter_brush::RampAlphaMode::None,
            paper_ramp_lut: Vec::new(),
            paper_ramp_dirty: true,
            stroke_mask: Vec::new(),
