...
necessário ([doc 10](../10_auditoria_30_nos_correcoes.md)). Commits adicionais
na mesma linha:
...
scrub para trás determinístico ([doc 11](../11_checkpoint_restore_scrub_nota_adr.md)).
...
e implementada a **fatia 1** do domínio de valor ([doc 12](../12_dominio_de_valor_nota_adr.md)).
...
congelados intocados** ([doc 13](../13_lfo_map_range_nota_adr.md)). Commits adicionais na
mesma linha:
...
([doc 14](../14_sample_hold_instance_field_nota_adr.md)). Commits adicionais na mesma linha:
