...
pub use stamp_color::{
    ColorStampMask, FusedDab, accumulate_color_stamp_coverage, accumulate_color_stamps_fused,
    accumulate_color_stamps_fused_batch, accumulate_shape_layer_rgba, blit_color_stamp,
