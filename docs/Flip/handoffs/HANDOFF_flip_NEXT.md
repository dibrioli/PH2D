...
Conhecimento do módulo: [`docs/Flip/`](../00_README.md) — `05_frames_ghost_tween.md`,
`06_fill_balde.md`, e sobretudo **[`BUGS_flip.md`](../BUGS_flip.md)**, o registro dos bugs cuja
...
[`Flip/BUGS_flip.md` #14](../BUGS_flip.md); o resumo de código em
...
[`Flip/02_referencia_algoritmos_blender_5.2.md` §7](../02_referencia_algoritmos_blender_5.2.md).
