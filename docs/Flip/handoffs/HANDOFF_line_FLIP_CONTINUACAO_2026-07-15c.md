...
> (o mapa detalhado do W7.5/W8 e da fila, que este estende) → [`Flip/BUGS_flip.md`](../BUGS_flip.md).
...
render) + 3 gates / 2 mutações provadas. Saga completa: [`Flip/BUGS_flip.md`](../BUGS_flip.md) **#18**.
