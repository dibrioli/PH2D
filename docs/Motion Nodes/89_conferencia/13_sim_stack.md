...
a porta `pulse` sem ninguém reconferir a nota. Restam **3 P1**: substeps · probabilidade de
nascimento · teto de população — o **speed limit** fechou na mesma varredura, e com ele a §0.1
