...
//! MECANISMO vai para o módulo do motor (Wedge, Arrow, Tube, e o `corner_chamfer` da W143).
...
pub enum Primitive {
    ...
    Star {
        ...
        round: f32,
        chamfer: f32,
        /// ⭐⭐⭐ **O CHANFRO DAS QUINAS DO CONTORNO — a ponta E o vale** (W143/W144). ⛔ Um número
        /// não chegava: o filete engole-o `3,7×` mais cedo numa ponta que num aro (tabela no doc do
        /// `ph2d_field_eval::ops_joint::facet_fillet_limit`), e as arestas VERTICAIS são outra
        /// família que a das faces. Tecto próprio, `2,03×` maior: [`crate::star_corner_chamfer_limit`].
        corner_chamfer: f32,
    },
