...
//!
//! A LEI do traço (a reamostragem, o ajuste, a construção) vive em [`ph2d_app_flip::draw`]: ela
//! só fala `ph2d_flip` e `ph2d_app_flip::smooth`. O que sobra aqui é **uma função** —
//! [`bake_stroke`] — e o que a prende é nomeável: ela pergunta a [`crate::flip::autokey`] qual é
//! o desenho-alvo e escreve na [`crate::flip::strip`], e esses dois estão presos atrás do
...
pub(crate) fn bake_stroke(
    ...
    drawing
        .strokes
        .push(ph2d_app_flip::draw::stroke_from_samples(
            style,
            points,
            pressures,
            world_to_local,
