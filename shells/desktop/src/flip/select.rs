...
pub(crate) use crate::flip::select_pick::stroke_at;

/// O desenho que está **na tela** para a camada ativa — sem criar chave nenhuma.
///
/// Espelha a resolução do [`crate::flip::autokey::target_drawing`] (objeto → camada ativa
...
pub(crate) use crate::flip::select_points::{
