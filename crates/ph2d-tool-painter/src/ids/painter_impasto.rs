...
//!
//! ⚠️ **Desceu de `ph2d-editor-core/src/ids/chrome/painter_impasto.rs` em 2026-09-12** (auditoria de arquitectura
...
pub const PAINTER_IMPASTO_TOOL_IDS: [NodeId; 10] = [
    ...
    super::PAINTER_SCULPT_MODE_SMOOTH,
    super::PAINTER_SCULPT_MODE_SHARPEN,
    super::PAINTER_SCULPT_MODE_FLATTEN,
    super::PAINTER_SCULPT_MODE_SCRAPE,
    super::PAINTER_SCULPT_MODE_FILL,
    super::PAINTER_SCULPT_MODE_CHISEL,
    super::PAINTER_SCULPT_MODE_LAYER,
    super::PAINTER_SCULPT_MODE_INFLATE,
];
