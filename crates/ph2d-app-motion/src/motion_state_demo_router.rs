...
/// Os ANÚNCIOS das cenas — a prosa, cortada daqui no teto de LOC do shell (600).
#[path = "motion_state_demo_announce.rs"]
mod announce;
...
pub const MAX_DEMO_LEVEL: u32 = 118;
...
#[must_use]
pub fn demo_wants_the_motion_tool(built_sinks: usize) -> bool {
...
#[must_use]
pub const fn wants_the_motion_tool(env_present: bool, built_sinks: usize) -> bool {
