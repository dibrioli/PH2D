...
fn scenes() -> Vec<(&'static str, Vec<Caption>)> {
    vec![
        (
            ...
            crate::motion::motion_state::conferencia_demos_gates::captions(),
        ),
        (
            "=83 o campo que era um número",
            crate::motion::motion_state::conferencia_demos_campo::captions(),
        ),
        (
            "=84 o que o efeito não sabia fazer",
            crate::motion::motion_state::conferencia_demos_fx_modes::captions(),
        ),
        (
            "=85 a forma que o artista desenha",
            crate::motion::motion_state::conferencia_demos_drawn::captions(),
        ),
        (
            "=86 a fronteira curva",
            crate::motion::motion_state::conferencia_demos_bezier::captions(),
        ),
    ]
}
