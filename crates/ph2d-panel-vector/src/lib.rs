...
pub use state::{
    ...
    set_current_shape_focus, set_current_snap, set_current_snap_position, set_current_text,
    ...
    set_current_vector_style, set_current_vertex_count, set_cut_line_exists, set_expand_join,
    set_expand_side, set_filter_blend_names, set_filter_kinds, set_selected_vertex_type,
