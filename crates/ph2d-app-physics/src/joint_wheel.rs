...
//! roldanas dela.
//!
//! Irmão de [`crate::joint`], e o corte é o assunto: lá mora *o que um
...
pub fn add_pulley_wheel(sim: &mut SimWorld, physics: &PhysicsBridge, joint_bits: u64) {
...
pub fn set_wheel_mount(sim: &mut SimWorld, wheel_bits: u64, body: Entity) {
...
pub fn set_wheel_rope(sim: &mut SimWorld, wheel_bits: u64, rope: Entity) -> bool {
    if sim
        .world()
