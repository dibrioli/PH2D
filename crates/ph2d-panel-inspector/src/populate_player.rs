...
fn populate_player_chips(store: &mut WidgetStore) {
    ...
    // 36 células do W2c).
    register_button_ids(store, &crate::ids::INSP_PLAYER_MODE_IDS);
    store.set_tooltip(
        crate::ids::INSP_PLAYER_MODE_IDS[0],
        "The floating capsule: impulses, a spring leg, the solver owns the pose.",
    );
    store.set_tooltip(
        crate::ids::INSP_PLAYER_MODE_IDS[1],
        "The controller: the pose is written, the world only says how much fit.",
    );
    store.set_tooltip(
        crate::ids::INSP_PLAYER_MODE_IDS[2],
    ...
    store.set_tooltip(
        crate::ids::INSP_PLAYER_LIFT_POLICY_IDS[2],
    ...
    register_button_ids(store, &crate::ids::INSP_PLAYER_WALK_OFF_IDS);
    store.set_tooltip(
        crate::ids::INSP_PLAYER_WALK_OFF_IDS[0],
        "He walks off ledges, like every character before this option existed.",
    );
    store.set_tooltip(
        crate::ids::INSP_PLAYER_WALK_OFF_IDS[1],
    ...
    register_button_ids(store, &crate::ids::INSP_PLAYER_CROUCH_WALK_OFF_IDS);
    store.set_tooltip(
        crate::ids::INSP_PLAYER_CROUCH_WALK_OFF_IDS[0],
        "Crouching does not change it: he walks off ledges if standing does.",
    );
    store.set_tooltip(
        crate::ids::INSP_PLAYER_CROUCH_WALK_OFF_IDS[1],
...
pub(super) fn populate_player(store: &mut WidgetStore) {
    ...
    for (id, value, min, max, step) in [
        ...
        (crate::ids::INSP_PLAYER_FLOAT, 0.5, 0.01, 100.0, 0.01), // LITERAL-PX-OK: meters
        (crate::ids::INSP_PLAYER_CLING, 0.25, 0.0, 100.0, 0.01), // LITERAL-PX-OK: meters
        ...
        (crate::ids::INSP_PLAYER_STIFFNESS, 2000.0, 0.0, 3600.0, 1.0), // LITERAL-PX-OK: accel per metre
        ...
        (crate::ids::INSP_PLAYER_DAMPING, 1.0, 0.0, 1.0, 0.05), // LITERAL-PX-OK: fraction per tick
        // m/s, relativa ao chão.
        (crate::ids::INSP_PLAYER_SPEED, 6.0, 0.0, 1000.0, 0.1), // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PLAYER_ACCEL, 60.0, 0.0, 10_000.0, 1.0), // LITERAL-PX-OK: m/s^2
        (crate::ids::INSP_PLAYER_AIR_ACCEL, 20.0, 0.0, 10_000.0, 1.0), // LITERAL-PX-OK: m/s^2
        ...
        (crate::ids::INSP_PLAYER_BRAKE, 1.0, 0.0, 100.0, 0.1), // LITERAL-PX-OK: fraction of the budget
        ...
        (crate::ids::INSP_PLAYER_MAX_SLOPE, 45.0, 0.0, 90.0, 1.0), // LITERAL-PX-OK: degrees
        ...
        (crate::ids::INSP_PLAYER_JUMP_HEIGHT, 2.0, 0.0, 1000.0, 0.1), // LITERAL-PX-OK: metres
        ...
        (crate::ids::INSP_PLAYER_AIR_JUMPS, 0.0, 0.0, 8.0, 1.0), // LITERAL-PX-OK: count
        (crate::ids::INSP_PLAYER_AIR_JUMP_H, 2.0, 0.0, 1000.0, 0.1), // LITERAL-PX-OK: metres
        ...
        (crate::ids::INSP_PLAYER_TAKEOFF_G, 1.0, 0.0, 20.0, 0.1), // LITERAL-PX-OK: gravity multiple
        (crate::ids::INSP_PLAYER_TAKEOFF_SPEED, 0.0, 0.0, 1000.0, 0.1), // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PLAYER_PEAK_G, 0.5, 0.0, 20.0, 0.1),    // LITERAL-PX-OK: gravity multiple
        (crate::ids::INSP_PLAYER_PEAK_SPEED, 1.5, 0.0, 1000.0, 0.1), // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PLAYER_FALL_G, 2.0, 0.0, 20.0, 0.1),    // LITERAL-PX-OK: gravity multiple
        (crate::ids::INSP_PLAYER_CUT_G, 4.0, 0.0, 20.0, 0.1),     // LITERAL-PX-OK: gravity multiple
        ...
        (crate::ids::INSP_PLAYER_COYOTE, 0.1, 0.0, 0.5, 0.01), // LITERAL-PX-OK: seconds
        (crate::ids::INSP_PLAYER_BUFFER, 0.1, 0.0, 0.5, 0.01), // LITERAL-PX-OK: seconds
        ...
        (crate::ids::INSP_PLAYER_CORNER, 0.12, 0.0, 0.3, 0.01), // LITERAL-PX-OK: metres
        ...
        (crate::ids::INSP_PLAYER_CORNER_AHEAD, 2.0, 0.0, 8.0, 0.5), // LITERAL-PX-OK: ticks
        // ⚠️ Segundos, e o teto cobre o pulo mais longo da config de partida
        // (1,45 s no ar, medido) com folga para um `jump_height` maior.
        (crate::ids::INSP_PLAYER_LIFT, 1.5, 0.0, 4.0, 0.05), // LITERAL-PX-OK: seconds
        ...
        (crate::ids::INSP_PLAYER_WALL_SLIDE, 0.0, 0.0, 12.0, 0.25), // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PLAYER_WALL_JUMP, 0.0, 0.0, 6.0, 0.1),    // LITERAL-PX-OK: metres
        (crate::ids::INSP_PLAYER_WALL_PUSH, 6.0, 0.0, 16.0, 0.25),  // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PLAYER_WALL_LOCK, 0.2, 0.0, 0.6, 0.02),   // LITERAL-PX-OK: seconds
        (crate::ids::INSP_PLAYER_WALL_REACH, 0.08, 0.0, 0.4, 0.01), // LITERAL-PX-OK: metres
        ...
        (crate::ids::INSP_PLAYER_FOOT_SAMPLES, 3.0, 1.0, 257.0, 2.0), // LITERAL-PX-OK: count
        (crate::ids::INSP_PLAYER_FOOT_SPREAD, 1.0, 0.0, 1.0, 0.05),   // LITERAL-PX-OK: fraction
        (crate::ids::INSP_PLAYER_WALL_SAMPLES, 3.0, 1.0, 257.0, 2.0), // LITERAL-PX-OK: count
        ...
        (crate::ids::INSP_PLAYER_WALL_SPREAD, 1.0, 0.0, 1.0, 0.05), // LITERAL-PX-OK: fraction
        ...
        (crate::ids::INSP_PLAYER_WALL_GRAB, 0.0, 0.0, 10.0, 0.25), // LITERAL-PX-OK: seconds
        (crate::ids::INSP_PLAYER_DASH_SPEED, 0.0, 0.0, 40.0, 0.5), // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PLAYER_DASH_TIME, 0.15, 0.0, 1.0, 0.01), // LITERAL-PX-OK: seconds
        (crate::ids::INSP_PLAYER_DASH_COOL, 0.2, 0.0, 2.0, 0.02),  // LITERAL-PX-OK: seconds
        (crate::ids::INSP_PLAYER_CROUCH_HEIGHT, 0.0, 0.0, 3.0, 0.05), // LITERAL-PX-OK: metres
        (crate::ids::INSP_PLAYER_CROUCH_SPEED, 2.0, 0.0, 20.0, 0.25), // LITERAL-PX-OK: m/s
        ...
        (crate::ids::INSP_PLAYER_SWIM_SPEED, 0.0, 0.0, 20.0, 0.25), // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PLAYER_SWIM_ACCEL, 12.0, 0.0, 60.0, 0.5), // LITERAL-PX-OK: m/s2
        (crate::ids::INSP_PLAYER_SWIM_ENTER, 1.0, 0.0, 4.0, 0.05),  // LITERAL-PX-OK: weights
        ...
        (crate::ids::INSP_PLAYER_LEDGE_GRAB, 0.0, 0.0, 2.0, 0.05), // LITERAL-PX-OK: m
        (crate::ids::INSP_PLAYER_LEDGE_REACH_Y, 0.6, 0.0, 2.0, 0.05), // LITERAL-PX-OK: m
        (crate::ids::INSP_PLAYER_LEDGE_SPAN, 0.0, 0.0, 2.0, 0.05), // LITERAL-PX-OK: m
        (crate::ids::INSP_PLAYER_LEDGE_OFFSET_Y, 0.0, -2.0, 2.0, 0.05), // LITERAL-PX-OK: m
        (crate::ids::INSP_PLAYER_LEDGE_SPEED, 3.0, 0.0, 20.0, 0.25), // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PLAYER_GLIDE_FALL, 0.0, 0.0, 20.0, 0.25), // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PLAYER_MAX_FALL, 0.0, 0.0, 150.0, 0.5),  // LITERAL-PX-OK: m/s
        ...
        (crate::ids::INSP_PLAYER_REACT_SUPPORT, 1.0, 0.0, 1.0, 0.05), // LITERAL-PX-OK: fraction
        (crate::ids::INSP_PLAYER_REACT_MOVEMENT, 0.0, 0.0, 1.0, 0.05), // LITERAL-PX-OK: fraction
        (crate::ids::INSP_PLAYER_REACT_PUSH, 1.0, 0.0, 1.0, 0.05),    // LITERAL-PX-OK: fraction
    ] {
        store.register(
            id,
