...
/// ⭐ **A RÉGUA** — as sondas que dizem *o que o olho pode ver*: ali mede-se a FIDELIDADE que
/// autoriza a troca.
#[path = "motion_carimbo_lod_regua_probe.rs"]
mod regua;

/// ⭐ **A DECISÃO** — as sondas que dizem *se* e *onde* o LOD arma, num ficheiro irmão por
/// RESPONSABILIDADE (e o tecto de LOC obrigou-o no dia certo): aqui mede-se o CUSTO, ali mede-se
/// a ESCOLHA.
#[path = "motion_carimbo_lod_decisao_probe.rs"]
mod decisao;
