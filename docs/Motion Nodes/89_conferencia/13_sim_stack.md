...
**Contagem: 3 P0 · 7 P1 · 8 P2 · 6 REFUTADOS por composição** (⛔) — ⚠️ **e a varredura de
...
a porta `pulse` sem ninguém reconferir a nota. Resta **1 P1**: substeps — e ele deixou de ser *"inexprimível"* para ser **escopo**
(o mecanismo está medido na linha 59: subdividir o playhead JÁ substepa; o que falta é
fazê-lo por-zona em vez de cobrar do grafo inteiro). O **teto de
