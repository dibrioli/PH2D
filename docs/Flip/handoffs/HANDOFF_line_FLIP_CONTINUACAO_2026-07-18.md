...
**Status:** FECHADO 2026-07-18 · no `main` em `dd4e08a64` (o commit que trouxe este arquivo).
...
[`Flip/04_alem_do_blender.md` §3](../04_alem_do_blender.md), que traz as constantes.
...
**Antes de escrever código:** leia `04 §3` inteiro + [`06_fill_balde.md`](../06_fill_balde.md)
