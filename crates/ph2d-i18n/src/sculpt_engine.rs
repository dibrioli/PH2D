...
pub(crate) fn tr(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "sculpt3d.pose_arrasto.ao_longo_do_osso" => "Along Bone",
        "sculpt3d.pose_arrasto.completo" => "Full Drag",
        ...
        "sculpt3d.verb.smear_color" => "Smear Color",
