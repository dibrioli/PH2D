...
| **W7** ⏳ | **SIM.\*** (fam. 13) | 3 → **2** | o estágio de EVENTOS dependia do W6, que fechou em 2026-08-10 — e o **P0 do evento de MORTE caiu no mesmo dia** (as saídas `died`/`pulse` do `sim.lifetime`, cena `=27`): `sim.replicate` acabou não sendo um nó, e sim uma fiação. **Restam** o RAIO da partícula (colidimos um PONTO, então um sprite afunda até a metade no chão) e o plano NÃO-HORIZONTAL |
