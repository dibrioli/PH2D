# ARQUIVO — README.md (história, 1171 linhas)

> ⚠️ **Isto NÃO é o estado atual de nada.** É a história recortada de
> [`README.md`](../../../UI_Bugs/README.md) em 2026-08-18, **verbatim** — nenhuma
...
>
> Recorte: linhas fora de `1-380` do original.
>
> ⚠️ **A única alteração ao corpo:** 37 alvo(s) de link relativo foram
