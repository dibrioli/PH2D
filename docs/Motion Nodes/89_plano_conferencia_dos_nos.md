...
| **W3** ✅ | **COR** (fam. 9) | 6 → **~3** → **4 FEITOS** | **quatro P0 fechados em 2026-08-09** ([§3 do 09_cor](89_conferencia/09_cor.md)): a alfa que não chegava ao device (**defeito**) · a máscara por campo · o canal "Opacity" do picker (que a tabela lia como *duas portas* e a medição mostrou ser **um FANTASMA** — ninguém escreve a coluna `opacity`) · e o **canal do `motion.luminance`**, de 1 para 8. Segue P0: o espaço de interpolação da rampa (o motor tem, o formato não) e hue/sat **sobre a cor existente**, que espera a metade de ESCRITA do loop (W0-B-genérico) |
