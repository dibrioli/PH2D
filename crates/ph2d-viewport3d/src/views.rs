...
pub fn named_view(cam: &Orbit) -> Option<Standard> {
    Standard::ALL
        .into_iter()
...
pub fn label_key(cam: &Orbit) -> &'static str {
...
pub fn view_for_key(code: winit::keyboard::KeyCode, ctrl: bool) -> Option<Standard> {
