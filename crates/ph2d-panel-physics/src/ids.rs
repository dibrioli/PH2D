...
pub use ph2d_editor_core::ids::{
    ...
    PHYSICS_BLAST_FORCE_NUM, PHYSICS_BLAST_RADIUS, PHYSICS_BLAST_RADIUS_NUM, PHYSICS_CLEAR_RUN,
    PHYSICS_CLOSE, PHYSICS_CONTACT_HZ, PHYSICS_CONTACT_HZ_NUM, PHYSICS_GRAVITY_X,
    PHYSICS_GRAVITY_X_NUM, PHYSICS_GRAVITY_Y, PHYSICS_GRAVITY_Y_NUM, PHYSICS_HOLD_DAMPING,
    PHYSICS_HOLD_DAMPING_NUM, PHYSICS_HOLD_MODE, PHYSICS_HOLD_MODE_OPT, PHYSICS_HOLD_SLACK,
    PHYSICS_HOLD_SLACK_NUM, PHYSICS_HOLD_STIFFNESS, PHYSICS_HOLD_STIFFNESS_NUM, PHYSICS_IK_ANGLE,
    PHYSICS_IK_ANGLE_OPT, PHYSICS_IK_DAMPING, PHYSICS_IK_DAMPING_NUM, PHYSICS_INTERACT_TOOL,
    PHYSICS_INTERACT_TOOL_OPT, PHYSICS_ITERATIONS, PHYSICS_ITERATIONS_NUM, PHYSICS_JOINT_TOOL,
    PHYSICS_JOINT_TOOL_OPT, PHYSICS_LAYER_CELL, PHYSICS_LINEAR_DAMPING, PHYSICS_LINEAR_DAMPING_NUM,
    PHYSICS_PANEL, PHYSICS_PULL_FORCE, PHYSICS_PULL_FORCE_NUM, PHYSICS_PULL_RADIUS,
