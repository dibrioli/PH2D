...
pub fn physics_smoke_mass(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn physics_smoke_dominance(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_material(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_one_way(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
/// zone is its push.
pub fn physics_smoke_area(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
