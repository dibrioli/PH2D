...
## 5. Histórico de execução — MOVIDO

> ⚠️ **Um ADR não carrega um diário.** As 19 entradas do histórico de execução (W0 → W3.T4, todo o
> maio de 2026 — 77 KB dos 98 KB deste arquivo) foram movidas **verbatim**, em 2026-08-18, para
> [`docs/archive/docs-2026-08-18/architecture/decisions/0054-imageio-pipeline.md`](../../archive/docs-2026-08-18/architecture/decisions/0054-imageio-pipeline.md).
>
> O que **decide** — Contexto, Decisão, o contrato congelado, as Consequências e as Alternativas
> consideradas — está inteiro acima, e é o que um ADR tem de responder. O histórico responde
> *"como chegámos aqui"*, e vive-se bem com ele a um clique de distância.
