...
pub mod paint_batch;
/// Fill primitives born after `paint.rs` hit its frozen LOC ceiling — see the module docs.
...
/// ecrã que o pinta.*
pub mod tween_edits;
/// ⭐⭐⭐ O vocabulário das secções HEALTH e DAMAGE (plano 28, W3).
pub mod vida_edits;
...
pub use gizmo::{
    ...
    GizmoView, GroupDragSnapshot, HANDLE_SIZE_PX, PointGizmoView, TransformSnapshot,
    anchor_pivot_world, compose_snapshot, compute_gizmo_transform, gizmo_kind_for_id,
    is_gizmo_handle_id, is_gizmo_id, live_anchor, move_pivot_transform, paint_gizmo_outline,
    paint_point_gizmo, paint_sprite_gizmo, paint_sprite_gizmo_keyed, pivot_snap_candidates,
    world_delta_to_local, world_translation_to_local,
};
...
pub use screens::{
    ...
    BottomHudStats, CameraFieldEdit, EMISSIVE_MAX_UI, FactoryFieldEdit, HeroScreen, HeroSelection,
    ...
    InspectorBlendInfo, InspectorBlendMixed, InspectorCameraFollow, InspectorCameraInfo,
    InspectorCameraLimits, InspectorFactory, InspectorFactoryInfo, InspectorGameCamera,
    InspectorJointInfo, InspectorLifecycle, InspectorNameInfo, InspectorOrderingInfo,
    InspectorOrderingMixed, InspectorPhysicsInfo, InspectorPlayerInfo, InspectorSamplingInfo,
    InspectorSamplingMixed, InspectorSliceInfo, InspectorSliceMixed, InspectorSpawnWhere,
