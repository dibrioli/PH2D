...
//!
//! Irmão do [`crate::motion::motion_object_bake`] e separado dele por RESPONSABILIDADE (e pelo tecto de
...
use crate::motion::motion_object_bake::{BAKE_DPI, MAX_TILE_SIDE, bake_camera};
