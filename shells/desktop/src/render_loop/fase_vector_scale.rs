...
impl crate::App {
    ...
    pub(super) fn fase_vector_scale(&mut self) -> Option<(bool, f64)> {
        ...
        let vw0 = camera.screen_to_world((0.0, 0.0), janela_da_cena);
        let vw1 = camera.screen_to_world((1.0, 0.0), janela_da_cena);
        let vec_px_to_world =
