...
pub(super) fn populate_joint(store: &mut WidgetStore) {
    register_button_ids(store, &crate::ids::INSP_JOINT_KIND);
    register_button_ids(store, &crate::ids::INSP_JOINT_LIMITS);
    register_button_ids(store, &crate::ids::INSP_JOINT_MOTOR);
    register_button_ids(store, &crate::ids::INSP_JOINT_MOTOR_MODE);
    register_button_ids(store, &crate::ids::INSP_JOINT_BREAK);
    ...
    register_button_ids(store, &crate::ids::INSP_JOINT_ACTIVE);
    register_button_ids(store, &crate::ids::INSP_JOINT_COLLIDE);
    register_button_ids(store, &crate::ids::INSP_JOINT_ANCHOR_B);
    ...
    for group in &crate::ids::INSP_JOINT_AXIS_MODE {
        register_button_ids(store, group);
    }
    register_button_ids(store, &crate::ids::INSP_JOINT_MOTOR_AXIS);
    // W-SoftWeld — mesma razão da linha acima.
    register_button_ids(store, &crate::ids::INSP_JOINT_SOFT);
    register_button_ids(
        store,
        &[
            crate::ids::INSP_JOINT_REMOVE,
            crate::ids::INSP_JOINT_SWAP,
            crate::ids::INSP_JOINT_ADD_WHEEL,
            crate::ids::INSP_JOINT_COPY,
            crate::ids::INSP_JOINT_PASTE,
            crate::ids::INSP_JOINT_PICK_A,
            crate::ids::INSP_JOINT_PICK_B,
            crate::ids::INSP_PHYS_JOIN,
            ...
            crate::ids::INSP_WHEEL_MOUNT_PICK,
            crate::ids::INSP_WHEEL_UNMOUNT,
            // §13 (W1): o eyedropper que arma o pick da CORDA.
            crate::ids::INSP_WHEEL_ROPE_PICK,
        ],
    );
    ...
    register_button_ids(store, &crate::ids::INSP_PHYS_JOIN_KIND);
    ...
    for (id, value, min, max, step) in [
        ...
        (crate::ids::INSP_JOINT_LIMIT_MIN, -45.0, -360.0, 360.0, 1.0), // LITERAL-PX-OK: degrees
        (crate::ids::INSP_JOINT_LIMIT_MAX, 45.0, -360.0, 360.0, 1.0),  // LITERAL-PX-OK: degrees
        ...
        (
            ...
            3600.0,
            1.0,
        ), // LITERAL-PX-OK: degrees or m
        (crate::ids::INSP_JOINT_MOTOR_FORCE, 10.0, 0.0, 10000.0, 0.1), // LITERAL-PX-OK: N·m ceiling
        (crate::ids::INSP_JOINT_REST_LENGTH, 1.0, 0.0, 1000.0, 0.01),  // LITERAL-PX-OK: meters
        (crate::ids::INSP_JOINT_STIFFNESS, 30.0, 0.0, 100000.0, 1.0), // LITERAL-PX-OK: spring constant
        (crate::ids::INSP_JOINT_DAMPING, 0.5, 0.0, 1000.0, 0.1), // LITERAL-PX-OK: damping constant
        ...
        (
            crate::ids::INSP_JOINT_AXIS_MIN[0],
            -1.0,
            -3600.0,
            3600.0,
            0.01,
        ...
        (
            crate::ids::INSP_JOINT_AXIS_MAX[0],
            1.0,
            -3600.0,
            3600.0,
            0.01,
        ...
        (
            crate::ids::INSP_JOINT_AXIS_MIN[1],
            -1.0,
            -3600.0,
            3600.0,
            0.01,
        ...
        (
            crate::ids::INSP_JOINT_AXIS_MAX[1],
            1.0,
            -3600.0,
            3600.0,
            0.01,
        ...
        (
            crate::ids::INSP_JOINT_AXIS_MIN[2],
            -45.0,
            -3600.0,
            3600.0,
            1.0,
        ), // LITERAL-PX-OK: degrees
        (
            crate::ids::INSP_JOINT_AXIS_MAX[2],
            45.0,
            -3600.0,
            3600.0,
            1.0,
        ...
        (crate::ids::INSP_JOINT_BREAK_FORCE, 100.0, 0.0, 10000.0, 1.0), // LITERAL-PX-OK: newtons
        (crate::ids::INSP_JOINT_BREAK_TORQUE, 50.0, 0.0, 10000.0, 1.0), // LITERAL-PX-OK: newton-metres
        (crate::ids::INSP_JOINT_MAX_LENGTH, 1.0, 0.001, 1000.0, 0.01),  // LITERAL-PX-OK: meters
    ] {
        store.register(
            id,
...
pub(super) fn populate_wheel(store: &mut WidgetStore) {
    register_button_ids(store, &crate::ids::INSP_WHEEL_WRAP);
    register_button_ids(store, &crate::ids::INSP_WHEEL_BREAK);
    ...
    register_button_ids(store, &crate::ids::INSP_WHEEL_DIFF);
    for (id, value, min, max, step, rate) in [
        // Metros. O seed é o `PulleyWheel::DEFAULT_RADIUS`.
        (crate::ids::INSP_WHEEL_RADIUS, 0.25, 0.0, 100.0, 0.01, 0.01), // LITERAL-PX-OK: meters
        (
            ...
            0.01,
            0.01,
        ), // LITERAL-PX-OK: meters
        // 1-based, como a row mostra.
        (crate::ids::INSP_WHEEL_ORDER, 1.0, 1.0, 99.0, 1.0, 0.1), // LITERAL-PX-OK: ordinal
        ...
        (crate::ids::INSP_WHEEL_MOTOR, 0.0, -3600.0, 3600.0, 1.0, 1.0), // LITERAL-PX-OK: deg/s
...
pub(super) fn populate_physics(store: &mut WidgetStore) {
    register_button_ids(store, &crate::ids::INSP_PHYS_KIND);
    register_button_ids(store, &crate::ids::INSP_PHYS_SHAPE);
    register_button_ids(store, &crate::ids::INSP_PHYS_LAYER);
    register_button_ids(store, &crate::ids::INSP_PHYS_SENSOR);
    register_button_ids(store, &crate::ids::INSP_PHYS_CCD);
    register_button_ids(store, &crate::ids::INSP_PHYS_LOCKROT);
    register_button_ids(store, &crate::ids::INSP_PHYS_LOCKX);
    register_button_ids(store, &crate::ids::INSP_PHYS_LOCKY);
    register_button_ids(store, &crate::ids::INSP_PHYS_MASSMODE);
    register_button_ids(store, &crate::ids::INSP_PHYS_REST_COMBINE);
    register_button_ids(store, &crate::ids::INSP_PHYS_FRIC_COMBINE);
    register_button_ids(store, &crate::ids::INSP_PHYS_DAMPMODE);
    register_button_ids(store, &crate::ids::INSP_PHYS_ONEWAY);
    register_button_ids(store, &crate::ids::INSP_PHYS_WALLMAT);
    register_button_ids(store, &crate::ids::INSP_PHYS_FORCE_AXES);
    register_button_ids(store, &crate::ids::INSP_PHYS_BAKE_CH);
    register_button_ids(
        store,
        &[
            crate::ids::INSP_PHYS_ADD,
            crate::ids::INSP_PHYS_BAKE,
            crate::ids::INSP_PHYS_REMOVE,
        ],
    );
    ...
    for (id, value, min, max, step) in [
        (crate::ids::INSP_PHYS_RADIUS, 0.5, 0.001, 1000.0, 0.01), // LITERAL-PX-OK: meters
        (crate::ids::INSP_PHYS_HALF_X, 0.5, 0.001, 1000.0, 0.01), // LITERAL-PX-OK: meters
        (crate::ids::INSP_PHYS_HALF_Y, 0.5, 0.001, 1000.0, 0.01), // LITERAL-PX-OK: meters
        ...
        (crate::ids::INSP_PHYS_CAP_HALF_H, 0.25, 0.0, 1000.0, 0.01), // LITERAL-PX-OK: meters
        ...
        (crate::ids::INSP_PHYS_OFFSET_X, 0.0, -1000.0, 1000.0, 0.01), // LITERAL-PX-OK: meters
        (crate::ids::INSP_PHYS_OFFSET_Y, 0.0, -1000.0, 1000.0, 0.01), // LITERAL-PX-OK: meters
        ...
        // regra.
        (crate::ids::INSP_PHYS_WALK_GRIP, 1.0, 0.0, 4.0, 0.05), // LITERAL-PX-OK: multiplier
        ...
        (crate::ids::INSP_PHYS_WALK_BELT, 0.0, -20.0, 20.0, 0.1), // LITERAL-PX-OK: m/s
        ...
        (crate::ids::INSP_PHYS_LINVEL_X, 0.0, -100.0, 100.0, 0.1), // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PHYS_LINVEL_Y, 0.0, -100.0, 100.0, 0.1), // LITERAL-PX-OK: m/s
        (crate::ids::INSP_PHYS_ANGVEL, 0.0, -3600.0, 3600.0, 1.0), // LITERAL-PX-OK: deg/s
        (crate::ids::INSP_PHYS_DENSITY, 1.0, 0.0, 1000.0, 0.01),   // LITERAL-PX-OK: kg/m^2
        ...
        (crate::ids::INSP_PHYS_MASS, 1.0, 0.001, 100000.0, 0.1), // LITERAL-PX-OK: kg
        (crate::ids::INSP_PHYS_RESTITUTION, 0.0, 0.0, 1.0, 0.01), // LITERAL-PX-OK: bounciness is 0..=1 by physics
        (crate::ids::INSP_PHYS_FRICTION, 0.5, 0.0, 10.0, 0.01), // LITERAL-PX-OK: Coulomb coefficient, >1 is legal
        ...
        (crate::ids::INSP_PHYS_GRAVITY_SCALE, 1.0, -10.0, 10.0, 0.1), // LITERAL-PX-OK: dimensionless gravity multiplier
        ...
        (crate::ids::INSP_PHYS_DOMINANCE, 0.0, -10.0, 10.0, 1.0), // LITERAL-PX-OK: integer collision priority
        ...
        (crate::ids::INSP_PHYS_LINEAR_DAMPING, 0.0, 0.0, 10.0, 0.05), // LITERAL-PX-OK: linear drag coefficient
        (crate::ids::INSP_PHYS_ANGULAR_DAMPING, 0.0, 0.0, 10.0, 0.05), // LITERAL-PX-OK: angular drag coefficient
        ...
        (crate::ids::INSP_PHYS_FORCE_X, 0.0, -1000.0, 1000.0, 0.5), // LITERAL-PX-OK: newtons
        (crate::ids::INSP_PHYS_FORCE_Y, 0.0, -1000.0, 1000.0, 0.5), // LITERAL-PX-OK: newtons
        ...
        (crate::ids::INSP_PHYS_AREA_TORQUE, 0.0, -1000.0, 1000.0, 0.5), // LITERAL-PX-OK: N*m
        ...
        (crate::ids::INSP_PHYS_AREA_FALLOFF, 0.0, 0.0, 1.0, 0.05), // LITERAL-PX-OK: fracao 0..1
        // The medium's resistance. Same range as the other drag knobs in this app —
        // it is the same law, so it must be the same numbers.
        (crate::ids::INSP_PHYS_AREA_DRAG, 0.0, 0.0, 10.0, 0.05), // LITERAL-PX-OK: drag coefficient
        ...
        (crate::ids::INSP_PHYS_AREA_DENSITY, 0.0, 0.0, 1000.0, 0.05), // LITERAL-PX-OK: kg/m^2
        ...
        (crate::ids::INSP_PHYS_AREA_FORM_DRAG, 0.0, 0.0, 10.0, 0.05), // LITERAL-PX-OK: coef. de forma
    ] {
        store.register(
            id,
            InteractiveState::NumberInput {
