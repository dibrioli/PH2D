...
use crate::gizmo::{Anchor, Handle, Motion};
...
pub fn stroke_for(code: winit::keyboard::KeyCode) -> Option<Stroke> {
...
pub fn edit(text: &str, s: Stroke) -> Option<String> {
...
pub fn value_of(text: &str) -> Option<f32> {
...
pub fn accepts(handle: Handle) -> bool {
...
pub fn label(handle: Handle, text: &str) -> String {
    match handle {
