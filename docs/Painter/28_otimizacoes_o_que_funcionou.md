...
## ⛔ Recusas MEDIDAS — 47, e nenhuma volta à fila

> ⚠️ **Este doc foi cortado em 2026-08-18** e a narrativa foi **verbatim** para
> [`28_otimizacoes_o_que_funcionou.md`](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md) — a remontagem das duas metades confere sha256 com o original.
>
...
| onde | a recusa |
|---|---|
| [(topo)](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L10) | ⛔ O que estiver aqui marcado **«medido e REJEITADO»** continua rejeitado: uma |
| [2.3 A admissibilidade, e a coincidência que não é coincidência](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L68) | ela rende exactamente onde o custo está e é recusada exactamente onde erraria.** |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L135) | 5.4 ⛔ A LUT **NÃO** transfere para Watercolor — e a razão é estrutural |
| [5.7 ✅ E o segundo padrão que transfere: **um walk puro por-texel camin](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L177) | Wet Paint** — ⛔ **NÃO transfere, e não é falta de vontade:** o solver é **serial por semântica** |
| [5.10 ✅ DE QUE É FEITO UM MOVE DE AQUARELA — e a tabela que se auto-cal](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L241) | `warp_offset` roda **10× por texel** (centro + 9 taps). ⛔ **Cortar taps está FORA de discussão e não é |
| [A aritmética, TESTADA em vez de afirmada](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L420) | ## ⛔ ERRATA — ESTA ARITMÉTICA FECHAVA POR COINCIDÊNCIA, E A CAUSA É OUTRA (ver **§5.14**) |
| [⚠️ E DUAS coisas minhas que a medição derrubou](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L444) | 2. **A hipótese que eu montei em cima daquele 117,8 — *"é o first-touch do 1º traço"* — está REFUTADA |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L647) | ⛔ MEDIDO E REJEITADO — não refaça: paralelizar a EXTRAÇÃO da janela |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L702) | 5.17 ⛔ S1 TENTADA E REVERTIDA — `mark_dirty` declara onde a IMAGEM mudou, não onde os BYTES foram escritos |
| [5.23 🔩 S3, degrau 2 — o censo foi a ZERO, e os 12 eram TRÊS mecanismos](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L1079) | substituição que muda a FORMA é recusada pelo journal (o stride não mede o plano velho) — o que é |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L1384) | ⛔ E a MESMA pergunta feita no COMMIT não é respondível ali — a tentativa, e o porquê |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L1711) | 5.31.4 Três hipóteses minhas, as três refutadas por medição |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L1966) | 5.36 ⛔ E AQUI O AGENDAMENTO ACABA — o teto passa a ser FÍSICO, medido e nomeado |
| [§5.39 — O SOLVER NÃO É GAUSS-SEIDEL EM TODA PARTE: um passo 16,08 → 10](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L2119) | ⛔ **E quatro ficam SERIAIS por semântica, cada um com o mecanismo escrito:** |
| [Gates: 6 + 8 mutações](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L2177) | `walk_rows2` é **rejeitada pelo compilador** (os tipos genéricos a tornam |
| [E é aqui que a CPU acaba, com o número do piso ao lado](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L2275) | três recusados pelo ADR-0145 §2, cada um com o mecanismo escrito, e o `advect` |
| [E o smoke do Enio CONFIRMOU o veredito, com um número que eu não tinha](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L2330) | ⛔ **E evenar isso na CPU é impossível — as três saídas foram checadas e as três |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L2918) | §5.44.2 ⛔ MEDIDO E REJEITADO — não refaça: reusar a moldura bilinear |
| [§5.45.4 — O que a troca de modelo custa](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L3034) | foi **REFUTADA por medição**: os dois modelos correm igual para cima e para baixo (1,14× e 1,09×). |
| [§5.46.7 — Quem é o dono agora, e o que a medição diz sobre ele](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L3239) | ⛔ **MEDIDO E NÃO FEITO — o alcance do gather NÃO pode ser apertado por |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L3294) | §5.46.10 — ⛔ MEDIDO E REJEITADO — não refaça: materializar o K/S do K–M |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L3376) | §5.47 — TRÊS hipóteses minhas sobre a água lenta, medidas e REJEITADAS — e o instrumento que sobrou (2026-07-31) |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L3425) | §5.47.2 — ⛔ MEDIDO E REJEITADO — não refaça: encolher o pool do rayon |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L3449) | §5.47.3 — ⛔ MEDIDO E REJEITADO: a água publica um retângulo maior que os outros meios |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L3512) | §5.48 — O TRAÇO lento: a espiral REFUTADA, e a linha do log que não decidia nada (2026-07-31) |
| [§5.48.1 — Duas medições antes de qualquer hipótese](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L3534) | ⛔ **E a espiral está REFUTADA.** O comentário do `painter_canvas_move` descreve |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L3711) | §5.50.1 — ⛔ MEDIDO E REJEITADO: a poça já existente não é o ingrediente |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L4543) | ⛔ MEDIDO E REJEITADO — não refaça: devolver o motor na fronteira |
| [5.58.1 🗺️ O MAPA da troca — os donos, onde cada um é posto, e a ordem](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L4679) | 2. **promover o journal para release** — ⛔ **não pode landar sozinha**, e agora com um segundo motivo |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L4706) | ⛔ Atalho 1, morto: *"reconstruir o cursor e seguir como está"* |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L4714) | ⛔ Atalho 2, morto: *"materializar só quando o journal não está vazio"* |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L4813) | 5.59.3 ⛔ O degrau 4 não é mecânico — a elisão joga fora a ENTRADA do fallback |
| [§5.60 — E O DEGRAU 4 FOI RE-DESENHADO PELA TERCEIRA VEZ: elidir o `bef](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L4892) | alocador (hipótese refutada por medição), era o **detector da absorção** disparando em todo pen-down. |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5008) | ⛔ A hipótese que quase virou a explicação — REFUTADA por medição |
| [§5.64 — "DEPOIS DE VÁRIOS TRAÇOS O IMPASTO FICA LENTO": três hipóteses](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5213) | ⛔ **TRÊS hipóteses, TRÊS rejeições por medição — nenhuma confirmada:** |
| [§5.64 — "DEPOIS DE VÁRIOS TRAÇOS O IMPASTO FICA LENTO": três hipóteses](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5215) | 1. **O(histórico)** (*"depois de vários"* é a assinatura). **Refutada:** 80 traços a 4096², histórico de |
| [§5.64 — "DEPOIS DE VÁRIOS TRAÇOS O IMPASTO FICA LENTO": três hipóteses](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5219) | quadro muda o custo por evento). **Refutada** por ablação 2×2: com dreno e sem dreno, **4,31 × 4,33 · |
| [⚠️ O que a medição REFUTOU, e por isso a próxima wave não foi aberta](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5346) | outra coisa, e escrever uma cura em cima da hipótese refutada seria escolher um culpado por eliminação — |
| [§5.66 — A janela NÃO é o problema: o bbox da MUDANÇA já é 89% (2026-08](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5393) | Duas medições depois, ela está metade certa e metade REFUTADA.** |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5413) | 2. ⛔ REFUTADO: apertar a janela não cura |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5501) | 3. ⛔ A conclusão que eu tirei daí, e por que ela era falsa |
| [2. O que a contagem achou — e o que ela REFUTOU](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5878) | ⚠️ **A minha hipótese do CLAMP foi refutada na primeira corrida:** o pour é **idêntico nas duas |
| [5. O que ficou, e o que NÃO foi construído](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5940) | ⛔ **A wave NÃO foi construída, e o motivo é a regra da casa:** uma wave de performance sem um número |
| [1. O alvo da §5.60 morreu na primeira medição](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L5971) | ⛔ **Todo o custo, nenhum benefício** ⇒ a porta foi **REVERTIDA inteira** (a lei da §5.44: *um doc que |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L6223) | ⛔ Três curas construídas, três medidas em ~1,00× — não as refaça |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L6357) | ⛔ E o que foi medido e NÃO é resultado |
| [§](../archive/docs-2026-08-18/Painter/28_otimizacoes_o_que_funcionou.md#L6429) | ⛔ Medido e rejeitado — não refaça |
