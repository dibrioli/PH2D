...
use crate::overlay::shapes::collider_outline;
...
pub const PROBE_PX: f64 = 1.25; // LITERAL-PX-OK: chrome de overlay
...
const _: () = assert!(PROBE_PX < crate::overlay::outline::OUTLINE_PX);
