...
impl super::super::AudioSystem {
    ...
    pub fn editor_publish_spectral(&mut self) {
    ...
    pub fn editor_spectrogram_rgba(
        &mut self,
        w: u32,
        h: u32,
        theme: Theme,
    ...
    pub fn editor_set_spectral_band(&mut self, a: f32, b: f32) {
    ...
    pub fn editor_learn_noise(&mut self) {
        let Some(clip) = self.editor.clip.as_ref() else {
            return;
        };
    ...
    pub fn editor_denoise(&mut self) {
    ...
    #[cfg(feature = "audio-ml")]
    pub fn editor_denoise_ml(&mut self) {
    ...
    #[cfg(feature = "audio-ml")]
    pub fn editor_ml_busy(&self) -> bool {
        self.ml_job.is_some()
    }
    ...
    #[cfg(feature = "audio-ml")]
    pub fn editor_poll_ml(&mut self) {
