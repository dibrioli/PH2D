...
//!
//! Irmão do [`crate::overlay::joints`], separado porque é o único tipo
...
use crate::overlay::joint_glyphs::{ARC_SEGS, ring_px, screen_of};
use crate::overlay::joints::JOINT_DOT_PX;
