//! **As seis vistas nomeadas** — a lei vive na [`ph2d_viewport3d::views`], partilhada com a escultura.
//!
//! ⚠️ **Este alias existe para o TESTE, não para o código.** `views_tests.rs` exercita a lei
