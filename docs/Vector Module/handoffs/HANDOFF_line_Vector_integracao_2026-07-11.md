...
| `crates/ph2d-editor-core/tests/it/node_id_collisions.rs` (+~30) | 17 linhas em `CHROME_IDS` + teste `vector_dynamic_ids_dont_collide_with_chrome_or_each_other` | ⚠️ lista hand-maintained — conflito textual se outra linha adicionar ids |
...
| `crates/ph2d-editor-core/tests/it/arch_mode_has_reconcile.rs` (+4) | linha p/ `VectorTool::set_mode` | aditivo |
