...
pub const LANES: [(&str, Option<PlayerMode>, [f32; 4]); 3] = [
...
pub fn physics_smoke_blast(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn build_blast_scene(world: &mut bevy_ecs::world::World) -> Vec<Entity> {
    slab(
        world,
        "Floor",
        Vec2::new(0.0, -0.5),
...
pub const BLAST_SMOKE_MESSAGE: &str = concat!(
