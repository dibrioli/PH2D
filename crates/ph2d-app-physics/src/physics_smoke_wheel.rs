...
pub const MEASURED_RIGID_DIST_M: f32 = 6.71;
...
pub const BUMP_HALF_Y: f32 = 0.05;
...
pub fn spawn_props_with(world: &mut World, bump_half_y: f32) {
...
pub fn physics_smoke_wheel(ctx: &mut crate::SceneCtx<'_>) {
