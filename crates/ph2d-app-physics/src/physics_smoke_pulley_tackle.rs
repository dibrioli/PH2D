...
use crate::physics_smoke_pulley::{BOOM_Y, GROUND, POST, R, ball};
use ph2d_core::Vec2;
...
pub const MEASURED_TACKLE_DRIFT: f32 = 0.02;
...
/// do produto.
pub const MEASURED_PLAIN_DROP: f32 = 3.15;
...
pub const MEASURED_SNAP_TARGETS: usize = 5;

/// Monta a cena 61.
pub fn build_tackle(world: &mut World) {
    world.spawn((
        Name::new("Floor"),
        RigidBody {
            kind: BodyKind::Static,
...
pub fn physics_smoke_tackle(ctx: &mut crate::SceneCtx<'_>) {
