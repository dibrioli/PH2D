...
//! brilhar"*).
//!
//! ## Por que um assador SEPARADO do [`crate::motion::motion_object_bake`]
//!
...
use crate::motion::motion_object_bake::{BAKE_DPI, MAX_TILE_SIDE};
...
/// até a placa acabar. O irmão [`crate::motion::motion_object_bake`] pareia cada `acquire`
