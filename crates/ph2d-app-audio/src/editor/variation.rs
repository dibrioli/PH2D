...
impl AudioSystem {
    ...
    pub fn editor_add_variation(&mut self, path: &Path) {
    ...
    pub fn editor_add_variation_folder(&mut self, dir: &Path) {
    ...
    pub fn editor_remove_variation(&mut self, sel: usize) {
    ...
    pub fn editor_cycle_variation_strategy(&mut self, steps: i32) {
    ...
    pub fn editor_bump_variation_weight(&mut self, sel: usize, steps: i32) {
    ...
    pub fn editor_set_variation_jitter(&mut self, pitch_norm: f32, gain_norm: f32) {
    ...
    pub fn editor_play_variation(&mut self) {
        let Some(i) = self
            .editor
            .variation_picker
    ...
    pub fn editor_save_variation_set(&self, path: &Path) {
    ...
    pub fn editor_load_variation_set(&mut self, path: &Path) {
    ...
    pub fn editor_toggle_variation_enabled(&mut self) {
    ...
    pub fn editor_variation_enabled(&self) -> bool {
        let sel = ph2d_panel_audio_editor::variation_sel();
        self.editor
            .variation_set
            .entries
    ...
    pub fn editor_variation_names(&self) -> Vec<String> {
        self.editor
            .variation_set
            .entries
            .iter()
    ...
    pub fn editor_variation_smoke(&mut self) {
