//! **O menu de vistas** — a lei vive na [`ph2d_viewport3d::view_menu`].
//!
//! ⚠️ **Este alias existe por UM motivo só: não editar a árvore de outra linha.** `crate::field3d_view_menu`
...
//! escrever `ph2d_viewport3d::view_menu` directamente. *Um alias com data de validade escrita é dívida
