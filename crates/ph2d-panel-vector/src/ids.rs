...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_MODE_RRECT, VECTOR_MODE_STAR, VECTOR_PANEL, VECTOR_RRECT_RADIUS, VECTOR_RRECT_RADIUS_NUM,
    VECTOR_SIDES, VECTOR_SIDES_NUM, VECTOR_STAR_INNER, VECTOR_STAR_INNER_NUM, VECTOR_STAR_POINTS,
    VECTOR_STAR_POINTS_NUM, VECTOR_STROKE_SWATCH, VECTOR_VERT_CORNER, VECTOR_VERT_DELETE,
