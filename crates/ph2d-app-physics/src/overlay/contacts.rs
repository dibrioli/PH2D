...
pub const CONTACT_RGBA: [f32; 4] = [1.0, 1.0, 1.0, 0.85]; // LITERAL-COLOR-OK: overlay de contato
...
/// saying "this one, now".
pub const CONTACT_FLASH_RGBA: [f32; 4] = [1.0, 1.0, 1.0, 1.0]; // LITERAL-COLOR-OK: flash de contato
...
pub const WATERLINE_RGBA: [f32; 4] = [0.45, 0.85, 1.0, 0.75]; // LITERAL-COLOR-OK: overlay de linha d'agua
