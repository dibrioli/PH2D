//! ⭐⭐⭐ **NENHUMA PALAVRA DO PAINEL FLIP É ESCRITA NO FONTE** — o HR-15, por crate.
//!
//! Migrado em 2026-09-16 (`scripts/migrar-texto-pintado.py`, mapa
//! `docs/UI_New_and_Simple/ferramentas/seccoes_flip.tsv`): o painel escrevia **84** textos no fonte, medidos
