...
const JOINT_RGBA: [f32; 4] = [0.98, 0.75, 0.25, 0.9]; // LITERAL-COLOR-OK: overlay de joint
...
mod tests {
    ...
    use super::{DYNAMIC_RGBA, STATIC_RGBA, collider_outline, joint_marks, outlines};
    use ph2d_host::WindowSize;
...
mod joint_tests {
    ...
    use super::{CIRCLE_SEGS, joint_marks};
    use ph2d_host::WindowSize;
    use ph2d_render::Camera2d;
    use ph2d_vector::PathEl;
