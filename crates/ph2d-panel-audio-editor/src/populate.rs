...
use crate::{
    ...
    AEDIT_LOOP_XFADE, AEDIT_NAME, AEDIT_NORM_LUFS, AEDIT_NORMALIZE, AEDIT_PLAY, AEDIT_PRESET_APPLY,
    AEDIT_PRESET_LOAD, AEDIT_PRESET_NEXT, AEDIT_PRESET_PREV, AEDIT_PRESET_SAVE, AEDIT_REDO,
    AEDIT_REVERSE, AEDIT_SILENCE, AEDIT_STOP, AEDIT_TRIM, AEDIT_UNDO, loop_state,
};
...
pub(crate) fn populate(store: &mut WidgetStore) {
    ...
    for id in [
        ...
        AEDIT_PRESET_SAVE,
        AEDIT_PRESET_LOAD,
        // Loop points (W6): Set from selection · Clear · Snap · Audition toggle.
        AEDIT_LOOP_SET,
        AEDIT_LOOP_CLEAR,
        AEDIT_LOOP_SNAP,
        AEDIT_LOOP_AUDITION,
