...
pub fn cena_11() -> Result<FieldDoc, ph2d_field::FieldError> {
    println!(
...
pub fn cena_12() -> Result<FieldDoc, ph2d_field::FieldError> {
    println!(
...
pub fn cena_13() -> Result<FieldDoc, ph2d_field::FieldError> {
    println!(
