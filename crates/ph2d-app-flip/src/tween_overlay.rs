...
//! diferentes — cada lado tem seu afim ([`crate::tween_correct::screen_affine`]).
...
use crate::tween_correct::{Side, TweenCorrect, screen_affine, stroke_centroid};
