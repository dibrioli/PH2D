...
pub const MEASURED_TOP_Y: [f32; 2] = [-0.65, 1.15];
...
pub const MEASURED_LEG_TIP_Y: [f32; 2] = [-2.60, -0.80];
...
pub fn build_compound(world: &mut World) {
...
pub fn physics_smoke_compound(ctx: &mut crate::SceneCtx<'_>) {
