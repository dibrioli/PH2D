...
**Status:** FECHADO 2026-07-23 · no `main` em `494c12477` (o commit que trouxe este arquivo).
...
1. **Texto em caminho** (`<textPath>` do SVG / *Type on a Path* do Illustrator). Motor arco→afim por
   ...
   Plano: [`docs/Vector Module/22_plano_texto_em_caminho.md`](../22_plano_texto_em_caminho.md).
...
2. **Pattern along path** (o *Pattern Brush* rígido do Illustrator / item #11 da pesquisa `20_*`). Um
   ...
   **Slide** (desliza o trecho inteiro), **Offset** (perpendicular), **Side** (o lado).
   Plano: [`docs/Vector Module/23_plano_pattern_along_path.md`](../23_plano_pattern_along_path.md).
...
- Picker: sem realce da FONTE (só do guia sob o cursor); sem tecla Escape dedicada (o botão direito e
  o clique no vazio já desistem). Detalhe em [`docs/Vector Module/23_plano_pattern_along_path.md`](../23_plano_pattern_along_path.md) §7.
