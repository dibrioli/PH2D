//! §11 Physics Body — the Inspector snapshot struct and edit enum for the
//! **body** (ADR-0131 D8).
//!
//! ⚠️ A §12 (o objeto-joint) e a §13 (a roldana) moram no irmão
//! `inspector_model_joint`, separadas daqui em W-JointCopy no cap de 700 LOC —
//! o mesmo corte que o painel já faz entre `sections/physics.rs` e
//! `sections/joint.rs`.
//!
