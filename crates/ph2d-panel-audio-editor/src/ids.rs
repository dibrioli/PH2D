...
//!
//! ⭐ **Desceram da fundação em 2026-09-13** (auditoria de arquitectura A5b): em 30 dias, 221 dos 437
...
//!
//! ⚠️ **UMA definição e ZERO re-exportações**: quem lê de fora nomeia `ph2d_panel_audio_editor::ids::X`. As colisões
