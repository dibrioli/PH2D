...
pub(crate) fn tr(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "panel.inspector.audio.max_distance_m" => "Max Distance (m)",
        "panel.inspector.audio.attenuation" => "Attenuation",
        "panel.inspector.audio.non_spatialized_radius_m" => "Non-Spatialized Radius (m)",
        ...
        "panel.inspector.camera.height_m" => "Height (m)",
        "panel.inspector.camera.offset_m" => "Offset (m)",
        ...
        "panel.inspector.camera.lookahead_s" => "Lookahead (s)",
        "panel.inspector.camera.follow_offset_m" => "Follow Offset (m)",
        ...
        "panel.inspector.camera.min_m" => "Min (m)",
        "panel.inspector.camera.max_m" => "Max (m)",
        ...
        "panel.inspector.joint.rest_length_m" => "Rest Length (m)",
        "panel.inspector.joint.stiffness" => "Stiffness",
        "panel.inspector.joint.damping" => "Damping",
        "panel.inspector.joint.length_m" => "Length (m)",
        "panel.inspector.joint.rope_length_m" => "Rope Length (m)",
        "panel.inspector.joint.max_length_m" => "Max Length (m)",
        ...
        "panel.inspector.joint.break_force_n" => "Break Force (N)",
        "panel.inspector.joint.break_torque_n_m" => "Break Torque (N.m)",
        ...
        "panel.inspector.physics.radius_m" => "Radius (m)",
        "panel.inspector.physics.half_height_m" => "Half Height (m)",
        "panel.inspector.physics.half_width_m" => "Half Width (m)",
        ...
        "panel.inspector.physics.offset_x_m" => "Offset X (m)",
        "panel.inspector.physics.offset_y_m" => "Offset Y (m)",
        ...
        "panel.inspector.physics.force_x_n" => "Force X (N)",
        "panel.inspector.physics.force_y_n" => "Force Y (N)",
        ...
        "panel.inspector.wheel.radius_m" => "Radius (m)",
        "panel.inspector.wheel.out_radius_m" => "Out Radius (m)",
        ...
        "panel.inspector.wheel.break_force_n" => "Break Force (N)",
        ...
        "panel.inspector.physics.init_vel_x_m_s" => "Init Vel X (m/s)",
        "panel.inspector.physics.init_vel_y_m_s" => "Init Vel Y (m/s)",
        "panel.inspector.physics.init_spin_deg_s" => "Init Spin (deg/s)",
        "panel.inspector.physics.belt_m_s" => "Belt (m/s)",
        ...
        "panel.inspector.wheel.motor_s" => "Motor (\u{00b0}/s)",
