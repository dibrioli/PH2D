...
//! API surface.
//
// Tecto de LOC NUMERADO em `tests/it/file_loc_caps.rs` — a struct `App` sozinha são ~940 linhas (187
// campos, cada um com o doc do DONO dele), e um ficheiro com ela não cabe em 600 sem a partir.
...
#[path = "app_state_gfx.rs"]
mod gfx; // os recursos que nascem no `resumed` (LOC cap: sibling module)
pub(crate) use gfx::AppGfx;
...
pub(crate) struct App {
    ...
    /// ⭐⭐⭐ **A RECEITA que acabou de abrir e ainda espera pelo palco** (Enio, 2026-09-07), em
    /// bits de `Entity`.
    ///
    ...
    pub(crate) texture_pattern_live: ph2d_vec_art_live::pattern::TexturePatternLive,
    /// O memo da arte dos pincéis — ver [`ph2d_vec_art_live::brush::BrushLive`] para os números.
    pub(crate) brush_live: ph2d_vec_art_live::brush::BrushLive,
...
pub(crate) use components_smokes::{ComponentsShell, CounterWatchShell, SequenceShell};
