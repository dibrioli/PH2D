...
pub use ph2d_tool_equalize_sizes::ids::{
    EQS_ALG_LANCZOS, EQS_ALG_NEAREST, EQS_ALG_XBR, EQS_APPLY, EQS_CANCEL, EQS_FIXED_H, EQS_FIXED_W,
    EQS_GRID_UNIT, EQS_GRID_UNIT_NUM, EQS_MODE_FIXED, EQS_MODE_GRID, EQS_MODE_MAX, EQS_PANEL,
    EQS_RASTERIZE_AFTER, EQS_UPSCALE_IF_SMALLER,
};
