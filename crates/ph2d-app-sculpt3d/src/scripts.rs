...
pub(crate) fn for_scene(mesh: &ph2d_mesh::Mesh) {
    ...
    if crate::directional_alpha_scene() {
    ...
    if crate::transform_scene() {
        ...
        let (band, total) = crate::soft_masked_counts();
        eprintln!(
    ...
    if crate::extract_scene() {
        ...
        eprintln!(
            ...
            crate::masked_dome_counts().0,
            crate::masked_dome_counts().1,
        );
    }
    if crate::fuse_scene() {
    ...
    crate::scenes::filter::announce();
    crate::scenes::cloth_filter::announce();
    crate::scenes::viewports::announce();
    crate::scenes::quad::announce();
    crate::scenes::ear::announce();
    crate::scenes::alcance::announce();
    crate::scenes::boundary::announce();
    crate::scenes::erase::announce();
    crate::scenes::smear::announce();
    crate::scenes::projectar::announce();
    crate::scenes::trim::announce();
