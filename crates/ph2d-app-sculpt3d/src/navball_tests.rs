...
/// `ph2d_viewport3d::views::Standard::eye_axis` já escreve para o módulo vizinho, e a
...
fn as_seis_teclas_de_vista_chegam_todas_a_uma_vista() {
    ...
    for code in [K::Numpad1, K::Numpad3, K::Numpad7] {
        for ctrl in [false, true] {
            let v = ph2d_viewport3d::views::view_for_key(code, ctrl)
...
fn um_clique_na_bola_muda_a_camera_e_um_arrasto_nao() {
    ...
    let mut s = crate::Sculpt3dScene::new(&gpu.device, uv_sphere(12, 18, 1.0), 1.0);
