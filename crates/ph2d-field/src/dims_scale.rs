    ...
    match p {
        ...
        Primitive::Star {
            ...
            *round *= factor;
            ...
            // deles fixo faria a aresta mudar de carácter ao redimensionar a forma.
            *chamfer *= factor;
            // ⚠️ **E o das QUINAS também** (W143/W144): é um comprimento como os outros três, e o
            // tecto dele escala com `outer − inner`, logo a razão ao tecto fica invariante.
            *corner_chamfer *= factor;
        }
        Primitive::BoxFrame {
            half,
            thickness,
        ...
        | Primitive::Document { .. }
        | Primitive::Helix { .. }
        | Primitive::Gyroid { .. }) => crate::dims_scale_signs::scale_sign(p, factor),
    }
    true
}
