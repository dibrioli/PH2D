...
//!
//! A ponte com a cena (`scene::ecs_bridge`) recebe o **mundo**, e três gestos do painel não
...
pub fn take_export_request() -> Option<crate::export::ExportLevel> {
    EXPORT.with(std::cell::Cell::take)
}

pub fn ask_export(level: crate::export::ExportLevel) {
    EXPORT.with(|c| c.set(Some(level)));
}

thread_local! {
    static EXPORT: std::cell::Cell<Option<crate::export::ExportLevel>> =
...
pub fn take_import_request() -> bool {
...
pub fn take_pending_sculpt() -> Option<String> {
    PENDING_SCULPT.with(|c| c.borrow_mut().take())
}

pub fn ask_spawn_sculpt(key: String) {
...
pub fn take_sculpt_extent() -> Option<f32> {
    SCULPT_EXTENT.with(std::cell::Cell::take)
}

pub fn ask_sculpt_extent(extent: f32) {
...
// para [`crate::notice`] na W25, quando apareceu o segundo produtor — a peça que não
...
/// portas discordarem.
pub fn take_open_panel_request() -> bool {
...
pub fn forget_open_panel_request() {
...
pub fn set_armed_by_panel(open: bool) {
...
pub fn take_isolate_key_request() -> bool {
    ISOLATE_KEY.with(std::cell::Cell::take)
}

pub fn ask_isolate_key() {
...
pub fn take_profile_request() -> Option<ProfileShape> {
    PROFILE_REQ.with(std::cell::Cell::take)
}

pub fn ask_profile_shape(which: ProfileShape) {
...
pub fn take_pending_profile() -> Vec<(ph2d_field::Primitive, f32, u64)> {
...
pub fn ask_spawn_profile(prim: ph2d_field::Primitive, extent: f32, path: u64) {
...
/// seu.
pub fn take_relink_request() -> Option<u64> {
    RELINK_REQ.with(std::cell::Cell::take)
}

pub fn ask_relink_sculpt(entity: u64) {
...
pub fn take_relinked() -> Option<(u64, String)> {
    RELINKED.with(|c| c.borrow_mut().take())
}

pub fn ask_relinked(entity: u64, key: String) {
...
pub fn take_scene_sculpt_request() -> bool {
    SCENE_SCULPT.with(std::cell::Cell::take)
}

pub fn ask_scene_sculpt() {
...
pub fn take_shape_palette_request() -> bool {
    SHAPE_PALETTE.with(std::cell::Cell::take)
}

pub fn ask_shape_palette() {
...
pub fn take_authored_change() -> bool {
...
pub fn take_shape_request() -> Option<usize> {
    SHAPE_PICK.with(std::cell::Cell::take)
}

pub fn ask_shape(slot: usize) {
