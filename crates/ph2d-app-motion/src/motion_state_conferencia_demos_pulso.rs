...
pub const PERIOD: f32 = 0.5;
pub const BPM: f32 = 60.0 / PERIOD;
...
pub fn build_pulse_demo_document(doc: &mut MotionDoc, reg: &NodeRegistry) -> Option<Vec<NodeId>> {
    let g = &mut doc.graph;
