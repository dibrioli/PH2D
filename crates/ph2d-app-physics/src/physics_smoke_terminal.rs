...
pub fn physics_smoke_terminal(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn build_terminal_scene(world: &mut bevy_ecs::world::World) -> Vec<Entity> {
    LANES
        .iter()
        .enumerate()
...
pub const TERMINAL_SMOKE_MESSAGE: &str = concat!(
