...
| ⭐⭐⭐ [`08_a_luz_indirecta.md`](08_a_luz_indirecta.md) | *«a luz que ricocheia»* — a **`W5`**: a caixa de Cornell como régua (o sangramento de cor, cujo **sinal se conhece antes de medir**), a referência convergida, e as DUAS tabelas que escolheram a rota — o preço (`8,8 ms` no aberto, `40×` mais numa caixa fechada) e o erro por número de direcções. ⛔ O erro **não encolhe monotonamente**, e é propriedade do estimador determinístico |
