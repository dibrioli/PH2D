...
| `z_order` | **`0` cravado** para TODA instância de Motion — e continua | ✅ **exprimível pela SUB-ORDEM** (2026-08-25, [ADR-0070-amendment-8](../../architecture/decisions/0070-amendment-8.md)): o `z_order` fica em `0` de propósito (é o rank da HIERARQUIA), e quem ordena as linhas é o `sub_order`, lido logo a seguir |
...
4. ✅ **ENTREGUE em 2026-08-25 — e por uma rota melhor que a que este item propunha.**
   ...
   **qualquer atributo** — idade, distância à câmera, `id`, luminância —, contra a lista FECHADA de
   ...
   dentro da fatia — [ADR-0070-amendment-8](../../architecture/decisions/0070-amendment-8.md). *Um
