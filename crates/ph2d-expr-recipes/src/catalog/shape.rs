...
pub const LIMIT: Recipe = Recipe {
    ...
    knobs: &[
        Knob::num("min", "Min", -10.0, (-1000.0, 1000.0)),
        Knob::num("max", "Max", 10.0, (-1000.0, 1000.0)),
    ],
    kind: RowKind::Value,
    clock: ClockUse::None,
...
pub const FLOOR_AT: Recipe = Recipe {
    ...
    knobs: &[Knob::num("min", "Min", -10.0, (-1000.0, 1000.0))],
    kind: RowKind::Value,
    clock: ClockUse::None,
    neutral: Neutrality::NoNeutral,
    pair: None,
...
pub const CEILING_AT: Recipe = Recipe {
    ...
    knobs: &[Knob::num("max", "Max", 10.0, (-1000.0, 1000.0))],
    kind: RowKind::Value,
    clock: ClockUse::None,
    neutral: Neutrality::NoNeutral,
    pair: None,
...
pub const REMAP: Recipe = Recipe {
    ...
    knobs: &[
        Knob::num("in_lo", "In Min", 0.0, (-1000.0, 1000.0)),
        Knob::num("in_hi", "In Max", 100.0, (-1000.0, 1000.0)),
        Knob::num("out_lo", "Out Min", 0.0, (-1000.0, 1000.0)),
        Knob::num("out_hi", "Out Max", 1.0, (-1000.0, 1000.0)),
    ],
    kind: RowKind::Value,
    clock: ClockUse::None,
    neutral: Neutrality::NoNeutral,
...
pub const INVERT_RANGE: Recipe = Recipe {
    ...
    knobs: &[
        Knob::num("min", "Min", 0.0, (-1000.0, 1000.0)),
        Knob::num("max", "Max", 100.0, (-1000.0, 1000.0)),
    ],
    kind: RowKind::Value,
    clock: ClockUse::None,
    neutral: Neutrality::NoNeutral,
...
pub const QUANTIZE: Recipe = Recipe {
    ...
    knobs: &[Knob::num("step", "Step", 5.0, (0.001, 100.0))],
    kind: RowKind::Value,
    clock: ClockUse::None,
    neutral: Neutrality::NoNeutral,
    pair: None,
