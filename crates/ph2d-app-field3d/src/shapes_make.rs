...
pub fn round_of(r: f32) -> f32 {
    r * 0.1
}

pub fn a_box(r: f32) -> Primitive {
    Primitive::Box {
        half: [r; 3],
        round: round_of(r),
        chamfer: 0.0,
...
pub fn a_sphere(r: f32) -> Primitive {
    Primitive::Sphere { radius: r }
}

pub fn a_cylinder(r: f32) -> Primitive {
    Primitive::Cylinder {
        radius: r,
        half_height: r * 1.2,
        round: round_of(r),
...
pub fn a_torus(r: f32) -> Primitive {
    Primitive::Torus {
        major: r,
        minor: r * 0.35,
    }
...
///
pub fn a_truncated_cone(r: f32) -> Primitive {
    Primitive::Cone {
        bottom: r,
        top: r * 0.5,
        half_height: r * 1.2,
...
pub fn a_capsule(r: f32) -> Primitive {
    Primitive::Capsule {
        radius: r * 0.6,
        half_height: r,
    }
...
pub fn a_prism(r: f32) -> Primitive {
    Primitive::Prism {
        sides: 6,
        bottom: r,
        top: r,
...
pub fn a_pyramid(r: f32) -> Primitive {
    Primitive::Prism {
        sides: 4,
        bottom: r,
        top: 0.0,
...
pub fn a_truncated_pyramid(r: f32) -> Primitive {
    Primitive::Prism {
        sides: 4,
        bottom: r,
        top: r * 0.5,
...
pub fn a_wedge(r: f32) -> Primitive {
    Primitive::Wedge {
        half: [r, r * 0.7, r * 0.8],
...
pub fn a_torus_arc(r: f32) -> Primitive {
    Primitive::TorusArc {
        major: r,
        minor: r * 0.28,
...
pub fn a_box_frame(r: f32) -> Primitive {
    Primitive::BoxFrame {
        half: [r; 3],
        thickness: r * 0.3,
        round: round_of(r),
...
pub fn an_ellipsoid(r: f32) -> Primitive {
    Primitive::Ellipsoid {
...
pub fn an_octahedron(r: f32) -> Primitive {
...
pub fn a_round_cone(r: f32) -> Primitive {
    Primitive::RoundCone {
        bottom: r * 0.55,
        top: r * 0.22,
        half_height: r * 0.75,
...
pub fn a_cut_sphere(r: f32) -> Primitive {
    Primitive::CutSphere {
        radius: r,
        cut: r * 0.35,
        round: round_of(r) * 0.5,
...
pub fn a_hollow_dome(r: f32) -> Primitive {
...
pub fn a_solid_angle(r: f32) -> Primitive {
...
pub fn a_cross(r: f32) -> Primitive {
    Primitive::Cross {
        arm: r,
        width: r * 0.3,
        half_height: r * 0.25,
...
pub fn a_heart(r: f32) -> Primitive {
    Primitive::Heart {
        size: r * 0.6,
        half_height: r * 0.25,
...
pub fn a_trapezoid(r: f32) -> Primitive {
    Primitive::Trapezoid {
        bottom: r,
        top: r * 0.45,
        half_width: r * 0.6,
...
pub fn a_cratered_sphere(r: f32) -> Primitive {
...
pub fn a_vesica(r: f32) -> Primitive {
    Primitive::Vesica {
        radius: r,
        offset: r * 0.55,
        half_height: r * 0.25,
...
pub fn an_arrow(r: f32) -> Primitive {
    uma_seta(r, 1)
}

pub fn a_double_arrow(r: f32) -> Primitive {
    uma_seta(r, 2)
}

pub fn a_chevron(r: f32) -> Primitive {
    Primitive::Chevron {
        half_length: r,
        half_span: r * 0.75,
        thickness: r * 0.28,
...
pub fn a_bent_arrow(r: f32) -> Primitive {
    Primitive::BentArrow {
        run: r,
        rise: r,
        shaft: r * 0.2,
...
pub fn a_rhombus(r: f32) -> Primitive {
    Primitive::Rhombus {
        half_width: r,
        half_span: r * 0.62,
        half_height: r * 0.25,
...
pub fn a_washer(r: f32) -> Primitive {
    Primitive::Tube {
        outer: r,
        inner: r * 0.55,
        angle: std::f32::consts::PI,
...
pub fn a_ring_arc(r: f32) -> Primitive {
    Primitive::Tube {
        outer: r,
        inner: r * 0.62,
        angle: 1.0,
...
pub fn a_circle_segment(r: f32) -> Primitive {
