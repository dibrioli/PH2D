...
>
> **O plano é [`docs/Painter/18_plano_sculpt_relevo.md`](../18_plano_sculpt_relevo.md).** Ele
...
Leia [`18_plano_sculpt_relevo.md`](../18_plano_sculpt_relevo.md) §2 — mas em uma linha: **o kernel
