...
pub use state::{
    ...
    set_current_text_font, set_current_text_font_previews, set_current_text_has_weight,
    set_current_text_seed, set_current_text_visible, set_current_text_wrap, set_current_textpath,
