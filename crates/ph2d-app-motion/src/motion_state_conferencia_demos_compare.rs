...
pub const EPS_NARROW: f32 = 0.05;
pub const EPS_WIDE: f32 = 0.20;
...
pub const MISSING_NAME: &str = "velocty";
...
/// ⚠️ `pub` e não `pub(super)` como as irmãs: o gate do BADGE mora no
...
pub fn build_compare_demo_document(doc: &mut MotionDoc, reg: &NodeRegistry) -> Option<Vec<NodeId>> {
    let g = &mut doc.graph;
