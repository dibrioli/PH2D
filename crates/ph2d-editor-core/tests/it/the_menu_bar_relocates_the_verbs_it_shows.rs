...
/// `ph2d-panel-registry-init/tests/it/the_window_menu_reaches_every_module.rs`, que é a crate mais
...
/// `ph2d-tool-registry-init/tests/it/every_image_tool_is_reachable_without_the_legacy_bar.rs` — a
