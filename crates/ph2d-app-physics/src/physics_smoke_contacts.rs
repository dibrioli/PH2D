...
pub fn physics_smoke_contacts(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn physics_smoke_area_drag(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_buoyancy(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_form_drag(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
