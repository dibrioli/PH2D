...
- ⭐ [Fila de undo exacta SEM a seleção lê-se como fila partida — a mão pertence ao PASSO](feedback_a_correct_undo_queue_without_the_selection_reads_as_a_broken_queue.md)
...
- ⭐ [Agulha VAZIA faz o `replace` inserir entre CADA carácter (581 → 646 277 linhas): asserte a AGULHA, não a contagem](feedback_an_empty_needle_makes_replace_insert_between_every_character.md)
...
- [Membro NOVO da família de flakes de carga: o cache do Flip (razão de 2 relógios) — 4,9× a load 4,7](reference_flip_fit_cache_ratio_is_a_load_flake.md)
...
- ⛔ [Régua de vazamento cuja máscara usa o predicado DO PRODUTO lê 0,00 % sobre o defeito](feedback_a_leak_ruler_masked_by_the_products_own_predicate_hides_the_leak.md) · [viés em NDC não é constante no mundo: 3e-3 = 30 % da distância do olho](feedback_a_depth_bias_constant_in_ndc_is_not_constant_in_the_world.md)
- ⭐ [Projectar no ponto mais próximo NUNCA escolhe um ápice: todo acabamento embota pontas](feedback_projecting_to_the_nearest_surface_point_never_picks_an_apex.md)
- ⭐ [Duas leituras «inexplicáveis» podem ser a ORDEM da sonda: aqueça um passe com estado antes de medir](feedback_a_contradiction_between_two_readings_can_be_the_order_the_probe_produced_them.md)
...
- ⭐ [Gate vermelho na PRECONDIÇÃO diz que o PRODUTO saiu do regime, não que a lei errou — e uma constante do lado aprovado responde à pergunta DELE](feedback_a_gate_that_fails_on_its_precondition_says_the_product_left_the_regime.md)
...
- ⭐ [O exemplo que o Enio aponta pode ser a EXCEPÇÃO da família — censo da família ANTES do veredito (2 de 49)](feedback_the_example_the_user_points_at_may_be_the_exception_of_its_family.md)
