...
- 📚 [Comunicação & decisão: mais (54) lições, uma linha cada, verbatim](reference_topic_communication_and_decision_lessons.md)
...
- [**Ofício de gate** — a família (109)](reference_topic_gate_discipline.md)
...
- [Provas de mutação (24) — 3 controles no arnês · ⛔ corpus onde a desigualdade nunca aperta não a testa (2 de 8 sobreviveram)](reference_topic_mutation_proofs.md)
