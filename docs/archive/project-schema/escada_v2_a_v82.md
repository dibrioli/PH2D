# A ESCADA do `PROJECT_SCHEMA`, de v2 a v82 — ARQUIVO VERBATIM

> ⚠️ **Este ficheiro era `shells/desktop/src/project_schema_history.rs`** e mudou-se para cá em
> 2026-09-15, **verbatim**. O que o obrigou foi a catraca `the_shell_only_shrinks`: a escada ganha
> um parágrafo por wave e **nunca perde um**, e o tecto da shell é fixo — a colisão estava NOMEADA
> no degrau `130` (*«o degrau que não puder ser apertado tem de MOVER a escada para fora da
> shell»*), e o `131` foi esse degrau.
>
...
`sha256` do `project_schema_history.rs` movido: `9e89bc0c992891c77eb64e81a820393bd500499afe6a6253a5cd17815e4aea73`
