...
pub fn physics_smoke_events(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
...
pub fn physics_smoke_impact_demolition(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
...
pub fn physics_smoke_fast_impact(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
