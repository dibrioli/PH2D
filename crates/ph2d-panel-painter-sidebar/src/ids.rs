...
pub use ph2d_editor_core::ids::{
    ...
    PAINTER_SIDEBAR_PIGMENT_TOGGLE as PIGMENT_TOGGLE,
    PAINTER_SIDEBAR_REDO_BUTTON as REDO_BUTTON, PAINTER_SIDEBAR_SIZE_CHIP as SIZE_CHIP,
    PAINTER_SIDEBAR_SIZE_SLIDER as SIZE_SLIDER, PAINTER_SIDEBAR_UNDO_BUTTON as UNDO_BUTTON,
};
