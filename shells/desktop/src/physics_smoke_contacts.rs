...
pub fn physics_smoke_contacts(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
...
pub fn physics_smoke_area_drag(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_buoyancy(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_form_drag(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
