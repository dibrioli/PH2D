...
pub const SCULPT3D_VERB: [NodeId; 38] = [
    ...
    hash_node_id("sculpt3d.verb.31"),
    hash_node_id("sculpt3d.verb.32"),
    hash_node_id("sculpt3d.verb.33"),
    hash_node_id("sculpt3d.verb.34"),
    hash_node_id("sculpt3d.verb.35"),
    hash_node_id("sculpt3d.verb.36"),
    hash_node_id("sculpt3d.verb.37"),
];
...
pub const SCULPT3D_TINTA_DETALHE: [NodeId; 9] = [
    ...
    hash_node_id("sculpt3d.tinta_detalhe.5"),
    hash_node_id("sculpt3d.tinta_detalhe.6"),
    hash_node_id("sculpt3d.tinta_detalhe.7"),
    hash_node_id("sculpt3d.tinta_detalhe.8"),
];
