//! ⭐⭐⭐ **NENHUMA PALAVRA DE ASSETS É ESCRITA NO FONTE** — o HR-15, por crate.
//!
//! Migrado em 2026-09-16 (mapa `docs/UI_New_and_Simple/ferramentas/seccoes_asset_browser.tsv`): 16 textos no fonte. O corpo do gate é o [`ph2d_label_census::gate`]; aqui ficam a LISTA desta crate e as
//! mensagens.

use ph2d_label_census::gate::{self, Excecao};

const PREFIX: &str = "panel.asset_browser.";
const TABLE: &str = "crates/ph2d-i18n/src/asset_browser.rs";
