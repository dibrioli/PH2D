...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_BOOL_CROP, VECTOR_BOOL_EXCLUDE, VECTOR_BOOL_INTERSECT, VECTOR_BOOL_MERGE,
    VECTOR_BOOL_MINUS_BACK, VECTOR_BOOL_SUBTRACT, VECTOR_BOOL_TRIM, VECTOR_BOOL_UNION,
    ...
    VECTOR_PATH_SMOOTH, VECTOR_PATH_SUBDIVIDE, VECTOR_PIVOT_EDIT, VECTOR_SNAP_OFF, VECTOR_SNAP_ON,
    VECTOR_STROKE_OPACITY, VECTOR_STROKE_OPACITY_NUM, VECTOR_STROKE_SWATCH,
    ...
    VECTOR_VERT_AVERAGE, VECTOR_VERT_CORNER, VECTOR_VERT_DELETE, VECTOR_VERT_SEL_SAME,
    VECTOR_VERT_SEL_SUBPATH, VECTOR_VERT_SMOOTH, VECTOR_VERT_SYMMETRIC, VECTOR_WIDTH,
    VECTOR_WIDTH_NUM,
};
