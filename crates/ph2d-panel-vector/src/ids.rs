...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_COMPONENT_DETACH, VECTOR_COMPONENT_EDIT, VECTOR_COMPONENT_PLACE, VECTOR_COMPONENT_RESET,
    VECTOR_COMPONENT_SWAP, VECTOR_COMPONENT_UPDATE_MAIN, VECTOR_SECTION_COMPONENT,
    vector_instance_piece_colour_id, vector_instance_piece_show_id, vector_variant_option_id,
};
pub use ph2d_editor_core::ids::{
