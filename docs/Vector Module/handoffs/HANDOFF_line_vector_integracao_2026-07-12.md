...
Documentação viva: [`docs/Vector Module/BUGS_vector.md`](../BUGS_vector.md) (7 bugs
com sintoma / causa real / gate) e
[`docs/Vector Module/20_pesquisa_ferramentas_de_artista.md`](../20_pesquisa_ferramentas_de_artista.md).
...
**Do Painter (herdado, intocado):** `docs/Painter/handoffs/HANDOFF_per_layer_color_perf_artifacts.md`.

**A pesquisa de próximos passos** está em
[`20_pesquisa_ferramentas_de_artista.md`](../20_pesquisa_ferramentas_de_artista.md).
