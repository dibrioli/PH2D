...
pub const MEASURED_WESTON_COUNTER_DROP: f32 = 6.85;
...
pub const CAMERA_CENTRE: [f32; 2] = [0.0, 6.0];
...
/// Monta a cena 64.
pub fn build_weston(world: &mut World) {
    world.spawn((
        Name::new("Floor"),
        RigidBody {
            kind: BodyKind::Static,
...
pub fn physics_smoke_weston(ctx: &mut crate::SceneCtx<'_>) {
