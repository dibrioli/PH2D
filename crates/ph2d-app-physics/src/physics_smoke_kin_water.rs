...
pub const SANK: [f32; 3] = [1.1070, 1.0855, 1.0860];
...
pub const BOB: [f32; 2] = [1.4357, 1.4394];
...
pub fn build_kin_water_scene(world: &mut World) {
...
pub fn physics_smoke_kin_water(ctx: &mut crate::SceneCtx<'_>) {
