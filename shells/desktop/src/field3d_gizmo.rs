//! **A lei do gizmo de transformação — o código mudou-se para [`ph2d_viewport3d::gizmo`], o endereço ficou.**
//!
//! ⚠️ **Este alias existe para NÃO editar a árvore de outra linha.** `crate::field3d_gizmo` está escrito
...
//!
//! ⇒ Quem chegar novo escreve `ph2d_viewport3d::gizmo` directamente.
