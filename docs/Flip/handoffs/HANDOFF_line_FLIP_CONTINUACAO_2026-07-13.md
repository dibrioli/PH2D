...
> completo virou [`BUGS_flip.md` **#17**](../BUGS_flip.md). Resumo do que mudou, para você não
...
> (inteira, e releia a cada passo) → este arquivo → [`Flip/BUGS_flip.md`](../BUGS_flip.md) **#14, #15,
...
1. ~~**Edit Mode / seleção de traço**~~ — ✅ **FECHOU** (2026-07-13, `4e1bfbd7`; pendente o smoke).
   ...
   Doc: [`Flip/08_edit_mode_selecao.md`](../08_edit_mode_selecao.md); tracker: W6.
...
3. **Colorize** (wave própria): trapped-ball → LazyBrush/CTG com onion-fill ([`Flip/04 §3`](../04_alem_do_blender.md)).
...
**Docs do módulo:** [`docs/Flip/`](../00_README.md) — `01_plano_waves` · `02_referencia` (§7 = o
