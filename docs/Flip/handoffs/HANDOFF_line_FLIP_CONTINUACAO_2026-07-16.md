...
**Status:** INDETERMINADO — ver o corpo (o corpo não declara estado) · no `main` desde 2026-07-16 (`98350ce11`).
...
> releia a cada passo) → **este arquivo** → [`Flip/BUGS_flip.md`](../BUGS_flip.md) (as sagas;
...
[`Flip/02_referencia_algoritmos_blender_5.2.md` §11](../02_referencia_algoritmos_blender_5.2.md)
...
`~/Downloads/blender-5.2-grease-pencil-ref/`. Docs do módulo: [`docs/Flip/`](../00_README.md)
