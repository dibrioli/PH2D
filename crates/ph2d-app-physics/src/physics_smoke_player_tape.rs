...
/// plausível.
pub fn physics_smoke_tape(ctx: &mut crate::SceneCtx<'_>) {
...
pub const TAPE_SMOKE_MESSAGE: &str = concat!(
    ...
    "2. Play. Segure a seta DIREITA e pule (SETA PARA CIMA) para subir os\n",
    "   degraus --\n",
