...
fn a_click_inside_the_gizmo_box_grabs_the_selection() {
    ...
    assert_eq!(
        crate::select::stroke_at(&d, center, 1.0, &Xform::IDENTITY),
        None,
    ...
    assert_eq!(
        crate::select::plan_down(&mut d, None, false, in_box),
        crate::select::Down::Move { collapse_to: None },
    ...
    assert_eq!(
        crate::select::plan_down(&mut d, None, false, out_box),
        crate::select::Down::Marquee { additive: false },
