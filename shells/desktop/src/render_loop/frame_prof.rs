...
thread_local! {
    ...
    /// `1` quando o corte em duas camadas está activo — o que IDENTIFICA o motor da linha.
    pub(super) static FRAME_PROF_DUAS_CAMADAS: std::cell::Cell<u64> = const { std::cell::Cell::new(0) };
