...
- **Componentes / instâncias** — identidade de objeto (`StableId`), ordem de irmãos como DADO (`SiblingOrder`),
  ...
  **Smokes:** `PH2D_TIMER_SMOKE=1` · `PH2D_SIGNAL_ACTION_SMOKE=1` · `PH2D_AUDIO_2D_SMOKE=1` · `PH2D_GAME_CAMERA_SMOKE=1` · `PH2D_TAGS_SMOKE=1|2` (⚠️ a `=2` é de FÍSICA — o prólogo arma o transporte e abre a régua; `PH2D_SIGNAL_LOG=1` diz a origem de cada sinal).
