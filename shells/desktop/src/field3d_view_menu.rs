//! **O menu de vistas — o código mudou-se para [`ph2d_viewport3d::view_menu`], o endereço ficou.**
//!
//! ⚠️ **Este alias existe para NÃO editar a árvore de outra linha.** `crate::field3d_view_menu` está escrito
...
//!
//! ⇒ Quem chegar novo escreve `ph2d_viewport3d::view_menu` directamente.
//!
//! # ⚠️ Os testes desta lei ficaram AQUI, e é de propósito
//!
//! `field3d_view_menu_tests.rs` exercita a lei **através** do smoke do 3D (`crate::field3d_smoke`,
...
pub(crate) use ph2d_viewport3d::view_menu::*;
