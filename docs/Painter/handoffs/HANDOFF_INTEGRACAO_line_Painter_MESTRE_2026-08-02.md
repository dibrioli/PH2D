...
```
- [Largar a POSSE cega todo comparador daquele lado](../../../project-memory/feedback_dropping_ownership_blinds_every_comparator_that_reads_that_side.md) — …
```
...
e no [doc 28](../28_otimizacoes_o_que_funcionou.md) §5.60-§5.70. Módulos novos:
...
O retrato completo é o **[doc 32](../32_aquarela_o_que_custa_hoje.md)** (o MAPA); o log
cronológico é o doc 28 §5.71-§5.77; os bugs cuja causa enganava são
[`BUGS_painter.md`](../BUGS_painter.md) **#18 · #19 · #20 · #21**.
...
1. **`build_rewet_fields` = 8,74 ms, 51% do composite** — dez box blurs em resolução cheia. O blur já
   ...
   [doc 32 §4](../32_aquarela_o_que_custa_hoje.md):
