...
// ⚠️ **Uma porta só para "um afim entra na geometria"** ([`crate::path_bake_xform`]): todo op que
// move pontos com `f` tem de escalar os COMPRIMENTOS com `radius_scale`, e se as duas metades
// vivessem em funções separadas o próximo op novo escalaria uma e esqueceria a outra.
use crate::path_bake_xform::{bake_xform, transform_fill_geometry};
use crate::{FlipAxis, Paint, Rotate90, VecPathId, VecScene, VecVertex};
