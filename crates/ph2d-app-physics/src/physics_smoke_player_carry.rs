...
pub fn physics_smoke_chimney(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn physics_smoke_wagon(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
...
pub const CHIMNEY_SMOKE_MESSAGE: &str = concat!(
...
pub const WAGON_SMOKE_MESSAGE: &str = concat!(
