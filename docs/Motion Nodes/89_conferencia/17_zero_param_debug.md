...
**Contagem (DERIVADA, reconciliada em 2026-08-19):** 15 linhas — **P0 = 0** · **P1 = 0** · **P2 = 6** · ✅ fechadas **3** · ⛔ recusadas/refutadas **6**. ⭐ **Re-medida em 2026-08-23 (bloco Z, [doc 91](../91_os_tetos_que_ninguem_mediu.md)):** a célula das DUAS constantes escondidas fechou — e a medição virou a leitura dela do avesso, porque **a `0,1` o grampo não guardava nada** (127× o raio de nascimento) e o dissidente a `0,05` era o mais certo. ✅ **A folha não tem mais P1.**
