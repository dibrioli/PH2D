...
pub fn motion_autofix_smoke(cx: &mut crate::motion_scene_ctx::MotionSceneCtx<'_>) {
    ...
    match (mode(), f) {
        ...
        _ => {
            crate::motion_autofix_smoke_appropriate::motion_autofix_smoke_appropriate(
                cx,
                mode(),
                f,
            );
            crate::motion_autofix_smoke_dead_branch::motion_autofix_smoke_dead_branch(
                cx,
                mode(),
                f,
            );
