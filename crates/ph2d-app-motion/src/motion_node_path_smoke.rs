...
pub fn push_shape(scene: &mut ph2d_vec_scene::VecScene) {
...
pub fn push_spacing_shapes(scene: &mut ph2d_vec_scene::VecScene) {
...
pub fn motion_node_path_smoke(cx: &mut crate::motion_scene_ctx::MotionSceneCtx<'_>) {
