...
| ⭐⭐⭐ **O IDIOMA DE TESTE — a prova que faltava às nove fatias** (os 30 censos leem o CÓDIGO; nenhum lê o ECRÃ) | [`medicoes/15_o_idioma_de_teste_a_prova_que_faltava.md`](medicoes/15_o_idioma_de_teste_a_prova_que_faltava.md) |
| ⛔ **A 2.ª foto do dono** — o que o idioma de teste acha, e o que ele NÃO distingue | [`medicoes/16_a_segunda_foto_do_dono_e_a_triagem_que_ela_obriga.md`](medicoes/16_a_segunda_foto_do_dono_e_a_triagem_que_ela_obriga.md) |
| ⛔⛔ **O cartão pintava a CHAVE, e o gate do cartão estava VERDE** | [`medicoes/17_o_cartao_pintava_a_chave_e_o_gate_do_cartao_estava_verde.md`](medicoes/17_o_cartao_pintava_a_chave_e_o_gate_do_cartao_estava_verde.md) |
| ⛔ **A letra sozinha que a régua não pode ver**, e o órfão que mentia no doc | [`medicoes/18_a_letra_sozinha_que_a_regua_nao_pode_ver.md`](medicoes/18_a_letra_sozinha_que_a_regua_nao_pode_ver.md) |
| ⭐ **O complemento da régua** — as cegueiras dela deixam de ser prosa e passam a ser uma LISTA | [`medicoes/19_o_complemento_da_regua_as_cegueiras_ficam_consultaveis.md`](medicoes/19_o_complemento_da_regua_as_cegueiras_ficam_consultaveis.md) |
| ⛔⛔ **A coluna de 32 px já cortava dois nomes EM INGLÊS** | [`medicoes/20_a_coluna_de_32px_ja_cortava_dois_nomes_em_ingles.md`](medicoes/20_a_coluna_de_32px_ja_cortava_dois_nomes_em_ingles.md) |
| ⭐⭐ **O censo das ELISÕES** — o que o app PINTOU contra o orçamento que ele tinha —, e o botão que pinta NADA | [`medicoes/21_o_censo_das_elisoes_e_o_botao_que_pinta_nada.md`](medicoes/21_o_censo_das_elisoes_e_o_botao_que_pinta_nada.md) |
| ⛔ **O respiro era CONSTANTE e engolia a caixa pequena** | [`medicoes/22_o_respiro_era_constante_e_engolia_a_caixa_pequena.md`](medicoes/22_o_respiro_era_constante_e_engolia_a_caixa_pequena.md) |
| ⭐⭐⭐ **A varredura das elisões** (a PÍLULA mede a palavra que carrega · uma INVERSA em `f32` não fecha por álgebra) **e a pergunta da próxima língua** — «tudo em inglês» | [`medicoes/23_a_varredura_das_elisoes_e_a_pergunta_da_proxima_lingua.md`](medicoes/23_a_varredura_das_elisoes_e_a_pergunta_da_proxima_lingua.md) |
| ⭐⭐⭐ **A régua que ATRAVESSA a crate** — o rótulo que um motor publica e um painel pinta escapa às DUAS réguas do HR-15; 27 órfãos apagados, 43 palavras pagas, catraca VAZIA | [`medicoes/24_a_fronteira_dos_motores_e_a_regua_que_atravessa_a_crate.md`](medicoes/24_a_fronteira_dos_motores_e_a_regua_que_atravessa_a_crate.md) |
| ⛔⛔⛔ **Um botão parado não se via** — e havia **DUAS leis** para a cor dele, com o doc de uma a afirmar ser a outra | [`medicoes/25_um_botao_parado_nao_se_via.md`](medicoes/25_um_botao_parado_nao_se_via.md) |
| ⛔⛔ **Três reports sobre o modal, e uma causa só** — a ORDEM do teclado, com a promessa escrita num ficheiro e violada por duas linhas noutro | [`medicoes/26_tres_reports_do_modal_e_uma_causa_so.md`](medicoes/26_tres_reports_do_modal_e_uma_causa_so.md) |
| ⭐⭐⭐ **O CENSO DO DEGRAU `G`** — de quem são as entradas de cada painel (o degrau mais caro do plano tinha **1 painel de 27** medido) | [`quantas_entradas_tem_cada_painel.rs`](../../crates/ph2d-panel-registry-init/tests/it/quantas_entradas_tem_cada_painel.rs) |
