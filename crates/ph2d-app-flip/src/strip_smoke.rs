...
/// do Pin precisa).
pub const POSES: [(i32, Rgba, f32, f32, f32, f32); 4] = [
...
pub const UNIT_RING: [(f32, f32); 12] = [
    (1.0, 0.0),
    (0.866, 0.5),
    (0.5, 0.866),
    (0.0, 1.0),
...
pub fn ball(colour: Rgba, cx: f32, cy: f32, rx: f32, ry: f32) -> FlipStroke {
...
pub fn floor_stroke() -> FlipStroke {
    let mut s = FlipStroke::new();
...
pub fn arm(
    ...
    let oid = flip.push_object("Strip Smoke");
