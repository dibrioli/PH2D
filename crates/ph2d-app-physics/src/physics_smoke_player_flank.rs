...
pub fn physics_smoke_flank(ctx: &mut crate::SceneCtx<'_>) {
...
pub const FLANK_SMOKE_MESSAGE_HEAD: &str = "[physics-smoke 98] A PAREDE COM JANELAS (W13, o flanco). Poco de 1,8 m:\nesquerda LISA (o controle), direita com ";

/// O roteiro da cena 98 — o gesto é o ziguezague da 92, e o que se julga é o que
/// acontece **na janela**.
pub const FLANK_SMOKE_MESSAGE: &str = concat!(
    "\n",
