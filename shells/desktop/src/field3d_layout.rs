//! **As quatro viewports e as costuras** — a lei vive na [`ph2d_viewport3d::layout`].
//!
//! ⚠️ **Este alias existe por UM motivo só: não editar a árvore de outra linha.** `crate::field3d_layout`
...
//! escrever `ph2d_viewport3d::layout` directamente. *Um alias com data de validade escrita é dívida
