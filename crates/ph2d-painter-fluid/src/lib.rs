...
pub use solver::{
    ...
    SHALLOW_WGSL, SPLAT_WGSL, TRANSFER_WGSL, WATERCOLOR_DEPOSITION_BASE, WATERCOLOR_DEPOSITION_DRY,
    WATERCOLOR_DRAG, WATERCOLOR_GRANULATION, WATERCOLOR_PRESSURE, WATERCOLOR_VELOCITY,
    WATERCOLOR_VISCOSITY, step_cpu_reference,
};
