...
pub const FALLBACK_BRUSH: BrushSettings = BrushSettings {
    ...
    sketchy_reach: 1.0,
    sketchy_density: 0.2, // LITERAL-PX-OK: espelho do default do BrushSpec, não é medida de UI
    thread_width_px: 1.0,
    thread_opacity: 0.25, // LITERAL-PX-OK: espelho do default do BrushSpec, não é medida de UI
    ...
    dab_rotor: [1.0, 0.0],
    // Off: the neutral taper, shared as a const with the engine so the fallback cannot drift.
    taper: ph2d_tool_painter::Taper::NEUTRAL,
    grain_depth: 1.0,
    ...
    wet_tilt_spoke: 3,
    wet_show_wet: false,
    wet_paper_visual: false,
    wet_km_mixing: false,
    wet_km_glaze: false,
    wet_tuning_open: false,
