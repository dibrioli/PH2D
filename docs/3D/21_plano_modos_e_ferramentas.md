...
| 🔄 **em curso (1)** | **Mesh Filter** — **7 dos 9** tipos hoje: os 4 por reuso de verbo (Smooth · Surface Smooth · Relax · Inflate) **mais os 3 SEM verbo** que a W9b destravou (Scale · Sphere · Random). ⚠️ **Contá-los exigiu o selector, e não o kernel:** enquanto a lei era DERIVADA do verbo em mãos os três eram inexprimíveis por gesto nenhum — *não existe pincel de Scale, de Sphere nem de Random* —, então um kernel novo sem a row de escolha teria shipado três leis que nada alcança. Faltam **Sharpen · Enhance Details** (W9c) |
