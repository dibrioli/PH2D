//! ⭐⭐⭐ **NENHUMA PALAVRA DO PAINEL AUDIO MIXER É ESCRITA NO FONTE** — o HR-15, por crate.
//!
//! Migrado em 2026-09-16 (`scripts/migrar-texto-pintado.py`, mapa
//! `docs/UI_New_and_Simple/ferramentas/seccoes_audio_mixer.tsv`): o painel escrevia **29** textos no fonte, medidos
...
const PREFIX: &str = "panel.audio_mixer.";
const TABLE: &str = "crates/ph2d-i18n/src/audio.rs";
