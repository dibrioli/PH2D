...
pub fn build_probe_scene(world: &mut bevy_ecs::world::World) -> ph2d_ecs::Entity {
    slab(
        world,
        "Floor",
        Vec2::new(14.0, -0.5),
...
pub const PROBES_SMOKE_MESSAGE: &str = concat!(
