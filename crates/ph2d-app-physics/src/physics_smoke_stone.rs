...
pub fn build_stone_scene(world: &mut bevy_ecs::world::World) -> ph2d_ecs::Entity {
    {
        slab(
            world,
            "Floor",
...
/// não cabe num raio.
pub const STONE_SMOKE_MESSAGE: &str = concat!(
