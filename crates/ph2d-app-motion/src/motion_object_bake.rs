...
pub const MAX_TILE_SIDE: u32 = 2048;
...
impl ObjectBake {
    ...
    pub fn objects(&self) -> impl Iterator<Item = (&str, ObjectVector)> {
    ...
    pub fn vector_for_id(&self, id: VecPathId) -> Option<ObjectVector> {
    ...
    pub fn tile_texture_for_gid(&self, geometry_id: u32) -> Option<u32> {
        self.cache
            .values()
    ...
    pub fn thumbnail_for(&self, geometry_id: u32) -> Option<ph2d_panel_motion_graph::PreviewThumb> {
        self.cache
            .values()
            .find(|b| b.geometry_id == geometry_id)
            .map(|b| b.thumb.clone())
...
fn select_present(
    ...
    use crate::motion_bridge::entity_is_in_a_named_group;
...
/// in the `store` the vector [`encode`](crate::motion_shape_gen::encode)
