...
pub fn physics_smoke_events(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn physics_smoke_impact_demolition(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn physics_smoke_fast_impact(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
