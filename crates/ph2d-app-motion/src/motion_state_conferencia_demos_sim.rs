...
pub const BREAK_ABOVE: f32 = 4.6;
/// O topo da rampa do vento e quanto tempo ela leva a lá chegar.
pub const WIND_TOP: f32 = 9.0;
pub const RAMP_SECS: f32 = 4.0;
...
pub fn build_sim_demo_document(
    doc: &mut MotionDoc,
