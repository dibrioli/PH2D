...
pub static KIND_LABELS: &[&str] = &[
    "node.opts.node_motion_shape.kind_labels.0",
    "node.opts.node_motion_shape.kind_labels.1",
    "node.opts.node_motion_shape.kind_labels.2",
    "node.opts.node_motion_shape.kind_labels.3",
    "node.opts.node_motion_shape.kind_labels.4",
    "node.opts.node_motion_shape.kind_labels.5",
    "node.opts.node_motion_shape.kind_labels.6",
    "node.opts.node_motion_shape.kind_labels.7",
    "node.opts.node_motion_shape.kind_labels.8",
    "node.opts.node_motion_shape.kind_labels.9",
    "node.opts.node_motion_shape.kind_labels.10",
    "node.opts.node_motion_shape.kind_labels.11",
    "node.opts.node_motion_shape.kind_labels.12",
    "node.opts.node_motion_shape.kind_labels.13",
    "node.opts.node_motion_shape.kind_labels.14",
    "node.opts.node_motion_shape.kind_labels.15",
    "node.opts.node_motion_shape.kind_labels.16",
    "node.opts.node_motion_shape.kind_labels.17",
    "node.opts.node_motion_shape.kind_labels.18",
    "node.opts.node_motion_shape.kind_labels.19",
    "node.opts.node_motion_shape.kind_labels.20",
    "node.opts.node_motion_shape.kind_labels.21",
    "node.opts.node_motion_shape.kind_labels.22",
    "node.opts.node_motion_shape.kind_labels.23",
    "node.opts.node_motion_shape.kind_labels.24",
    "node.opts.node_motion_shape.kind_labels.25",
    "node.opts.node_motion_shape.kind_labels.26",
    "node.opts.node_motion_shape.kind_labels.27",
    "node.opts.node_motion_shape.kind_labels.28",
    "node.opts.node_motion_shape.kind_labels.29",
    "node.opts.node_motion_shape.kind_labels.30",
    "node.opts.node_motion_shape.kind_labels.31",
    "node.opts.node_motion_shape.kind_labels.32",
    "node.opts.node_motion_shape.kind_labels.33",
    "node.opts.node_motion_shape.kind_labels.34",
    "node.opts.node_motion_shape.kind_labels.35",
    "node.opts.node_motion_shape.kind_labels.36",
    "node.opts.node_motion_shape.kind_labels.37",
    "node.opts.node_motion_shape.kind_labels.38",
    "node.opts.node_motion_shape.kind_labels.39",
...
pub fn register(reg: &mut NodeRegistry) -> Result<(), RegistryError> {
    ...
    reg.register_ui(
        ...
        ph2d_node_registry::NodeUiManifest {
            display_key: "node.source.shape.name",
