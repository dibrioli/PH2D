...
- **W1.T5** — template canônico `ph2d-node-debug-wave` (input + param + `Temporal` + `ph2d-expr`/`eval_column` + golden test) + `docs/archive/integracao-jornadas/briefing-node-crate.md`. ✅ commit `e87edb0`.
