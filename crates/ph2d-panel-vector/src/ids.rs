...
pub use ph2d_editor_core::ids::{
    MAX_SMART_CLIPS, VECTOR_BONE_ACT_CREATE, VECTOR_BONE_ACT_TRANSFORM, VECTOR_BONE_ACTION,
    VECTOR_BONE_ACTION_IDS, VECTOR_BONE_BEND_IDS, VECTOR_BONE_BIND, VECTOR_BONE_EXPAND,
    VECTOR_BONE_FIELDS, VECTOR_BONE_IK_ADD, VECTOR_BONE_IK_BEND, VECTOR_BONE_IK_CHAIN,
    VECTOR_BONE_IK_MIX, VECTOR_BONE_IK_REMOVE, VECTOR_BONE_IK_SOFTNESS, VECTOR_BONE_LENGTH,
    VECTOR_BONE_LIMIT_ADD, VECTOR_BONE_LIMIT_MAX, VECTOR_BONE_LIMIT_MIN, VECTOR_BONE_LIMIT_REMOVE,
    VECTOR_BONE_RELEASE, VECTOR_BONE_SMART_ADD, VECTOR_BONE_SMART_CLIP, VECTOR_BONE_SMART_CLIP_IDS,
    VECTOR_BONE_SMART_FROM, VECTOR_BONE_SMART_PICK, VECTOR_BONE_SMART_REMOVE, VECTOR_BONE_SMART_TO,
    VECTOR_BONE_STRENGTH, VECTOR_BONE_VERBS, VECTOR_MODE_BONE, VECTOR_SECTION_BONE,
};
pub use ph2d_editor_core::ids::{
