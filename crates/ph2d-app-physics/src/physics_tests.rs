...
// silenciar o diagnóstico; a verdade é que o import serve os testes.
#[cfg(test)]
use ph2d_physics_ecs::{BodyKind, Collider, ColliderShape, RigidBody};
use ph2d_render::Sprite;

use crate::inspector::body::apply_physics_edit;
#[cfg(test)]
use crate::inspector::body::build_physics_info;
...
pub fn sprite_scene() -> (SimWorld, Entity) {
...
pub fn apply(sim: &mut SimWorld, e: Entity, edit: PhysicsFieldEdit) {
    let reg = registry();
