...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_TEXPAT_MODE_TILE, VECTOR_TEXPAT_OFFSET, VECTOR_TEXPAT_OFFSET_NUM, VECTOR_TEXPAT_SIZE,
    VECTOR_TEXPAT_SIZE_NUM, VECTOR_TEXPAT_SOURCE, VECTOR_TEXPAT_TILE_BRICK,
