...
pub const SURFACES: [(Option<WalkSurface>, &str); 4] = [
    (
        Some(WalkSurface {
            grip: 0.15,
            belt: 0.0,
...
pub fn physics_smoke_surface(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn build_surface_scene(world: &mut bevy_ecs::world::World) -> Vec<(Entity, Entity)> {
    SURFACES
        .iter()
        .enumerate()
...
pub const SURFACE_SMOKE_MESSAGE: &str = concat!(
