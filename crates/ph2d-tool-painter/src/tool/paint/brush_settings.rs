...
pub struct BrushSettings {
    ...
    /// **Shape Relief** (`0..1`, `0` = off) — quanta espessura o DEPÓSITO desta silhueta deixa (o `emb`
    /// do bloco `paper_on` do Wet Paint, do lado do pigmento). Tool-global, editado na seção **Shape**.
    pub shape_relief: f32,
