...
mod params_snapshot;
/// A porta única `kind → id` da SIMETRIA — irmão de `params` pelo teto de 700 LOC.
mod params_symmetry;
...
pub use params::{
    BoneAction, DrawMode, SkinDeform, StrokeCap, StrokeJoin, TextAlign, VectorDrawConfig,
    VectorStyleSnapshot, VertexSel, VertexType, px_to_slider, slider_to_px,
};
pub use tool::{
