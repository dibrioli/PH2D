...
/// `pub` so the params-bridge gate drives the SAME scene the smoke shows.
pub fn build_picker_scene(g: &mut Graph) -> NodeId {
...
///
/// ⚠️ Era um `impl crate::App` e tocava **um** campo (`self.gfx`) — logo é uma CENA como as
/// outras catorze, e a cura foi a mesma: o [`crate::motion_scene_ctx::MotionSceneCtx`].
pub fn picker_smoke(cx: &mut crate::motion_scene_ctx::MotionSceneCtx<'_>) {
    {
