...
pub fn is_connector_field_id(id: NodeId) -> bool {
    id == ph2d_tool_vector::ids::VECTOR_CONNECTOR_ROUTE
        || id == ph2d_tool_vector::ids::VECTOR_CONNECTOR_JETTY
        || id == ph2d_tool_vector::ids::VECTOR_CONNECTOR_SPREAD
        || id == ph2d_tool_vector::ids::VECTOR_CONNECTOR_CORNER
        || id == ph2d_tool_vector::ids::VECTOR_CONNECTOR_CURVE
}
...
fn apply_field(conn: &mut VecConnector, id: NodeId, v: f64) -> bool {
    ...
    } else if id == ph2d_tool_vector::ids::VECTOR_CONNECTOR_CURVE {
    ...
    } else if id == ph2d_tool_vector::ids::VECTOR_CONNECTOR_ROUTE {
