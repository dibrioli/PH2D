...
pub fn stable_index(sim: &mut SimWorld) -> std::collections::BTreeMap<u64, Entity> {
...
pub fn entity_for_stable_id(sim: &mut SimWorld, stable_id: u64) -> Option<u64> {
...
/// assinava o longo*.
pub fn instance_root_of(sim: &mut SimWorld, clicked: Entity) -> Option<Entity> {
...
pub fn belongs_to_an_instance(sim: &mut SimWorld, entity: Entity) -> bool {
...
pub fn is_a_recipe_given_piece(sim: &mut SimWorld, entity: Entity) -> bool {
...
pub fn subtree(sim: &SimWorld, root: Entity) -> Vec<Entity> {
    let mut out = Vec::new();
...
pub fn master_subject(sim: &mut SimWorld, clicked: Entity) -> Entity {
