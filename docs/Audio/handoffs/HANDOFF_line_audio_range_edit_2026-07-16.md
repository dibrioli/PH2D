...
> backlog do módulo: [`docs/Audio/03_o_que_falta.md`](../03_o_que_falta.md)
...
- **O frame do knob-drag ainda reconstrói a waveform inteira — medido, 21,9 ms/frame** (stereo 3 min).
  ...
  dança de posse dos 2 slots com o mixer). Detalhe: [`03_o_que_falta.md`](../03_o_que_falta.md) §2.2.
