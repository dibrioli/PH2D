...
pub fn anchors_of(sk: &Stream) -> Vec<Anchor> {
...
pub type Look = ([f32; 2], [f32; 4], [f32; 4], f32, f32, f32);
...
pub fn named_appearance(cook: &ph2d_nodegraph::cook::Cook, name: &str) -> Option<Look> {
...
pub fn unanswered_slots(names: &[String; 3], anchors: &[Anchor]) -> Vec<usize> {
    (0..names.len())
...
#[cfg(test)]
pub fn already_said(key: &str) -> bool {
...
pub fn say_if_a_wire_drives_an_inert_param(
...
/// que o saiba por ele.
pub fn say_if_the_level_hid_every_leaf(
    id: ph2d_nodegraph::graph::NodeId,
    names: &[String; 3],
    anchors: &[Anchor],
    first_level: f32,
...
pub fn say_if_the_letter_is_missing(
    id: ph2d_nodegraph::graph::NodeId,
    names: &[String; 3],
    anchors: &[Anchor],
) {
