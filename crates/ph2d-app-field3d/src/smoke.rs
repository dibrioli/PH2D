//! **O smoke do módulo de modelagem 3D** — `PH2D_FIELD_SMOKE=1..35` (ADR-0161).
//!
...
/// ⭐⭐⭐ **O que corre NA THREAD de traçado** — ver [`thread`].
#[path = "smoke_draw_thread.rs"]
mod thread;
...
/// ⭐⭐⭐ **Os gates de paridade do dispositivo** — ver [`smoke_gpu_tests`].
#[cfg(test)]
#[path = "smoke_gpu_tests.rs"]
mod smoke_gpu_tests;
