...
mod shift;
pub use lod::{LOD_COUNT, apply_object_lod};
pub use shift::publish_shifted;
pub use shift::wanted_shifts;
...
// 2026-08-20: o [`crate::motion_glow_layer`] deriva com ela a camada que o
...
pub use lod::vector_instance_as_tile;
...
pub use appearance::{Appearance, sprite_appearance};
...
pub fn entity_is_in_a_named_group(world: &ph2d_ecs::World, entity: Entity) -> bool {
...
pub fn bake_flip_objects(
    motion: &mut MotionState,
    flip: &ph2d_flip::FlipDoc,
    map: &ph2d_flip_entities::entities::FlipEntityMap,
