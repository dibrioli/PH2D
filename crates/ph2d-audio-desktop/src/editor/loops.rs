...
impl AudioSystem {
    ...
    pub fn editor_set_loop_from_selection(&mut self) {
    ...
    pub fn editor_clear_loop(&mut self) {
        if let Some(clip) = self.editor.clip.as_mut() {
            clip.clear_loop();
        }
        self.editor_refresh_preview_loop();
    ...
    pub fn editor_loop_region(&self) -> Option<ph2d_audio::LoopRegion> {
    ...
    pub fn editor_refresh_preview_loop(&mut self) {
    ...
    pub fn editor_loop_span(&self) -> Option<(f64, f64)> {
    ...
    pub fn editor_loop_frames(&self) -> Option<(u64, u64)> {
        let lp = self.editor.clip.as_ref()?.loop_region()?;
    ...
    /// sample rate.
    pub fn editor_xfade_frames(&self, norm: f32) -> usize {
        let sr = self
            .editor
            .clip
            .as_ref()
    ...
    pub fn editor_set_pending_xfade(&mut self, frames: usize) {
    ...
    pub fn editor_bake_loop_crossfade(&mut self) {
    ...
    pub fn editor_can_bake_crossfade(&self) -> bool {
    ...
    /// with the buffer.
    pub fn editor_scrub_to_frame(&mut self, full_frame: u64) {
    ...
    pub fn editor_end_scrub(&mut self) {
    ...
    pub fn editor_playhead_frame(&self) -> u64 {
    ...
    pub fn editor_loop_smoke(&mut self) {
