...
pub(super) fn paint_detalhe_da_tinta(
    ...
    let labels: Vec<&str> = crate::state::DetalheDaTinta::ALL
        ...
        .map(|d| d.label())
        .collect();
    // ⛔ **Aqui vinha a caixa `Even Detail`, colada ao degrau que ela igualava**,
    //    e ela saiu em 2026-09-23 por ordem do dono. A fileira do degrau é hoje
    //    a última desta secção.
