...
use crate::fx_params::{FxCommand, build};
...
pub fn lone_plain_stage(chain: &[FxStage], from: usize) -> Option<ph2d_audio_edit::Effect> {
    let mut found = None;
...
impl super::super::AudioSystem {
    ...
    pub fn fx_preview_filled(&self) -> bool {
