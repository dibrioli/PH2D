...
[`docs/Painter/19_relevo_do_papel_investigacao.md`](../19_relevo_do_papel_investigacao.md).
...
[`docs/Painter/20_accumulate_na_mesma_pincelada.md`](../20_accumulate_na_mesma_pincelada.md).
