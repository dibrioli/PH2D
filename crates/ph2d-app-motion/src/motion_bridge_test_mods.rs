...
//!
//! ⚠️ **O `pub use super::*` é load-bearing:** cada um daqueles arquivos abre com
...
mod plumbing_tests;
/// O censo dos RÓTULOS de porta. ⚠️ Ele foi cortado, por tecto de LOC, de um irmão que media
/// *«cabe no dock do painel lateral?»* — e esse irmão SAIU com o painel (doc 114 §13), enquanto
/// este ficou: *este nome é legível?* é pergunta do CARTÃO, que continua a pintar rótulos de
/// porta. O corte de então, feito pela pergunta e não pelo ficheiro, é o que deixou esta metade
/// sobreviver à morte da outra.
#[cfg(all(test, feature = "panel-motion-graph"))]
