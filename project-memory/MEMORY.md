...
- [MagicaCSG sob Wine (Wayland + vsync off); licença não-comercial ⇒ referência, não oráculo](reference_magicacsg_installed_under_wine.md)
...
- ⭐ [**Como uma RÉGUA mente** — a família (182)](reference_topic_measurement_discipline.md)
...
- ⛔⛔ [Multiplicar a resposta de um BSDF pelo albedo do texel TINGE o destaque — a cor é o `base_color`, e um corpus CINZENTO aprova as duas leis](feedback_a_per_texel_albedo_is_the_base_color_never_a_factor_at_the_end.md)
...
- [Costura de UI (25)](reference_topic_ui_seam_discipline.md) — ⭐ [o hit rect é também o DENOMINADOR](feedback_a_hit_rect_is_also_the_denominator_not_only_the_target.md)
- [**Ofício de gate** — a família (128)](reference_topic_gate_discipline.md)
...
- 📚 [Auditoria (famílias — 2 saltos): mais (40) lições, uma linha cada, verbatim](reference_topic_audit_lessons.md)
...
- ⛔⛔⛔ [Impor uma propriedade DEPOIS de um óptimo por-peça é o que ONDULA — e antes de forçar suavidade, meça se a VERDADE a tem](feedback_forcing_a_property_after_the_optimum_is_what_ripples.md)
...
- [Registro de painel — (5) sítios](reference_topic_panel_registration.md) · [Gotchas de código (28)](reference_topic_code_gotchas.md)
