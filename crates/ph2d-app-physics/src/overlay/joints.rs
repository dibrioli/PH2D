...
use crate::overlay::annotations::torque_glyph;
use crate::overlay::joint_glyphs::{
...
pub const JOINT_DOT_PX: f64 = 3.0; // LITERAL-PX-OK: chrome de overlay, raio de tela
...
pub const JOINT_RGBA: [f32; 4] = [0.98, 0.75, 0.25, 0.9]; // LITERAL-COLOR-OK: overlay de joint
...
pub const JOINT_DIM_RGBA: [f32; 4] = [0.98, 0.75, 0.25, 0.5]; // LITERAL-COLOR-OK: overlay de joint (posse/limite)
...
pub const JOINT_STRAIN_RGBA: [f32; 4] = [0.96, 0.32, 0.28, 0.95]; // LITERAL-COLOR-OK: overlay de joint nao imposto
...
pub const JOINT_BROKEN_RGBA: [f32; 4] = [0.96, 0.32, 0.28, 0.95]; // LITERAL-COLOR-OK: overlay de joint rompido
...
pub const JOINT_BROKEN_DIM_RGBA: [f32; 4] = [0.96, 0.32, 0.28, 0.45]; // LITERAL-COLOR-OK: overlay de joint rompido (posse)
...
pub const JOINT_OFF_RGBA: [f32; 4] = [0.98, 0.75, 0.25, 0.3]; // LITERAL-COLOR-OK: overlay de joint desligado
...
pub const JOINT_OFF_DIM_RGBA: [f32; 4] = [0.98, 0.75, 0.25, 0.17]; // LITERAL-COLOR-OK: overlay de joint desligado (posse)
...
fn kind_marks(
    ...
    match v.kind {
        ...
        JointKind::Custom => {
            glyph = crate::overlay::joint_glyphs::custom_glyph(a, v.rotation_free);
            ring_px(b, JOINT_DOT_PX, &mut glyph);
        }
        ...
        JointKind::Pulley => {
            acting = crate::overlay::pulley::pulley_marks(
...
pub fn dashed(from: Point, to: Point, path: &mut BezPath) {
