...
pub const MEASURED: [f32; 3] = [0.2285, 0.0, 0.133];
/// A linha d'água de uma cápsula idêntica **sem** o player — o oráculo da cena.
pub const WATERLINE: f32 = 0.2265;
...
pub fn build_water_scene(world: &mut World) {
...
pub fn physics_smoke_water(ctx: &mut crate::SceneCtx<'_>) {
