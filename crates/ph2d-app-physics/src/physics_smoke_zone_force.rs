...
pub const CARRIED: [f32; 4] = [87.330, 20.590, 20.999, 20.999];
...
pub const WALKED: [f32; 3] = [12.564, 20.999, 31.395];
...
pub fn build_zone_force_scene(world: &mut World) {
...
pub fn physics_smoke_zone_force(ctx: &mut crate::SceneCtx<'_>) {
