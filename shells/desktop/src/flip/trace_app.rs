...
//!
//! A lei vive em [`crate::flip::trace`]. O que sobra aqui é o bloco `impl crate::App`:
...
impl crate::App {
    ...
    pub(crate) fn flip_wants_trace(&self) -> bool {
        crate::flip::trace::wants(&self.flip_state)
    }
    ...
    pub(crate) fn flip_trace_canvas_down(&mut self, x: f32, y: f32) -> bool {
        ...
        crate::flip::trace::canvas_down(&mut self.flip_state, &f, &w2o, ctrl, x, y)
    }
    ...
    pub(crate) fn flip_trace_canvas_move(&mut self, x: f32, y: f32) -> bool {
        ...
        crate::flip::trace::canvas_move(&mut self.flip_state, &f, &w2o, x, y)
    }

    /// Pen-up: fecha o arrasto de trace.
    pub(crate) fn flip_trace_canvas_up(&mut self) -> bool {
        crate::flip::trace::canvas_up(&mut self.flip_state)
    }
}
