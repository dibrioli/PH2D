...
pub const IF_GREATER: Recipe = Recipe {
    ...
    knobs: &[
        ...
        Knob::num("then", "Then", 1.0, (-1000.0, 1000.0)),
        Knob::num("else", "Else", 0.0, (-1000.0, 1000.0)),
    ],
    kind: RowKind::Value,
    clock: ClockUse::None,
...
pub const IF_EQUAL: Recipe = Recipe {
    ...
    knobs: &[
        Knob::num("threshold", "Equals", 10.0, (-1000.0, 1000.0)),
        Knob::num("then", "Then", 1.0, (-1000.0, 1000.0)),
        Knob::num("else", "Else", 0.0, (-1000.0, 1000.0)),
    ],
    kind: RowKind::Value,
...
pub const GATE_AND: Recipe = Recipe {
    ...
    knobs: &[
        Knob::link("a", "Watch A"),
        Knob::num("a_min", "A Over", 5.0, (-1000.0, 1000.0)),
        Knob::link("b", "Watch B"),
        Knob::num("b_min", "B Over", 5.0, (-1000.0, 1000.0)),
...
pub const AFTER_TIME: Recipe = Recipe {
    ...
    knobs: &[
        ...
        Knob::num("before", "Before", 0.0, (-1000.0, 1000.0)),
        Knob::num("after", "After", 1.0, (-1000.0, 1000.0)),
    ],
    kind: RowKind::Value,
