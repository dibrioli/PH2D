...
#[cfg(test)]
pub fn sea_trap_threshold(waves: f32) -> f32 {
...
pub fn build_forces_demo_document(
    doc: &mut MotionDoc,
...
#[cfg(test)]
pub fn sea_authored() -> (f32, f32, f32, f32, f32) {
    (
        SEA_AMPLITUDE,
        SEA_WAVELENGTH,
        SEA_SPEED,
