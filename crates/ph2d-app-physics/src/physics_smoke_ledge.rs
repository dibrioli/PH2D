...
use crate::common::{slab, spawn_player};
...
pub fn physics_smoke_ledge(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn build_ledge_scene(world: &mut bevy_ecs::world::World) -> (Entity, Entity) {
...
pub const LEDGE_SMOKE_MESSAGE: &str = concat!(
    ...
    "    * 'Grab Offset Y (m)' DESLIZA o sensor na vertical sem o redimensionar.\n",
    "      Suba para 0.40: ele passa a alcancar labios mais altos SEM que a\n",
    "      histerese do pendurar mude. Baixe para -0.40 e o contrario.\n",
