...
tocada*, com o cap em BYTES.** É a frente **U1** do [plano 26](../26_plano_performance_procreate.md)
...
- [`Painter/26_plano_performance_procreate.md`](../26_plano_performance_procreate.md) **§7** — o
