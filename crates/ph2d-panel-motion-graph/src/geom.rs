...
/// ⭐⭐ **A GEOMETRIA DA FAIXA DE PARAMS DE UM CARTÃO** — irmã por RESPONSABILIDADE (o tecto de
/// LOC de 600 dos painéis obrigou ao corte, e a pergunta desenhou-o): aqui em cima fica a
/// geometria do GRAFO (a vista, o cartão, os sockets, o menu, a moldura), ali a do que um cartão
/// CONTROLA — as fileiras, as bandas, a faixa e as zonas de um selector.
///
/// ⚠️ **Re-exportado inteiro**: todo chamador continua a dizer `geom::param_row_rect`, e a mudança
/// de casa não move um endereço.
#[path = "geom_card.rs"]
mod card;
pub(crate) use card::*;
