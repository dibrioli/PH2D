...
pub struct MotionShellState {
    ...
    pub path_drag: Option<crate::motion_path_overlay::MotionPathGrab>,
    ...
    pub path_last_click: Option<(std::time::Instant, (f32, f32))>,
