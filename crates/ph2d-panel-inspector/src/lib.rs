//! ph2d-panel-inspector — Wave 7 Stage 2 panel-as-crate (alias form).
//!
//! Re-exports the in-tree [`ph2d_editor::screens::hero::inspector::PANEL_MANIFEST`]
...
pub use ph2d_editor::screens::hero::inspector::PANEL_MANIFEST;
