...
mod blend;
use blend::paint_blend_chip;
pub(crate) use blend::paint_blend_popover;
...
fn paint_layer_block(
    ...
    if active {
        // ⭐ Pela porta do TEMA: a camada seleccionada é só tinta num tema moderno.
        let block = Rect::new(m.inner_x, block_top, m.inner_w, block_h);
