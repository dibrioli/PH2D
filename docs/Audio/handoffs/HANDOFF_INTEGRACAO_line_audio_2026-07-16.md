...
```
- [Lista compartilhada só se funde contra a main de HOJE](../../../project-memory/feedback_a_shared_list_is_merged_against_todays_main.md) — "limpei o MEMORY.md" apagou 4 memórias que a main ganhou pós-fork; só ADICIONE, remover é operação de integração
```
