...
impl TextureKind {
    ...
    pub fn name_key(self) -> &'static str {
        match self {
            Self::None => "paint_brush.texture_kind.none",
            Self::Noise => "paint_brush.texture_kind.noise",
            Self::Checker => "paint_brush.texture_kind.checker",
            Self::Voronoi => "paint_brush.texture_kind.voronoi",
            Self::Stripes => "paint_brush.texture_kind.stripes",
            Self::Image => "paint_brush.texture_kind.image",
            Self::Clouds => "paint_brush.texture_kind.clouds",
            Self::DistortedNoise => "paint_brush.texture_kind.distorted_noise",
            Self::Magic => "paint_brush.texture_kind.magic",
            Self::Marble => "paint_brush.texture_kind.marble",
            Self::Musgrave => "paint_brush.texture_kind.musgrave",
            Self::Wood => "paint_brush.texture_kind.wood",
            Self::Stucci => "paint_brush.texture_kind.stucci",
            Self::Gradient => "paint_brush.texture_kind.gradient",
            Self::Grain => "paint_brush.texture_kind.grain",
            Self::Crosshatch => "paint_brush.texture_kind.crosshatch",
            Self::Dots => "paint_brush.texture_kind.dots",
            Self::Grid => "paint_brush.texture_kind.grid",
            Self::Bricks => "paint_brush.texture_kind.bricks",
            Self::Waves => "paint_brush.texture_kind.waves",
            Self::Chevron => "paint_brush.texture_kind.chevron",
            Self::Diamonds => "paint_brush.texture_kind.diamonds",
            Self::Triangles => "paint_brush.texture_kind.triangles",
            Self::Hexagons => "paint_brush.texture_kind.hexagons",
            Self::Scales => "paint_brush.texture_kind.scales",
            Self::Weave => "paint_brush.texture_kind.weave",
            Self::PaperCold => "paint_brush.texture_kind.paper_cold",
            Self::PaperRough => "paint_brush.texture_kind.paper_rough",
            Self::PaperHot => "paint_brush.texture_kind.paper_hot",
        }
    }
}
