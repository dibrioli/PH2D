...
pub const ROW_GAP: f32 = 4.8;
/// A que distância do centro cada coluna vive.
pub const COL_X: f32 = 3.0;
...
pub fn authored() -> (usize, f32) {
    (ROWS_TABLE.len(), SIDE)
}

/// Os rótulos, para a mensagem numerada.
pub fn row_labels() -> impl Iterator<Item = (usize, &'static str)> {
...
pub fn build_bezier_demo_document(doc: &mut MotionDoc, reg: &NodeRegistry) -> Option<Vec<NodeId>> {
    let g = &mut doc.graph;
