...
impl FlipObjectBake {
    ...
    /// node.
    pub fn tiles(&self) -> impl Iterator<Item = (&str, FlipTile)> {
    ...
    pub fn tile_named_shifted(&self, name: &str, offset: f32) -> Option<FlipTile> {
        let oid = self
            .cache
            .iter()
    ...
    pub fn tile_for_id(&self, id: u64) -> Option<FlipTile> {
    ...
    #[cfg(test)]
    pub fn seed_named_shift_for_test(
        &mut self,
        id: u64,
        name: &str,
        offset: f32,
    ...
    #[cfg(test)]
    pub fn seed_for_test(&mut self, id: u64, texture_id: u32, size: [f32; 2]) {
    ...
    pub fn thumbnail_for(&self, texture_id: u32) -> Option<ph2d_panel_motion_graph::PreviewThumb> {
        self.cache
            .values()
    ...
    #[cfg(test)]
    pub fn asked_len_for_test(&self) -> usize {
        self.asked.len()
    }
