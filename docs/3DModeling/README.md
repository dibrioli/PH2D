...
| [`07_fillet_e_chanfro_por_aresta.md`](07_fillet_e_chanfro_por_aresta.md) | ⭐⭐⭐ **AVALIAÇÃO MEDIDA (28/08)** — *«fillet e chanfro por aresta e por vértice?»* (pergunta do Enio). Um raio por **grupo** de arestas é barato, exacto e mantém `‖∇f‖ = 1` (`1,93×` **só** quando os raios diferem); por aresta do **resultado** de uma booleana é ⛔ representação, não preço — traz o *persistent naming* junto. ⭐ E **«por vértice» não é item à parte: é a consequência de «por aresta»** — a medição mostra face e aresta a coincidir e **só o vértice a divergir** |
