...
> ⚠️ **Este handoff SUPERSEDE** `docs/HANDOFF_INTEGRACAO_line_motion_value_group_bypass_2026-08-01.md`,
...
Plano vivo: **[`docs/Motion Nodes/86_plano_objetos_engine_render_e_preview.md`](Motion%20Nodes/86_plano_objetos_engine_render_e_preview.md)**.
