...
//! inteira (a taxonomia do projecto: criar, renomear, aninhar, apagar).
//!
...
//!
//! ⛔ **As FRASES DE RECUSA não entram aqui** — elas nascem em `ph2d_tags::TagError::message`, ao
//! lado da lei que as produz, e a tabela de strings di-lo por escrito. Duplicá-las daria duas
//! frases para a mesma recusa.
use ph2d_label_census::gate::{self, Excecao};

const PREFIX: &str = "panel.tags.";
const TABLES: &[&str] = &["crates/ph2d-i18n/src/tags.rs"];
...
fn every_key_of_this_panel_exists_on_both_sides() {
    ...
    assert!(
        ...
        "o censo achou {} declaradas e {} usadas — o piso é 10 e dois conjuntos vazios \
         concordam sempre",
        c.declaradas,
        c.usadas
    );
