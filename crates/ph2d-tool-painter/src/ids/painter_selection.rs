...
//!
//! ⚠️ **Desceu de `ph2d-editor-core/src/ids/chrome/painter_selection.rs` em 2026-09-12** (auditoria de arquitectura
...
pub const PAINTER_SEL_MODE: NodeId = hash_node_id("painter_sel.mode");
...
pub const PAINTER_SEL_OP: NodeId = hash_node_id("painter_sel.op");
