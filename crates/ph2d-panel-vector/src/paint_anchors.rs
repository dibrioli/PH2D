        ...
        self.segmented(
            ...
            &[
                (
                    ...
                    a.v == Some(ph2d_editor_core::ids::VECTOR_ANCHOR_V_START),
                ),
                (
                    ph2d_editor_core::ids::VECTOR_ANCHOR_V_CENTER,
                    tr("panel.vector.anchors.center"),
                    a.v == Some(ph2d_editor_core::ids::VECTOR_ANCHOR_V_CENTER),
                ),
                (
                    ph2d_editor_core::ids::VECTOR_ANCHOR_V_END,
                    tr("panel.vector.anchors.bottom"),
                    a.v == Some(ph2d_editor_core::ids::VECTOR_ANCHOR_V_END),
                ),
                (
                    ph2d_editor_core::ids::VECTOR_ANCHOR_V_STRETCH,
                    tr("panel.vector.anchors.stretch"),
                    a.v == Some(ph2d_editor_core::ids::VECTOR_ANCHOR_V_STRETCH),
                ),
            ],
            y,
        )
