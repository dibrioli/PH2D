...
pub struct PhysicsState {
    ...
    /// guardar cópia.
    pub interaction: ph2d_physics_ecs::InteractionSettings,
    ...
    pub joint_anchor_drag: Option<crate::joint_anchor_drag::JointAnchorDrag>,
    ...
    /// documento.
    pub joint_draw_armed: bool,

    /// O gesto em curso, ou `None`. Ver [`crate::joint_draw`].
    pub joint_draw: Option<crate::joint_draw::JointDraw>,
