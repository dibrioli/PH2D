...
/// **O roteador desta cena** — lê a `PH2D_VEC_STACK_SMOKE`.
///
...
#[must_use]
pub fn armed() -> bool {
    std::env::var_os("PH2D_VEC_STACK_SMOKE").is_some()
}
...
pub fn build(scene: &mut ph2d_vec_scene::VecScene) {
    ...
    let estrela = ph2d_vec_scene::cook_tinted(
        ShapeKind::Star,
        [-8.0, 0.0],
        [-3.0, 4.5],
        &[5.0, 0.45, 0.0],
    ...
    let linha = ph2d_vec_scene::cook_tinted(
        ShapeKind::Rectangle,
        [-1.5, 1.6],
        [8.0, 1.9],
        &[],
    ...
    let disco = ph2d_vec_scene::cook_tinted(
        ShapeKind::Ellipse,
        [-1.0, -5.0],
        [4.0, 0.0],
        &[],
    ...
    let cartao = ph2d_vec_scene::cook_tinted(
        ShapeKind::Rectangle,
        [-8.2, -5.0],
        [-3.6, -1.4],
        &[],
    ...
    let selo = ph2d_vec_scene::cook_tinted(
        ShapeKind::Star,
        [1.0, 1.6],
        [5.6, 6.2],
        &[5.0, 0.45, 0.0],
    ...
    let mut fundo = ph2d_vec_scene::cook_tinted(
        ShapeKind::Star,
        [4.5, -5.0],
        [9.5, -0.5],
        &[5.0, 0.45, 0.0],
    ...
    let mut cima = ph2d_vec_scene::cook_tinted(
        ShapeKind::Star,
        [4.5, -5.0],
        [9.5, -0.5],
        &[5.0, 0.45, 0.0],
