...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_TEXPAT_SHIFT_Y, VECTOR_TEXPAT_SHIFT_Y_NUM, VECTOR_TEXPAT_SIZE, VECTOR_TEXPAT_SIZE_NUM,
    VECTOR_TEXPAT_SOURCE, VECTOR_TEXPAT_TILE_BRICK, VECTOR_TEXPAT_TILE_COLUMN,
    VECTOR_TEXPAT_TILE_GRID, VECTOR_TEXPAT_TILE_HEX, VECTOR_TEXT_ALIGN_CENTER,
