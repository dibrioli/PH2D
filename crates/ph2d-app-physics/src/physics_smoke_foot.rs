...
pub const LANES: [f32; 3] = [-3.0, 0.0, 3.0];
/// Os nomes das três faixas, na ordem de `LANES`.
pub const LANE_NAMES: [&str; 3] = ["Grounded", "Hovering", "Falling"];
...
#[cfg(test)]
pub const MEASURED_LIT: [bool; 3] = [true, false, true];
...
pub fn build_characters(world: &mut World) {
    world.spawn((
        Name::new("Ground"),
        RigidBody {
...
pub fn physics_smoke_foot(ctx: &mut crate::SceneCtx<'_>) {
