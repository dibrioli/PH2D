...
pub fn flipbook(g: &mut Graph, src: NodeId, holds: Option<&str>, y: f32) -> NodeId {
...
pub fn build_holds_graph(g: &mut Graph) -> Vec<NodeId> {
...
pub fn spawn_art(flip: &mut ph2d_flip::FlipDoc) {
