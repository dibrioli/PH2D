//! ⭐⭐⭐ **NENHUMA PALAVRA DE DESIGN TOKENS É ESCRITA NO FONTE** — o HR-15, por crate.
//!
//! Em 2026-09-16 o painel ainda escrevia a linha de contraste colada em pedaços e o nome da amostra de cor; as chaves moram no `lib.rs` da tabela. O corpo do gate é o [`ph2d_label_census::gate`]; aqui ficam a LISTA desta crate e as
//! mensagens.

use ph2d_label_census::gate::{self, Excecao};

const PREFIX: &str = "panel.tokens.";
