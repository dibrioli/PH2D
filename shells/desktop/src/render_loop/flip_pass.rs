...
pub(crate) struct FlipComposite {
    ...
    stage: crate::render_loop::flip_pass_stage::StageMemo,
}
...
impl FlipComposite {
    fn new(gpu: &GpuContext) -> Self {
        Self {
            ...
            stage: crate::render_loop::flip_pass_stage::StageMemo::default(),
        }
    }
...
pub(crate) fn render(
    ...
    ghosts: Option<crate::render_loop::flip_pass_ghosts::GhostSources<'_>>,
...
fn composite_layers(
    ...
    // sobrescrevê-lo (submissão k+1) — garantido pela ordem da fila.
    {
        ...
        for l in layers {
            ...
            let fp = crate::render_loop::flip_pass_stage::fingerprint(
