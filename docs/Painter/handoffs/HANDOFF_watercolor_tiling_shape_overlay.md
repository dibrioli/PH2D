...
| **14** | **INVESTIGAÇÃO: retângulos do Per-Layer Color no brush COMUM** | bug aberto; handoff `docs/Painter/handoffs/HANDOFF_per_layer_color_perf_artifacts.md`. Aplicar o MÉTODO do BUGS #8 (bissecção + perfil + sondas). |
