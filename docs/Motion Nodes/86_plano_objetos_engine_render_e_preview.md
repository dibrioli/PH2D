...
6. ~~Ordem~~ — **DECIDIDO (Enio, 2026-08-02): B (preview) primeiro, depois A1**, depois A2→A4. **Wave B FECHADA (smoke OK).** **Wave A1 FECHADA (smoke OK).** **Wave A2 CONSTRUÍDA (aguarda smoke)** — ver §8. Próximo após smoke de A2: **A3** (bake de **Flip** via `ph2d-flip-render` — o membrane ganha o ramo de Flip, o nó `source.object` de novo intacto) e **A4** (grupo/composto).
