...
[`docs/Flip/03_traco_rasterizacao.md`](../03_traco_rasterizacao.md)** (mecanismo, as 4 peças,
...
[`docs/Flip/05_frames_ghost_tween.md`](../05_frames_ghost_tween.md). Resumo do que existe agora:
...
Doc definitivo: [`docs/Flip/06_fill_balde.md`](../06_fill_balde.md).
...
[`BUGS_flip.md` #14](../BUGS_flip.md); o resumo do que mudou no código:
...
Doc definitivo: [`docs/Flip/07_reshape_escultura.md`](../07_reshape_escultura.md).
...
O "select do traço". **Doc: [`docs/Flip/08_edit_mode_selecao.md`](../08_edit_mode_selecao.md).**
...
Doc: [`Flip/08 §5b`](../08_edit_mode_selecao.md).
...
Doc: [`Flip/05 §8`](../05_frames_ghost_tween.md). Marque chaves na tira (Shift/Ctrl+clique
...
(`02_referencia`: *"anti-padrão do GP: 2 anos sem UI"*). Doc: [`Flip/05 §6.1`](../05_frames_ghost_tween.md).
...
*a arte é uma só; o LUGAR é de cada quadro*. Doc: [`Flip/05 §6.2`](../05_frames_ghost_tween.md).
...
- **"Não percebo o efeito de falloff"** (`3a95954b`, depois reestilizado — ver W7.4): o falloff só
  ...
  MESMA `falloff_at` da escultura, seed = sample). Doc: [`Flip/05 §8`](../05_frames_ghost_tween.md).
