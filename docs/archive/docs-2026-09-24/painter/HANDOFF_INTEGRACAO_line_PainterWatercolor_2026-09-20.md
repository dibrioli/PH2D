# ARQUIVO — HANDOFF_INTEGRACAO_line_PainterWatercolor_2026-09-20.md (história, 3023 linhas)

> ⚠️ **Isto NÃO é o estado atual de nada.** É a história recortada de
> [`HANDOFF_INTEGRACAO_line_PainterWatercolor_2026-09-20.md`](../../../Painter/handoffs/HANDOFF_INTEGRACAO_line_PainterWatercolor_2026-09-20.md) em 2026-08-18, **verbatim** — nenhuma
...
>
> Recorte: linhas fora de `1-14,3038-3275` do original.
>
> ⚠️ **A única alteração ao corpo:** 31 alvo(s) de link relativo foram
...
depois). A tabela por mutação está no [doc 41 §7](../../../Painter/41_a_reserva_e_um_nivel_disputado.md).
...
> [doc 40 §S2-C e §9](../../../Painter/40_a_costura_dura_do_retorno_sobre_o_proprio_traco.md).
...
as tabelas, está em [`docs/Painter/40_auditoria_da_pilha_2026-09-21.md`](../../../Painter/40_auditoria_da_pilha_2026-09-21.md);
...
**atribuição falsa** que eu reportei ao dono — é o **[Bug #24](../../../Painter/BUGS_painter.md)**; aqui fica o
...
(§5.3 da [auditoria](../../../Painter/40_auditoria_da_pilha_2026-09-21.md)) — ela é refrescada só dentro da região
...
> [doc 42](../../../Painter/42_auditoria_do_watercolor_2026-09-22.md).
...
módulo: **[doc 43](../../../Painter/43_a_pilha_do_composite_brush_ficou_rapida.md)**, com o amostrador por `gdb`
versionado em [`ferramentas/amostra_gdb.py`](../../../Painter/ferramentas/amostra_gdb.py) e duas linhas novas no
placar do [doc 28](../../../Painter/28_otimizacoes_o_que_funcionou.md) (W, X e a recusa Y).
