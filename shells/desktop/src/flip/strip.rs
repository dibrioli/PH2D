...
pub(crate) struct FlipStrip {
    ...
    /// par não muda o desenho até o Add. Ver [`crate::flip::tween_correct`].
    pub(crate) tween_correct: Option<crate::flip::tween_correct::TweenCorrect>,
}
    ...
    match ev {
        ...
        PanelEvent::Click(id) if *id == ids::FLIP_TWEEN_PAIRS => {
            if strip.tween_correct.is_some() {
                ...
                strip.tween_correct =
                    crate::flip::tween_correct::build(flip, active_layer, playhead);
            }
