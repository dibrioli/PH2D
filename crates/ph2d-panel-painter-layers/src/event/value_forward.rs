...
pub(super) fn route(host: &mut dyn PanelHostInternal, id: ph2d_a11y::NodeId) -> bool {
    ...
    if id == ph2d_tool_painter::ids::PAINTER_WETPAINT_TILT_PAD {
