...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_ENVELOPE_RUN, VECTOR_FILL_KIND_LINEAR, VECTOR_FILL_KIND_MULTI, VECTOR_FILL_KIND_RADIAL,
    VECTOR_FILL_KIND_SOLID, VECTOR_FILL_OPACITY, VECTOR_FILL_OPACITY_NUM, VECTOR_FILL_RULE_EVENODD,
    VECTOR_FILL_RULE_NONZERO, VECTOR_FILL_SWATCH, VECTOR_FX_TRIM, VECTOR_FX_TRIM_END,
    VECTOR_FX_TRIM_END_NUM, VECTOR_FX_TRIM_OFFSET, VECTOR_FX_TRIM_OFFSET_NUM, VECTOR_FX_TRIM_START,
    VECTOR_FX_TRIM_START_NUM, VECTOR_GAP, VECTOR_GAP_NUM, VECTOR_GRAD_ADD_POINT,
    VECTOR_GRAD_ADD_STOP, VECTOR_GRAD_ANGLE, VECTOR_GRAD_ANGLE_NUM, VECTOR_GRAD_INFLUENCE,
    VECTOR_GRAD_INFLUENCE_NUM, VECTOR_GRAD_JITTER, VECTOR_GRAD_JITTER_NUM,
...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_SECTION_FILL, VECTOR_SECTION_FILL_TYPE, VECTOR_SECTION_FONT, VECTOR_SECTION_MORPH,
