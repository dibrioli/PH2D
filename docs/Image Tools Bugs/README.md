...
**Gate:** crates/ph2d-editor-core/tests/it/arch_color_space_typed.rs (heuristic match — refine if wrong)
...
**Gate:** crates/ph2d-editor-core/tests/it/arch_mode_has_reconcile.rs (heuristic match — refine if wrong)
...
**Gate:** crates/ph2d-editor-core/tests/it/no_tofu_glyphs.rs (heuristic match — refine if wrong)
