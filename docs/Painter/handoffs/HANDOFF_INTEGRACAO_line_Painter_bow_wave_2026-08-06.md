...
[plano 34 §5](../34_plano_smokes_e_cerca.md) listava era a maior — **a fronteira é o MEIO**.
...
[`docs/Painter/35_boolean_o_que_o_vector_ensina.md`](../35_boolean_o_que_o_vector_ensina.md).
