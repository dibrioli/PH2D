...
mod wave_view;
#[cfg(feature = "panel-audio-editor")]
pub use wave_view::{WaveView, frame_at_x, set_wave_view, wave_view};
#[cfg(feature = "panel-audio-editor")]
pub mod fx_params;
...
pub struct AudioSystem {
    ...
    ml_job: Option<ph2d_editor_core::Job<editor::spectral::MlDenoise>>,
    ...
    #[cfg(feature = "audio-ml")]
    started_job: Option<ph2d_editor_core::Progress>,
...
impl AudioSystem {
    ...
    pub fn scene_parts(&mut self) -> (&mut scene::SceneAudio, &mut AudioEngine) {
    ...
    pub fn set_bus_gain(&self, i: usize, gain: f32) {
    ...
    pub fn set_bus_pan(&self, i: usize, pan: f32) {
    ...
    pub fn set_bus_cutoff(&self, i: usize, hz: f32) {
    ...
    pub fn set_bus_highpass(&self, i: usize, hz: f32) {
    ...
    pub fn set_bus_send(&self, i: usize, amount: f32) {
    ...
    pub fn set_delay(&self, on: bool, time: f32, feedback: f32, mix: f32) {
    ...
    pub fn set_bus_delay_send(&self, i: usize, amount: f32) {
    ...
    pub fn set_bus_compressor(&self, i: usize, amount: f32) {
    ...
    pub fn update_ducking(&self, on: bool, depth: f32, key_idx: usize) -> f32 {
    ...
    pub fn set_master_cutoff(&self, hz: f32) {
    ...
    pub fn set_master_highpass(&self, hz: f32) {
    ...
    pub fn set_reverb(&self, on: bool, size: f32, mix: f32) {
    ...
    pub fn set_master_eq(&self, low: f32, mid: f32, high: f32) {
    ...
    pub fn set_test_playing(&mut self, on: bool) {
