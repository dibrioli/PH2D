//! ⭐⭐⭐ **NENHUMA PALAVRA DO PAINEL PADDING É ESCRITA NO FONTE** — o HR-15, por crate.
//!
//! Migrado em 2026-09-16 (`scripts/migrar-texto-pintado.py`, mapa
//! `docs/UI_New_and_Simple/ferramentas/seccoes_padding.tsv`): o painel escrevia **11** textos no fonte, medidos
...
const PREFIX: &str = "panel.padding.";
