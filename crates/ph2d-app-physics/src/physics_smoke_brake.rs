...
pub const DECK_END: f32 = 20.0;
/// O fundo do poço.
pub const PIT_TOP: f32 = -6.0;

/// Os três freios da cena.
pub const BRAKES: [(f32, &str); 3] = [(0.0, "Ice"), (1.0, "Normal"), (2.0, "Hard")];
...
pub const LANE_SPAN: f32 = 32.0;

/// Onde a raia `i` começa.
#[must_use]
pub fn lane_x(i: usize) -> f32 {
    i as f32 * LANE_SPAN
}
...
/// **A derrapada** — o peso.
pub fn physics_smoke_brake(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn build_brake_scene(world: &mut bevy_ecs::world::World) -> Vec<Entity> {
    BRAKES
        .iter()
        .enumerate()
...
pub const BRAKE_SMOKE_MESSAGE: &str = concat!(
