...
//!
//! Irmão do [`crate::motion_shape_gen`], cortado pelo teto de 600 LOC da shell e por
...
impl VecPathStore {
    ...
    pub fn intern(&mut self, key: &str, build: impl FnOnce() -> VecPath) -> u32 {
    ...
    pub fn handle_for(&mut self, key: &str) -> Option<u32> {
    ...
    /// tudo*.
    pub fn push(&mut self, path: VecPath) -> u32 {
        self.next += 1;
        let h = self.next;
    ...
    /// publicarem ([`crate::motion_externals::publish_all`]).
    ///
