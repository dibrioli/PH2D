...
| **6** | o resto do catálogo, por gosto — **em curso**: a **F5 cascata** FEITA na paleta (⚠️ `ε` reprovado uma vez no smoke — 0,020 lia-se simultâneo; o valor é **0,050 s**, §6.3 do estudo), a **E2 rolagem suave** (a porta  passou a devolver o vivo ⇒ ~130 leitores de graça) e: as **rows dos menus** da barra entraram na paleta global (33 verbos, 9 menus), fechando a cauda que o commit da E3 nomeou. ⚠️ E corrigindo-o: *«a barra de topo fica de fora»* era verdade do **PILL** e falsa da **ROW**. Ver a §6.1 do estudo | 1-3 | — | — |
