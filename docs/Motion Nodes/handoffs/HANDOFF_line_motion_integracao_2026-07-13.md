...
> O registro da integração está em [`REGISTRO_integracao_jornada_2026-07-13.md`](../../archive/integracao-jornadas/REGISTRO_integracao_jornada_2026-07-13.md).
...
| # | Fatia | Nota-ADR |
|---|---|---|
| 1 | **Subgrafos** — nesting é uma *dobra da VISTA* | [doc 57](../57_subgrafos_nota_adr.md) |
| 2 | **Params dirigidos por fio** — `value.lfo` → `force.wind.strength` | [doc 58](../58_params_dirigidos_nota_adr.md) |
| 3 | **Busca no add-menu** — fuzzy, ranqueada, nos DOIS nomes | [doc 59](../59_busca_no_add_menu_nota_adr.md) |
| 4 | **O clique que deslizava** — o bug que o menu tinha desde sempre | [doc 59 §5](../59_busca_no_add_menu_nota_adr.md) |
| 5 | **Poisson-disc + Bóia** — 2 nós novos; a neve cai no mar | [doc 60](../60_poisson_e_buoyancy_nota_adr.md) |
| 6 | **Nomes no grafo (F2)** — card, grupo e backdrop | [doc 61](../61_nomes_no_grafo_nota_adr.md) |
| 7 | **Paleta do backdrop (R-click)** | [doc 62](../62_paleta_do_backdrop_nota_adr.md) |
...
| **`ph2d-editor-core/tests/it/hr12_widgets_a11y.rs`** | **+entrada** na allowlist `PANEL_A11Y_DELEGATE_OK` (`paint_menu.rs`) | **ALTO se outra linha também adicionou** — **funda a união** |
...
- **Corrigido por escrito:** [doc 61 §2](../61_nomes_no_grafo_nota_adr.md) ·
  [doc 62 §1](../62_paleta_do_backdrop_nota_adr.md) · memória
