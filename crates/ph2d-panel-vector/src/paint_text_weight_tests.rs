...
fn a_weight_only_variable_font_keeps_its_weight_row() {
    ...
    assert!(
        !painted(crate::ids::vector_text_axis_id(0)),
...
fn a_font_with_weight_and_more_shows_both_sections() {
    ...
    assert!(
        painted(crate::ids::vector_text_axis_id(0)) && painted(crate::ids::vector_text_axis_id(1)),
