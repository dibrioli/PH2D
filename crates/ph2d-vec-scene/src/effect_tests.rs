...
fn the_engine_and_panel_agree_on_the_kind_ceiling() {
    // `ph2d_editor_core::ids::MAX_FX_KINDS`, em ids/chrome/vector.rs (9→13 catálogo único; 21→22 Mirror; 13→17
    // com as 4 formas de Falloff; 17→18 com o Twist; 18→19 com o Knot; 19→21 com Sketch + Hatch).
    const PANEL_MAX_FX_KINDS: usize = 22;
    assert!(
