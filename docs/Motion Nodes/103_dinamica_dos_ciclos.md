...
| 10 ✅ ([doc 116](116_ciclo_10_o_carimbo_no_dispositivo.md), fechado com o ciclo 12) | ⚡ **O CARIMBO NO DISPOSITIVO** — `source.shape` + `motion.duplicator` | (optimização, não um grupo novo) | ⛔ **não tem tutorial** (doc 116 §1) |
