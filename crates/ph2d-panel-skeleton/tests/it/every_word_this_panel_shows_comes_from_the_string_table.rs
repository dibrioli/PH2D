...
//! inteira (os ossos e a restrição de IK).
//!
...
//!
//! ⚠️ **O piso do censo de chaves é `1`, e ele é honesto sobre o que vale:** este painel pede o
//! vocabulário emprestado ao do VECTOR (`panel.vector.*`), e a única chave `panel.skeleton.*` é o
//! nome dele. Um piso de `1` não prova muito — prova que o censo lê o sítio certo.
use ph2d_label_census::gate::{self, Excecao};

const PREFIX: &str = "panel.skeleton.";
