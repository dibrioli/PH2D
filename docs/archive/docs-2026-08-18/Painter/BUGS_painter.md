# ARQUIVO — BUGS_painter.md (história, 1631 linhas)

> ⚠️ **Isto NÃO é o estado atual de nada.** É a história recortada de
> [`BUGS_painter.md`](../../../Painter/BUGS_painter.md) em 2026-08-18, **verbatim** — nenhuma
...
>
> Recorte: linhas fora de `1-6,586-634,753-759,880-883,895-896,980-1057,1778-1781` do original.
>
> ⚠️ **A única alteração ao corpo:** 28 alvo(s) de link relativo foram
...
**Detalhe técnico:** [`25_avaliacao_gpu.md`](../../../Painter/25_avaliacao_gpu.md) §13.11 (diagnóstico) → §13.12 (o `keep`
...
[`16_impasto_plano_implementacao.md`](../../../Painter/16_impasto_plano_implementacao.md) §14–§16.
...
> [`09_curvas_convert_merge_simplify_offset.md`](../../../Painter/09_curvas_convert_merge_simplify_offset.md).
...
- **Bridge (`2c64ba80`) — ❌ REVERTIDO (`461dcafd`, 2026-07-04).** A ideia era: `needs_upload` do sinal
  ...
  ver [`HANDOFF_per_layer_color_perf_artifacts`](../../../Painter/handoffs/HANDOFF_per_layer_color_perf_artifacts.md) §4.2.
