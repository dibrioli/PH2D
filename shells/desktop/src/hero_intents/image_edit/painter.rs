//! Drain Painter — single-sprite bake of the layer composite.
//!
//! Painter is the stateful layers + effects host. On Apply, `run_full()`
//! returns the composited layer stack (base + every layer's opacity / blend /
//! adjustments) which we bake back into the sprite as a fresh Individual
