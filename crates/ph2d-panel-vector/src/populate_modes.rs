...
pub(super) fn mode_buttons(store: &mut WidgetStore) {
    ...
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_PENCIL);
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_SHAPE);
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_TEXT);
    // Connect (a linha que gruda em duas formas) + Build (Shape Builder).
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_CONNECT);
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_BUILD);
    // Pick Shapes (Blend): o botão mora na seção BLEND, mas registra-se aqui.
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_PICKBLEND);
    // Fillet / Chamfer: arredondar / chanfrar quina por clicar-e-arrastar.
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_FILLET);
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_CHAMFER);
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_WIDTH);
    ...
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_CUT);
    ...
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_TRIM);
    // **Balde** (plano 40) — o 16º pill, e a mesma linha pela mesma razão.
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_BUCKET);
    ...
    button(store, ph2d_tool_vector::ids::VECTOR_MARQUEE_BOX);
    button(store, ph2d_tool_vector::ids::VECTOR_MARQUEE_LASSO);
    ...
    button(store, ph2d_tool_vector::ids::VECTOR_MODE_FRAME);
