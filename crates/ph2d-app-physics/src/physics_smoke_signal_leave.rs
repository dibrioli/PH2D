...
pub const LANE_Y: [f32; 3] = [4.2, 2.6, 1.0];
pub const LANE_NAMES: [&str; 3] = ["Door", "Bell", "Half"];
...
pub fn build_signal_leave_scene(world: &mut World) {
    world.spawn((
        Name::new("Ground"),
        RigidBody {
...
pub fn physics_smoke_signal_leave(ctx: &mut crate::SceneCtx<'_>) {
