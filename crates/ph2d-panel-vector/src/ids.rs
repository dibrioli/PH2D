...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_ARRANGE_ROTATE_CW, VECTOR_ARRANGE_TO_BACK, VECTOR_ARRANGE_TO_FRONT, VECTOR_BLEND_EXPAND,
    VECTOR_BLEND_RELEASE, VECTOR_BLEND_RESET_SPINE, VECTOR_BLEND_RUN, VECTOR_BLEND_STACK_UP,
    VECTOR_BLEND_STEPS, VECTOR_BLEND_STEPS_NUM, VECTOR_BOOL_APPLY, VECTOR_BOOL_CROP,
    VECTOR_BOOL_EXCLUDE, VECTOR_BOOL_INTERSECT, VECTOR_BOOL_LIVE_OFF, VECTOR_BOOL_LIVE_ON,
    VECTOR_BOOL_MERGE, VECTOR_BOOL_MINUS_BACK, VECTOR_BOOL_SUBTRACT, VECTOR_BOOL_TRIM,
    ...
    VECTOR_DASH_NUM, VECTOR_DISTRIBUTE_H, VECTOR_DISTRIBUTE_V, VECTOR_ENVELOPE_BEND,
    ...
    VECTOR_TEXT_WEIGHT_NUM, VECTOR_TRANSFORM_H, VECTOR_TRANSFORM_R, VECTOR_TRANSFORM_RESIZE_BOX,
...
pub use ph2d_editor_core::ids::{
    VECTOR_FRAME_CLIP_OFF, VECTOR_FRAME_CLIP_ON, VECTOR_FRAME_PRESET_DESKTOP,
    VECTOR_FRAME_PRESET_PHONE, VECTOR_FRAME_PRESET_SQUARE, VECTOR_FRAME_PRESET_TABLET,
    VECTOR_MODE_FRAME, VECTOR_SECTION_FRAME,
};

/// **O AUTO LAYOUT** (plano UI/UX W2, ADR-0153): a seção, o rádio de direção, os vãos, o recuo
/// (modo + cinco campos), as duas fileiras de alinhamento e o par Grow/Shrink do filho.
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_LAYOUT_JUSTIFY_START, VECTOR_LAYOUT_PAD_ALL, VECTOR_LAYOUT_PAD_ALL_MODE,
