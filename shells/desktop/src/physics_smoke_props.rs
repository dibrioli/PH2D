...
pub fn physics_smoke_capsule(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    ...
    ctx.want.settings = Some(settings);
...
pub fn physics_smoke_gravity(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_launch(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_ccd(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
/// so they never meet.
pub fn physics_smoke_lock_rotation(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
...
/// to drop them.
pub fn physics_smoke_offset(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_freeze_position(ctx: &mut ph2d_app_physics::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
