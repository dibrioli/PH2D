# ARQUIVO — 01_a_fila.md (história, 3435 linhas)

> ⚠️ **Isto NÃO é o estado atual de nada.** É a história recortada de
> [`01_a_fila.md`](../../Skeleton/01_a_fila.md) em 2026-08-18, **verbatim** — nenhuma
...
>
> Recorte: linhas fora de `1-12,282-299,1865-1912,2921-2970,3564-3608` do original.
>
> ⚠️ **A única alteração ao corpo:** 32 alvo(s) de link relativo foram
...
[`02_pesquisa_a_malha_sobre_a_imagem.md`](../../Skeleton/02_pesquisa_a_malha_sobre_a_imagem.md).
...
([plano 03](../../Skeleton/03_plano_a_pele_no_passe_de_sprites.md), W1+W2) — e o plano achou um quinto defeito: a
...
A cura da F6-h, em duas waves ([plano 03](../../Skeleton/03_plano_a_pele_no_passe_de_sprites.md) §5).
...
⇒ **[HANDOFF_O_RESTO_DO_APP_ACHAVA_A_ARTE_PLANA_2026-09-15](../../Skeleton/handoffs/HANDOFF_O_RESTO_DO_APP_ACHAVA_A_ARTE_PLANA_2026-09-15.md)**
...
⇒ **[HANDOFF_A_CURVATURA_DEBAIXO_DO_DAB_2026-09-14](../../Skeleton/handoffs/HANDOFF_A_CURVATURA_DEBAIXO_DO_DAB_2026-09-14.md)**
...
A corrida, os cinco scripts e a saída com proveniência: [`docs/Skeleton/oraculo/`](../../Skeleton/oraculo/README.md).
