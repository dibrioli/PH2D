# ARQUIVO — BUGS_vector.md (história, 1453 linhas)

> ⚠️ **Isto NÃO é o estado atual de nada.** É a história recortada de
> [`BUGS_vector.md`](../../../Vector%20Module/BUGS_vector.md) em 2026-08-18, **verbatim** — nenhuma
...
>
> Recorte: linhas fora de `1-10,881-886,1411-1419,1479-1582` do original.
>
> ⚠️ **A única alteração ao corpo:** 3 alvo(s) de link relativo foram
