...
pub(crate) const PROBES_SMOKE_MESSAGE: &str = concat!(
    ...
    " 1. Marque Physics no transporte e de Play. Debaixo do personagem ha' uma\n",
    "    linha para BAIXO com um TIQUE atravessado: e' a perna, e o tique diz\n",
    "    ONDE ela achou o chao.\n",
    " 2. Ande. A linha acompanha, e o tique fica colado no chao.\n",
    " 3. Ao lado do corpo ha' tres tracinhos APAGADOS (o flanco) e um risco\n",
    "    APAGADO sobre a cabeca (o vao da quina). Apagado = ARMADO e nao\n",
    "    perguntado -- e' o estado que diz 'a capacidade esta' la', nao e' a\n",
    "    hora', e ate' esta wave ele era indistinguivel de nao existir.\n",
    ...
    "    ele levanta-se.\n",
    " 5. BEIRAL: pule junto da quina (x=15). Enquanto ele SOBE, o risco sobre a\n",
    "    cabeca ganha hastes ACESAS do lado que esta' tapado -- e' o perfil do\n",
    "    teto, e as hastes sao o que a assistencia de canto leu.\n",
    ...
    " 7. CONTROLE: aperte B. Os sensores TEM de sumir junto com o contorno dos\n",
