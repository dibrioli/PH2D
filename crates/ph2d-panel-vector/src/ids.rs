...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_STROKE_PRESENT, VECTOR_STROKE_SWATCH, VECTOR_TEXPAT_ANGLE, VECTOR_TEXPAT_ANGLE_NUM,
    VECTOR_TEXPAT_GAP, VECTOR_TEXPAT_GAP_NUM, VECTOR_TEXPAT_H, VECTOR_TEXPAT_H_NUM,
    VECTOR_TEXPAT_LOCK, VECTOR_TEXPAT_MODE_CLAMP, VECTOR_TEXPAT_MODE_MIRROR,
    ...
    VECTOR_TEXPAT_TARGET_FILL, VECTOR_TEXPAT_TARGET_STROKE, VECTOR_TEXPAT_TILE_BRICK,
    VECTOR_TEXPAT_TILE_COLUMN, VECTOR_TEXPAT_TILE_GRID, VECTOR_TEXPAT_TILE_HEX, VECTOR_TEXPAT_W,
    VECTOR_TEXPAT_W_NUM, VECTOR_TEXT_ALIGN_CENTER, VECTOR_TEXT_ALIGN_LEFT, VECTOR_TEXT_ALIGN_RIGHT,
    VECTOR_TEXT_FONT_DD, VECTOR_TEXT_FONT_IMPORT, VECTOR_TEXT_FONT_NEXT, VECTOR_TEXT_FONT_PREV,
    VECTOR_TEXT_LINE_HEIGHT, VECTOR_TEXT_LINE_HEIGHT_NUM, VECTOR_TEXT_SIZE, VECTOR_TEXT_SIZE_NUM,
    VECTOR_TEXT_TRACKING, VECTOR_TEXT_TRACKING_NUM, VECTOR_TEXT_WEIGHT, VECTOR_TEXT_WEIGHT_NUM,
    VECTOR_TEXT_WRAP_AUTO, VECTOR_TEXT_WRAP_FIXED, VECTOR_TEXT_WRAP_W, VECTOR_TEXT_WRAP_W_NUM,
    VECTOR_TRANSFORM_H, VECTOR_TRANSFORM_R, VECTOR_TRANSFORM_RESIZE_BOX, VECTOR_TRANSFORM_W,
    ...
    VECTOR_VERT_SYMMETRIC, VECTOR_VERT_X, VECTOR_VERT_Y, VECTOR_WIDTH, VECTOR_WIDTH_NUM,
};
