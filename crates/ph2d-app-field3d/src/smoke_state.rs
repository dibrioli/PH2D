...
/// (ver `preview::cancels_the_inflight`).
///
...
pub struct Viewport {
    ...
    /// escolhe a resolução do preview ([`crate::preview`]).
    ///
...
impl Viewport {
    ...
    #[cfg(test)]
    #[doc(hidden)]
    pub fn probe_forget_frame(&mut self) {
        self.frame = None;
        self.requested = None;
        self.inflight = None;
    }
    ...
    #[cfg(test)]
    #[doc(hidden)]
    pub fn probe_has_frame(&self) -> bool {
        self.frame.is_some()
    }
    ...
    #[cfg(test)]
    #[doc(hidden)]
    pub fn probe_resting_state(&self) -> Option<bool> {
    ...
    /// tracei nada»*.
    pub fn new(cam: Orbit, manual: bool) -> Self {
        Self {
            cam,
            frame: None,
            inflight: None,
...
pub struct Smoke {
    ...
    pub view_menu: Option<usize>,
    /// O rectângulo do menu aberto, **publicado por quem o pinta** — ver
    /// [`crate::view_menu`]. Cache, como o irmão acima.
    pub view_menu_rect: Option<EditorRect>,
    /// ⭐⭐⭐ **Como o canvas está dividido** — ver [`crate::layout::Split`].
    ///
    /// ⚠️ **Estado de VISTA**, como a câmera: ele não toca a peça, não entra no undo e não viaja no
    /// arquivo. ⛔ E **não** viaja no [`crate::view::View`] que sobrevive a fechar o painel:
    ...
    /// O arrasto em curso, se houver ([`crate::input`]).
    ...
    pub gizmo: Option<crate::gizmo::Anchor>,
    ...
    pub vertices: Option<crate::gizmo::Vertices>,
    /// A alça sob o cursor. Só realce — quem manda no arrasto é o `drag`.
    pub gizmo_hot: Option<crate::gizmo::Handle>,
    ...
    pub snapping: bool,
    /// ⭐ **O número que está a ser DIGITADO no meio do gesto** (W26, [`crate::typed`]).
    ///
    ...
    pub pending_pick: Option<([f32; 2], bool)>,
    ...
    /// dedo por um quadro.
    pub pending_lasso: Option<([f32; 2], [f32; 2])>,
    ...
    pub gizmo_mode: crate::gizmo::Mode,
    ...
    /// que o nó ainda existe antes de o usar (ver `scene::cook_root`). Um isolamento
    ...
    /// movimento que ninguém pediu. Ver [`crate::flight`].
    pub flight: Option<crate::flight::Flight>,
    ...
    pub nav_hot: Option<crate::views::Standard>,
    ...
    pub nav_press: Option<crate::views::Standard>,
...
pub struct Grip {
    ...
    pub applied: crate::gizmo::Motion,
