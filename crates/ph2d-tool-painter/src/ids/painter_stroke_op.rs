...
//!
//! ⚠️ **Desceu de `ph2d-editor-core/src/ids/chrome/painter_stroke_op.rs` em 2026-09-12** (auditoria de arquitectura
...
pub const PAINTER_STROKE_OP: NodeId = hash_node_id("painter_brush.stroke_op");
