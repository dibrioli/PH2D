...
//!
//! Irmão do [`crate::overlay::joints`], e o corte é a distinção que aquele
...
use crate::overlay::joint_glyphs::{ring_px, screen_of, spring_zigzag};
use crate::overlay::joints::{JOINT_DOT_PX, dashed};
...
pub const GRAB_RGBA: [f32; 4] = [0.55, 1.0, 0.30, 0.95]; // LITERAL-COLOR-OK: overlay da mão
