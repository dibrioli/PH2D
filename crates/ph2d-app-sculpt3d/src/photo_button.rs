...
///
/// ⚠️ Ela chama [`crate::Sculpt3dScene::quad_remesh`] — a **porta** —, então
...
fn the_artists_piece_through_the_button() {
    ...
    let mut scene = crate::Sculpt3dScene::new(&gpu.device, piece.clone(), 1.0);
    scene.note_canvas(ph2d_editor_core::zones::Rect::new(0.0, 0.0, 900.0, 700.0));
