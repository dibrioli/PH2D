...
/// Os gates do SELECTOR (as duas setas e a lista) — irmãos por RESPONSABILIDADE, cortados no
/// tecto de LOC dos painéis: aqui ficam os gestos de uma row de NÚMERO, ali os de uma row de
/// ESCOLHA.
#[path = "interact_param_row_selector_tests.rs"]
mod selector;
