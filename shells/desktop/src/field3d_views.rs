//! **As seis vistas nomeadas** — a lei vive na [`ph2d_viewport3d::views`].
//!
//! ⚠️ **Este alias existe por UM motivo só: não editar a árvore de outra linha.** `crate::field3d_views`
...
//! escrever `ph2d_viewport3d::views` directamente. *Um alias com data de validade escrita é dívida
