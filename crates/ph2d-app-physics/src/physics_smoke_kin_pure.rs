...
pub const LANE_TOP: [f32; 3] = [6.0, 0.0, -6.0];
/// Onde cada obstáculo nasce.
pub const CRATE_X: f32 = 3.0;
/// A metade PENDURADA do chão — o artista anda para cima dela.
pub const SLING_X: f32 = 9.0;
pub const SLING_HALF: f32 = 3.0;
...
pub fn physics_smoke_kin_pure(ctx: &mut crate::SceneCtx<'_>) {
    build(ctx.world);
