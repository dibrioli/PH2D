...
pub fn physics_smoke_capsule(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn physics_smoke_gravity(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_launch(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_ccd(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
/// so they never meet.
pub fn physics_smoke_lock_rotation(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
...
/// to drop them.
pub fn physics_smoke_offset(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
...
pub fn physics_smoke_freeze_position(ctx: &mut crate::SceneCtx<'_>) {
    let world = &mut *ctx.world;
    spawn_floor(world);
