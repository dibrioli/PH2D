...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_BOOL_CROP, VECTOR_BOOL_EXCLUDE, VECTOR_BOOL_GRAPH_OPEN, VECTOR_BOOL_INTERSECT,
    VECTOR_BOOL_LIVE_OFF, VECTOR_BOOL_LIVE_ON, VECTOR_BOOL_MERGE, VECTOR_BOOL_MINUS_BACK,
