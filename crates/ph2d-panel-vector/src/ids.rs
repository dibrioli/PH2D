...
pub use ph2d_editor_core::ids::{
    ...
    VECTOR_TEXPAT_ANGLE_NUM, VECTOR_TEXPAT_GAP, VECTOR_TEXPAT_GAP_NUM, VECTOR_TEXPAT_MODE_CLAMP,
    VECTOR_TEXPAT_MODE_MIRROR, VECTOR_TEXPAT_MODE_TILE, VECTOR_TEXPAT_OFFSET,
    VECTOR_TEXPAT_OFFSET_NUM, VECTOR_TEXPAT_PICK_SHAPE, VECTOR_TEXPAT_SHIFT_X,
    VECTOR_TEXPAT_SHIFT_X_NUM, VECTOR_TEXPAT_SHIFT_Y, VECTOR_TEXPAT_SHIFT_Y_NUM,
    VECTOR_TEXPAT_SIZE, VECTOR_TEXPAT_SIZE_NUM, VECTOR_TEXPAT_SOURCE, VECTOR_TEXPAT_TILE_BRICK,
    VECTOR_TEXPAT_TILE_COLUMN, VECTOR_TEXPAT_TILE_GRID, VECTOR_TEXPAT_TILE_HEX,
