...
pub const COL_X: f32 = 2.6;
/// O centro de cada linha, de cima para baixo.
pub const ROW_Y: [f32; 4] = [4.4, 1.4, -1.6, -4.7];
...
pub const BANDS: [(f32, f32, f32, f32); 4] = [
    (12.0, 1.0, 0.26, 0.17),
    (8.0, 8.0, 0.28, 0.14),
    (16.0, 1.0, 0.19, 0.13),
    (11.0, 11.0, 0.24, 0.11),
...
#[must_use]
pub fn footprint(k: usize) -> (f32, f32) {
...
pub const ORDER_BY_ATTRIBUTE: f32 = 1.0;
...
pub const ATTR_FREQ: f32 = 4.5;

// ── Par 3 · RAMPA ────────────────────────────────────────────────────────────
/// O contorno `Curve` do `field.remap` (o valor do enum).
pub const CONTOUR_CURVE: f32 = 4.0;
...
pub const CURVE_SHIFT: f32 = 0.35;
/// O modo `Ramp` do `value.instance_field`: o índice normalizado, `0..1`.
pub const FIELD_RAMP: f32 = 1.0;
/// O canal **Falloff** do `motion.drive`, e o modo **Set**.
pub const DRIVE_FALLOFF: f32 = 5.0;
pub const DRIVE_SET: f32 = 1.0;

// ── Par 4 · FORMA ────────────────────────────────────────────────────────────
pub const SHAPE_SIDES: f32 = 5.0;
pub const SHAPE_RADIUS: f32 = 0.72;
pub const SHAPE_DISTANCE: f32 = 0.20;
...
pub fn build_rank_demo_document(
    doc: &mut MotionDoc,
