...
pub const LANE_STIFFNESS: [f32; 4] = [0.0, 30.0, 3.0, 30.0];
...
pub const MEASURED_DROOP_DEG: [f32; 4] = [0.00, 3.03, 26.83, 3.01];
...
pub const MEASURED_SEPARATION_M: f32 = 0.0000;
...
pub const MEASURED_IMPACT_PEAK_DEG: f32 = 62.42;
pub const MEASURED_IMPACT_REST_DEG: f32 = 3.01;
...
pub fn build_soft_weld(world: &mut World) {
...
pub fn physics_smoke_soft_weld(ctx: &mut crate::SceneCtx<'_>) {
