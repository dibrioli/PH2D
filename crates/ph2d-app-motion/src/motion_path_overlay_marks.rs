...
pub const RIBBON_PX: f64 = 1.6; // LITERAL-PX-OK: chrome de overlay, espessura de tela

/// Largura do glow que passa por baixo da fita — o halo macio do acabamento.
pub const RIBBON_GLOW_PX: f64 = 5.5; // LITERAL-PX-OK: chrome de overlay, espessura de tela

/// A cor/alfa do glow: âmbar difusa e fraca. É halo, não leitura — nunca compete.
pub const RIBBON_GLOW_RGBA: [f32; 4] = [1.0, 0.62, 0.22, 0.12]; // LITERAL-COLOR-OK: overlay de trajetoria
...
pub const RIBBON_BANDS: usize = 24;
...
pub const RIBBON_FLAT_REL: f64 = 0.01;
