# ARQUIVO — 16_impasto_plano_implementacao.md (história, 1035 linhas)

> ⚠️ **Isto NÃO é o estado atual de nada.** É a história recortada de
> [`16_impasto_plano_implementacao.md`](../../../Painter/16_impasto_plano_implementacao.md) em 2026-08-18, **verbatim** — nenhuma
...
>
> Recorte: linhas fora de `1-213,337-362,538-541,791-796,1212-1231,1305-1335` do original.
>
...
> Fundamentação e fontes: [17_impasto_deposito_pesquisa2.md](../../../Painter/17_impasto_deposito_pesquisa2.md).
...
- **`Level`** — a tinta espessa e opaca desta camada **soterra** a textura debaixo dela em vez de herdá-la,
  ...
  ([17_impasto_deposito_pesquisa2.md](../../../Painter/17_impasto_deposito_pesquisa2.md)). Onde a tinta é sólida a superfície
