...
impl PainterTool {
    ...
    pub fn brush_settings(&self) -> BrushSettings {
        ...
        BrushSettings {
            ...
            sculpt_knob_family: self.sculpt_knob_family(),
            ...
            sculpt_depth_loads: self.sculpt_depth(),
            sculpt_angle: self.paint.sculpt.angle_norm,
            sculpt_angle_deg: self.sculpt_chisel_angle_deg(),
            ...
            composite_len: self.composite_len(),
            composite_add_op: self.composite_add_op(),
            composite_add_available: self.ops_com_quota_livre(),
            composite_ops: self.composite_ops_u8(),
            composite_strength: self.composite_strengths(),
            composite_color: self.composite_colors(),
            ...
            thread_width_px: b.thread_width_px,
            thread_opacity: b.thread_opacity,
            sketchy_magnetify: b.sketchy_magnetify,
            wire_history: b.wire_history,
            wire_connection_line: b.wire_connection_line,
            ribbon_weight: b.ribbon_weight,
            ribbon_friction: b.ribbon_friction,
            ribbon_gravity: b.ribbon_gravity,
            ribbon_rungs: b.ribbon_rungs,
            rough_amount: b.rough_amount,
            rough_bowing: b.rough_bowing,
            rough_passes: b.rough_passes,
            ...
            shape_alpha_from_image: self.paint.shape_layers.alpha_from_image(),
            shape_has_alpha_choice: self.paint.shape_layers.has_alpha_choice(),
            ...
            wet_tilt_on: self.paint.wetpaint.tilt_on,
            wet_tilt_ring: self.paint.wetpaint.tilt_ring,
            wet_tilt_spoke: self.paint.wetpaint.tilt_spoke,
            wet_show_wet: self.paint.wetpaint.show_wet,
            wet_paper_visual: self.paint.wetpaint.paper_visual,
