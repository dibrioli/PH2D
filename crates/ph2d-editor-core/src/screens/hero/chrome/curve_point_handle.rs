//! On-canvas **Curve / Free Hand** editor point-handle menu — the four vector-app continuity kinds
//! (Free / Aligned / Vector / Auto), opened by a secondary-click on a control point (the shell raises
...
//! `3 = Auto`); the shell drains it and calls `PainterTool::set_curve_handle_kind` on the selected point.
