# A ESCADA do `PROJECT_SCHEMA`, de `v99` a `v108` — ARQUIVO VERBATIM

> ⚠️ **Este ficheiro era `shells/desktop/src/project_schema_history_v99.rs`** e mudou-se para cá em 2026-09-16, **verbatim**, pela MESMA
> catraca que já tinha movido a faixa `v2`..`v82`: a `the_shell_only_shrinks`. Ela foi cortada da escada viva no mesmo dia em que nasceu este arquivo, pelo degrau `133` (o *custom handle* do osso), e vai directamente para o arquivo em vez de virar um terceiro módulo da shell.
>
...
`sha256` do `project_schema_history_v99.rs` movido: `76437d0fcca9527bd9bf2ca9864ee1a2cf42495c6afef46a1a44b59d77a747ab`
