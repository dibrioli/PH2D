...
pub fn chip(view: Rect, inset: f32, text_w: f32, font_px: f32) -> Rect {
    let pad = chip_pad();
    Rect::new(
        view.x + inset - pad,
...
pub fn menu_rect(chip: Rect, canvas: Rect, widest: f32) -> Rect {
...
/// não obedece.
pub fn row_at(menu: Rect, p: [f32; 2]) -> Option<Standard> {
...
pub fn widest_row(text: &mut ph2d_text::TextSystem, font_px: f32) -> f32 {
    Standard::ALL
        .into_iter()
