//! **O gizmo de navegação** — a lei vive na [`ph2d_viewport3d::navball`].
//!
//! ⚠️ **Este alias existe por UM motivo só: não editar a árvore de outra linha.** `crate::field3d_navball`
...
//! escrever `ph2d_viewport3d::navball` directamente. *Um alias com data de validade escrita é dívida
