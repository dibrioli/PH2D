...
pub fn physics_smoke_drop(ctx: &mut crate::SceneCtx<'_>) {
...
pub fn physics_smoke_pile(ctx: &mut crate::SceneCtx<'_>) {
    spawn_floor(ctx.world);
...
pub fn physics_smoke_world(ctx: &mut crate::SceneCtx<'_>) {
    spawn_floor(ctx.world);
...
pub fn physics_smoke_layers(ctx: &mut crate::SceneCtx<'_>) {
    spawn_floor(ctx.world);
...
pub fn physics_smoke_author(ctx: &mut crate::SceneCtx<'_>) {
    spawn_floor(ctx.world);
