...
impl AudioSystem {
    ...
    pub fn editor_load(&mut self, path: &std::path::Path) {
    ...
    pub fn editor_force_mono(&self) -> bool {
    ...
    pub fn editor_toggle_force_mono(&mut self) {
    ...
    pub fn editor_refresh_mono_view(&mut self) {
        if !self.editor.force_mono {
            self.editor.mono_view = None;
            self.editor.mono_sig = None;
            return;
    ...
    pub fn editor_toggle_play(&mut self, looping: bool) {
    ...
    pub fn editor_duration_secs(&self) -> f64 {
    ...
    pub fn editor_clip(&self) -> Option<&ph2d_audio_edit::EditClip> {
        self.editor_sounding()
    }
    ...
    pub fn editor_apply(&mut self, cmd: ph2d_panel_audio_editor::AudioEditCmd) {
    ...
    pub fn editor_set_looping(&self, looping: bool) {
    ...
    pub fn editor_set_selection(&mut self, a: u64, b: u64) {
        if let Some(clip) = self.editor.clip.as_mut() {
    ...
    pub fn editor_selection(&self) -> Option<(u64, u64)> {
        self.editor
            .clip
            .as_ref()
