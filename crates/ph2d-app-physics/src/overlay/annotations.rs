...
//!
//! Separadas do [`crate::overlay::outline`] pelo cap de 600 LOC do shell (a wave do frame,
...
use crate::overlay::joint_glyphs::{ring_px, screen_of};
...
pub const VELOCITY_RGBA: [f32; 4] = [0.96, 0.92, 0.26, 0.95]; // LITERAL-COLOR-OK: overlay de velocidade inicial
...
/// recusou a sua.
pub const BELT_RGBA: [f32; 4] = [0.28, 0.92, 0.78, 0.95]; // LITERAL-COLOR-OK: overlay de esteira
...
pub const EFFECTOR_RGBA: [f32; 4] = [1.0, 0.62, 0.16, 0.95]; // LITERAL-COLOR-OK: overlay de campo de forca
...
pub const FALLOFF_RGBA: [f32; 4] = [1.0, 0.62, 0.16, 0.45]; // LITERAL-COLOR-OK: overlay de falloff
...
pub const FALLOFF_RING: f32 = 0.5;

/// The torque-zone glyph — **violet**, a hue no collider, joint, launch or force uses.
pub const TORQUE_RGBA: [f32; 4] = [0.66, 0.44, 0.98, 0.95]; // LITERAL-COLOR-OK: overlay de torque de area
...
pub const AIM_RGBA: [f32; 4] = [0.55, 1.0, 0.30, 0.35]; // LITERAL-COLOR-OK: overlay da mira

/// O anel do **estouro** — o mesmo verde, opaco, porque ele descreve algo que
/// ACONTECEU e não algo que pode acontecer.
pub const BLAST_RGBA: [f32; 4] = [0.55, 1.0, 0.30, 0.95]; // LITERAL-COLOR-OK: overlay da explosao
...
pub fn draw_interaction(
    ...
    let width = crate::overlay::outline::OUTLINE_PX;
...
pub fn zone_mirror(scale: ph2d_core::Vec2) -> [f32; 2] {
...
/// nomear.
pub fn zone_pushes(world: &bevy_ecs::world::World, e: ph2d_ecs::Entity) -> bool {
    world
