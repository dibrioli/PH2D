//! **A pintura do gizmo 3D** — a metade que faz pixels, separada da [lei](crate::gizmo).
//!
...
/// ela tem resposta (o [`crate::smoke::Smoke::active`], que o botão do rato escolhe). Sem a
...
///
/// ⚠️ O texto vem da chave i18n derivada da **câmera** ([`crate::views::label_key`]), nunca
