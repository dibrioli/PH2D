...
use crate::select_pick::Where;
use crate::select_points::DownPoints;
...
/// [`crate::select_points::plan_down_points`], com o PEDAÇO no lugar do ponto.
///
...
pub fn hover_refresh(
    ...
    state.segment_hover = (|| {
        ...
        let (si, w) = crate::select_pick::hit_at(drawing, local, px_to_world, w2l)?;
