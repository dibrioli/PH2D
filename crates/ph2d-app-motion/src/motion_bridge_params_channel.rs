...
pub(in crate::motion_bridge) fn apply_channel_presets(
...
pub(in crate::motion_bridge) fn apply_lsystem_preset(
    motion: &mut MotionState,
    nid: ph2d_nodegraph::graph::NodeId,
    type_name: &str,
    preset: f32,
...
pub(in crate::motion_bridge) fn mark_lsystem_custom(
    motion: &mut MotionState,
    nid: ph2d_nodegraph::graph::NodeId,
    type_name: &str,
) {
...
pub(in crate::motion_bridge) fn bake_lsystem_grammar(
    motion: &mut MotionState,
    nid: ph2d_nodegraph::graph::NodeId,
    type_name: &str,
) {
    ...
    let v = |p: &str| crate::motion_bridge::params::param_value(motion, nid, p);
