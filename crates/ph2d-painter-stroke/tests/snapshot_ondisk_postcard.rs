...
use ph2d_painter_stroke::{LayerSnapshot, SNAPSHOT_VERSION, SnapshotStorage, device::LayerId};
...
fn snapshot_inmemory_roundtrips_postcard() {
    let snap = LayerSnapshot::new_in_memory(LayerId(1), 50, vec![0xDE, 0xAD, 0xBE, 0xEF]);
