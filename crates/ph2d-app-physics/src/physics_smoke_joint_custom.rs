...
pub const LANE_Y: [f32; 3] = [5.0, 1.6, -2.4];
/// O curso dos batentes desta cena, metros.
pub const STROKE: f32 = 1.1;
...
pub fn build_joint_custom_scene(world: &mut World) {
    spawn_floor(world);
...
pub fn physics_smoke_joint_custom(ctx: &mut crate::SceneCtx<'_>) {
