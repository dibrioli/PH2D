...
//! delas responde pela [`crate::notice`]. *Uma affordance que mente é a que aceita o clique
...
#[must_use]
pub const fn item_id(key: &'static str) -> NodeId {
...
pub fn build(live_sculpt: bool, profile: bool) -> PaletteModel {
...
pub fn build_from(shapes: &[Shape], live_sculpt: bool, profile: bool) -> PaletteModel {
...
#[must_use]
pub fn slot_of_pick(id: NodeId) -> Option<usize> {
    SHAPES.iter().position(|s| item_id(s.key) == id)
}

#[cfg(test)]
#[path = "shape_palette_tests.rs"]
mod tests;
