...
use crate::physics_smoke_pulley::{GROUND, ball};
use ph2d_core::Vec2;
...
pub const CAMERA_CENTRE: [f32; 2] = [0.0, 6.5];
...
/// Monta a cena 62.
pub fn build_differential(world: &mut World) {
    world.spawn((
        Name::new("Floor"),
        RigidBody {
...
pub fn physics_smoke_differential(ctx: &mut crate::SceneCtx<'_>) {
