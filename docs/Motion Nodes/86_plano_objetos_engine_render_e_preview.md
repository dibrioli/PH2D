...
6. ~~Ordem~~ — **DECIDIDO (Enio, 2026-08-02): B (preview) primeiro, depois A1**, depois A2→A4. **Wave B FECHADA (smoke OK).** **Wave A1 CONSTRUÍDA (aguarda smoke)** — ver §8. Próximo após smoke de A1: A2 (bake-to-tile de vetor).
