...
//!
//! ⚠️ **Desceu de `ph2d-editor-core/src/ids/chrome/timeline.rs` em 2026-09-12** (auditoria de arquitectura
...
// ── Desceu de `ph2d-editor-core/src/ids/chrome/timeline.rs` em 2026-09-13 (2.ª passagem: a cerca com a
