...
pub const FADE_BY_DISTANCE: Recipe = Recipe {
    ...
    knobs: &[
        ...
        Knob::link("b_x", "B · X"),
        Knob::link("b_y", "B · Y"),
        Knob::num("near_at", "Near At", 50.0, (0.0, 5000.0)),
        Knob::num("far_at", "Far At", 200.0, (0.0, 5000.0)),
        Knob::num("near", "Near Value", 1.0, (-1000.0, 1000.0)),
        Knob::num("far", "Far Value", 0.0, (-1000.0, 1000.0)),
    ],
    kind: RowKind::Value,
    clock: ClockUse::None,
...
pub const SCALE_BY_PROXIMITY: Recipe = Recipe {
    ...
    knobs: &[
        ...
        Knob::num("near_at", "Near At", 50.0, (0.0, 5000.0)),
        Knob::num("far_at", "Far At", 200.0, (0.0, 5000.0)),
        Knob::num("near", "Near Value", 2.0, (-1000.0, 1000.0)),
        Knob::num("far", "Far Value", 0.5, (-1000.0, 1000.0)),
    ],
    kind: RowKind::Value,
    clock: ClockUse::None,
    neutral: Neutrality::NoNeutral,
...
pub const GRADIENT_BY_VALUE: Recipe = Recipe {
    ...
    knobs: &[
        ...
        Knob::num("in_lo", "From", 0.0, (-1000.0, 1000.0)),
        Knob::num("in_hi", "To", 100.0, (-1000.0, 1000.0)),
        Knob::num("out_lo", "Gives", 0.0, (-1000.0, 1000.0)),
        Knob::num("out_hi", "Up To", 1.0, (-1000.0, 1000.0)),
    ],
    kind: RowKind::Value,
    clock: ClockUse::None,
    neutral: Neutrality::NoNeutral,
