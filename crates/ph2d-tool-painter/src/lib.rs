...
pub use tool::{
    ...
    PANEL_RAMP_STOPS, PainterTool, PolygonOverlay, StencilOverlay, StencilPreview, TangentHandles,
    TransformGizmo, brush_falloff_weight_at, set_pending_select_mods,
};
