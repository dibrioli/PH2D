...
pub(crate) struct ChaveDoChao {
    ...
    consts: Vec<f32>,
    altura: f32,
    lampadas: Vec<ph2d_field_render::PointLamp>,
    materiais: Vec<ph2d_material::Surface>,
    /// A tolerância de acerto — o ÚNICO eixo da câmera que chega ao campo, e ele chega.
    hit: f32,
...
fn campo_do_chao(
    ...
    let chave = ChaveDoChao {
        ...
        hit: ph2d_field_render::Sharpness::for_frame(cam.half_extent, w.min(h) as usize).hit,
