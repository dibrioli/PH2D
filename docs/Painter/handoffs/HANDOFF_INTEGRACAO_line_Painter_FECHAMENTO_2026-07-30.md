...
| # | O quê | doc |
|---|---|---|
| B1 | **A sim saiu da thread do frame** — água 15 → 33 Hz, pior tick 73 → 9 ms | [doc 29](../29_offthread_sim.md) + §5.31–§5.38 |
...
| B5 | **`Flow Grid`** — a multi-resolução: o fluxo é grosso, o pigmento é da tela | [plano 30](../30_plano_multiresolucao.md) + §5.42 |
