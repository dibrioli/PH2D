...
pub use ph2d_editor_core::ids::{
    ...
    filter_detail_id, filter_detail_num_id, filter_down_id, filter_hide_id, filter_mode_id,
    filter_offx_id, filter_offx_num_id, filter_offy_id, filter_offy_num_id, filter_opacity_id,
    filter_opacity_num_id, filter_radius_id, filter_radius_num_id, filter_remove_id,
    filter_scale_id, filter_scale_num_id, filter_seed_id, filter_seed_num_id, filter_up_id,
};
