...
pub(crate) use crate::strip_resolve::current_tween_interval;
...
pub struct FlipStrip {
    ...
    pub trace: std::collections::BTreeMap<Frame, ph2d_flip::Pose>,
    ...
    /// par não muda o desenho até o Add. Ver [`crate::tween_correct`].
    pub tween_correct: Option<crate::tween_correct::TweenCorrect>,
}
...
impl FlipStrip {
    ...
    pub fn selected_keys(&self) -> &[Frame] {
        &self.selection
    }
}
