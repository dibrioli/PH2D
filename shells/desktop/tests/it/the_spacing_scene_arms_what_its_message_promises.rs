...
//!
//! O gate de cook irmão (`ph2d-node-registry-init/tests/it/spacing_scene.rs`) prova que o NÓ, dadas
...
const SCENE: &str =
    include_str!("../../../../crates/ph2d-app-motion/src/motion_node_path_smoke.rs");
    ...
    for claim in [
        ...
        assert!(
            ...
            "a tabela impressa perdeu a linha {claim:?} — os números dela são gateados em \
             ph2d-node-registry-init/tests/it/spacing_scene.rs"
        );
    }
}
