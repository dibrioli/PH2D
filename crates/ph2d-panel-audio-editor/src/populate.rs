...
use crate::{
    ...
    AEDIT_CUTS_CLEAR, AEDIT_DC, AEDIT_EXPORT, AEDIT_EXPORT_PIECES, AEDIT_EXPORT_SET, AEDIT_FADE_IN,
    AEDIT_FADE_OUT, AEDIT_FX_ADD, AEDIT_FX_APPLY, AEDIT_FX_BYPASS, AEDIT_FX_CANCEL, AEDIT_FX_DOWN,
    AEDIT_FX_LOAD_IR, AEDIT_FX_NEXT, AEDIT_FX_PARAMS, AEDIT_FX_PREV, AEDIT_FX_REMOVE,
    ...
    AEDIT_NORMALIZE, AEDIT_OGG_QUALITY, AEDIT_PASTE, AEDIT_PLAY, AEDIT_PRESET_APPLY,
    AEDIT_PRESET_LOAD, AEDIT_PRESET_NEXT, AEDIT_PRESET_PREV, AEDIT_PRESET_SAVE, AEDIT_REDO,
    AEDIT_REVERSE, AEDIT_SEC_DELIVERY, AEDIT_SEC_EDIT, AEDIT_SEC_FX, AEDIT_SEC_LOOP,
    AEDIT_SEC_MARKERS, AEDIT_SEC_SPECTRAL, AEDIT_SEC_TRANSPORT, AEDIT_SEC_VARIATIONS,
    AEDIT_SILENCE, AEDIT_SPEC_AMOUNT, AEDIT_SPEC_DENOISE, AEDIT_SPEC_DENOISE_ML, AEDIT_SPEC_LEARN,
    AEDIT_SPEC_REPAIR, AEDIT_SPEC_VIEW, AEDIT_SPLIT, AEDIT_SPLIT_PLAYHEAD, AEDIT_STOP,
    AEDIT_TOOL_MOVE, AEDIT_TOOL_SCALE, AEDIT_TOOL_SELECT, AEDIT_TRIM, AEDIT_UNDO, AEDIT_VAR_ADD,
    AEDIT_VAR_ADD_FOLDER, AEDIT_VAR_ENABLED, AEDIT_VAR_GAIN, AEDIT_VAR_LOAD, AEDIT_VAR_PITCH,
...
fn register_buttons(store: &mut WidgetStore) {
    ...
    for id in [
        ...
        AEDIT_EXPORT_PIECES,
        // Delivery: one file per shipping target (Mobile / Desktop / Console).
        AEDIT_EXPORT_SET,
        ...
        AEDIT_SPEC_LEARN,
        AEDIT_SPEC_DENOISE,
        // AI Denoise (W7): registered unconditionally (like the Amount slider) so a click lands
        // when the shell paints it; the shell only paints it with `audio-ml`.
